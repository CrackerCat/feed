...
- 🌟 👤 [0xCD4](https://github.com/0xCD4) Starred [google/sec-gemini](https://github.com/google/sec-gemini)
...
- 🌟 👤 [0xbug](https://github.com/0xbug) Starred [jelmer/dulwich](https://github.com/jelmer/dulwich)
  > Pure-Python Git implementation

### [4ra1n](https://github.com/4ra1n)
- 🌟 👤 [4ra1n](https://github.com/4ra1n) Starred [wux1an/wxapkg](https://github.com/wux1an/wxapkg)
  > 跨平台微信小程序反编译 GUI 工具，.wxapkg 文件扫描 + 解密 + 解包工具
- 🌟 👤 [4ra1n](https://github.com/4ra1n) Starred [fasnow/fine](https://github.com/fasnow/fine)
  > 网络空间资产测绘、ICP备案、天眼查股权结构图、端口扫描、指纹识别、小程序敏感信息提取。

### [Abbbbbi](https://github.com/Abbbbbi)
- 🌟 👤 [Abbbbbi](https://github.com/Abbbbbi) Starred [osecurio/mtkview](https://github.com/osecurio/mtkview)
  > A BinaryNinja loader plugin for MTK Preloaders and Little Kernels
- 🌟 👤 [Abbbbbi](https://github.com/Abbbbbi) Starred [kasnria001/pwnage24mtk](https://github.com/kasnria001/pwnage24mtk)
  > Cert exploit for MTK devices.There is a logic flaw in MTK cert verification process.Similar to CVE-2...
- 🌟 👤 [Abbbbbi](https://github.com/Abbbbbi) Starred [mekos2772/ios-location-spoofer](https://github.com/mekos2772/ios-location-spoofer)
...
- 🚀 👤 [AlexiaChen](https://github.com/AlexiaChen) Made [AlexiaChen/kata-go-sai](https://github.com/AlexiaChen/kata-go-sai) public
  > GO SAI
- 🌟 👤 [AlexiaChen](https://github.com/AlexiaChen) Starred [patr-schm/TinyAD](https://github.com/patr-schm/TinyAD)
...
- 🌟 👤 [BlackHole1](https://github.com/BlackHole1) Starred [oomol-lab/CloseUp](https://github.com/oomol-lab/CloseUp)
...
- 🌟 👤 [Chordp](https://github.com/Chordp) Starred [wilsonfreitas/awesome-quant](https://github.com/wilsonfreitas/awesome-quant)
...
- 🌟 👤 [Cossack9989](https://github.com/Cossack9989) Starred [occia/apicraft](https://github.com/occia/apicraft)
...
- 🌟 👤 [DarkLineX](https://github.com/DarkLineX) Starred [GitKittys/AndroidPrybar](https://github.com/GitKittys/AndroidPrybar)
...
- 🌟 👤 [DeHby](https://github.com/DeHby) Starred [ZoeyVid/NPMplus](https://github.com/ZoeyVid/NPMplus)
...
- 🌟 👤 [FldBudin](https://github.com/FldBudin) Starred [GyulyVGC/sniffnet](https://github.com/GyulyVGC/sniffnet)
...
- 🌟 👤 [GaoYuCan](https://github.com/GaoYuCan) Starred [Orangera1n/spironolactone](https://github.com/Orangera1n/spironolactone)
  > Something, mayhaps?

### [H3d9](https://github.com/H3d9)
- 🌟 👤 [H3d9](https://github.com/H3d9) Starred [Wasdubya/x64dbgMCP](https://github.com/Wasdubya/x64dbgMCP)
  > Model Context Protocol for x64dbg & x32dbg
- 🌟 👤 [H3d9](https://github.com/H3d9) Starred [svnscha/mcp-windbg](https://github.com/svnscha/mcp-windbg)
  > Model Context Protocol for WinDbg.

### [HSSkyBoy](https://github.com/HSSkyBoy)
- 🌟 👤 [HSSkyBoy](https://github.com/HSSkyBoy) Starred [HSSkyBoy/apk-reverse](https://github.com/HSSkyBoy/apk-reverse)
  > Agent Skill

### [J0o1ey](https://github.com/J0o1ey)
- 🌟 👤 [J0o1ey](https://github.com/J0o1ey) Starred [anmolksachan/AI-ML-Free-Resources-for-Security-and-Prompt-Injection](https://github.com/anmolksachan/AI-ML-Free-Resources-for-Security-and-Prompt-Injection)
  > AI/ML Pentesting Roadmap for Beginners

### [Jumbo-WJB](https://github.com/Jumbo-WJB)
- 🌟 👤 [Jumbo-WJB](https://github.com/Jumbo-WJB) Starred [visa/visa-vulnerability-agentic-harness](https://github.com/visa/visa-vulnerability-agentic-harness)
  > Visa Vulnerability Agentic Harness

### [Kwansy98](https://github.com/Kwansy98)
- 🌟 👤 [Kwansy98](https://github.com/Kwansy98) Starred [MistyFir/SVMHypervisor-Preview](https://github.com/MistyFir/SVMHypervisor-Preview)
  > 从零开始手写的AMD平台Hypervisor

### [Lakr233](https://github.com/Lakr233)
- 🌟 👤 [Lakr233](https://github.com/Lakr233) Starred [qqqqqf-q/ai-model-fingerprint](https://github.com/qqqqqf-q/ai-model-fingerprint)
  > AI 模型随机数分布指纹数据集 — 17 模型 / OpenRouter / 含原始响应与相似度分析

### [LasCC](https://github.com/LasCC)
- 🌟 👤 [LasCC](https://github.com/LasCC) Starred [RedByte1337/CredSpy](https://github.com/RedByte1337/CredSpy)
...
- 🌟 👤 [LunFengChen](https://github.com/LunFengChen) Starred [LawnchairLauncher/lawnchair](https://github.com/LawnchairLauncher/lawnchair)
  > No clever tagline needed.
- 🍴 👤 [LunFengChen](https://github.com/LunFengChen) Forked [LawnchairLauncher/lawnchair](https://github.com/LawnchairLauncher/lawnchair) to [LunFengChen/lawnchair](https://github.com/LunFengChen/lawnchair)
  > No clever tagline needed.
...
- 🌟 👤 [MikaCybertron](https://github.com/MikaCybertron) Starred [vova7878-modules/PMPatch](https://github.com/vova7878-modules/PMPatch)
  > Disable signature verification for Android

### [MolotovCherry](https://github.com/MolotovCherry)
- 🌟 👤 [MolotovCherry](https://github.com/MolotovCherry) Starred [qt/qtbridge-rust-examples](https://github.com/qt/qtbridge-rust-examples)
  > Examples for the Qt Bridge Rust
...
- 🌟 👤 [NativeStar](https://github.com/NativeStar) Starred [ruffle-rs/ruffle](https://github.com/ruffle-rs/ruffle)
  > A Flash Player emulator written in Rust

### [Natsume324](https://github.com/Natsume324)
- 🌟 👤 [Natsume324](https://github.com/Natsume324) Starred [FufuLauncher/FufuLauncher](https://github.com/FufuLauncher/FufuLauncher)
...
- 🌟 👤 [No-Github](https://github.com/No-Github) Starred [DeusData/codebase-memory-mcp](https://github.com/DeusData/codebase-memory-mcp)
...
- 🌟 👤 [PIKACHUIM](https://github.com/PIKACHUIM) Starred [GEORGEWWWU/NetSpeed-Dynamic](https://github.com/GEORGEWWWU/NetSpeed-Dynamic)
  > Windows 灵动岛？Windows 灵动岛！NSD - Dynamic Island For Windows
...
- 🌟 👤 [Resery](https://github.com/Resery) Starred [0xCyberstan/CVE-2026-31694-POC](https://github.com/0xCyberstan/CVE-2026-31694-POC)
  > Linux kernel FUSE readdir cache out-of-bounds write (CVE-2026-31694): a malicious FUSE server overfl...

### [Ridter](https://github.com/Ridter)
- 🌟 👤 [Ridter](https://github.com/Ridter) Starred [bikini/exploitarium](https://github.com/bikini/exploitarium)
  > A single archive of public exploit PoCs and vulnerability research writeups. At the time I post thes...
- 🍴 👤 [Ridter](https://github.com/Ridter) Forked [bikini/exploitarium](https://github.com/bikini/exploitarium) to [Ridter/exploitarium](https://github.com/Ridter/exploitarium)
  > A single archive of public exploit PoCs and vulnerability research writeups. At the time I post thes...
...
- 🌟 👤 [Seyud](https://github.com/Seyud) Starred [Javis603/token-monitor](https://github.com/Javis603/token-monitor)
...
- 🌟 👤 [SherlockChiang](https://github.com/SherlockChiang) Starred [zyfzsi/fancyStart](https://github.com/zyfzsi/fancyStart)
...
- 🌟 👤 [SodaMilk233](https://github.com/SodaMilk233) Starred [XtrLumen/TS-Enhancer-Extreme](https://github.com/XtrLumen/TS-Enhancer-Extreme)
  > Enhances the TrickyStore experience, while providing extreme hiding of detection points introduced b...
- 🌟 👤 [SodaMilk233](https://github.com/SodaMilk233) Starred [bndeff/socksdroid](https://github.com/bndeff/socksdroid)
- 🌟 👤 [SodaMilk233](https://github.com/SodaMilk233) Starred [GitKittys/AndroidPrybar](https://github.com/GitKittys/AndroidPrybar)
  > Android Native Trace 与逆向分析工具，用于函数包装执行、指令跟踪、JNI 调用观测与外部跳转控制
- 🌟 👤 [SodaMilk233](https://github.com/SodaMilk233) Starred [lingbol088-spec/Codex-5.5-codex-instruct-5.5](https://github.com/lingbol088-spec/Codex-5.5-codex-instruct-5.5)
  > Codex CLI 破甲工具（GPT-5.5） — 注入无限制模式系统指令，关闭所有内容过滤器。

### [StanleyNull](https://github.com/StanleyNull)
- 🌟 👤 [StanleyNull](https://github.com/StanleyNull) Starred [zhizhuodemao/android_proxy_mcp](https://github.com/zhizhuodemao/android_proxy_mcp)
  > 基于 MCP 的 Android 抓包服务，让 AI 助手通过自然语言分析网络请求。
- 🌟 👤 [StanleyNull](https://github.com/StanleyNull) Starred [StanleyNull/AutoHunter](https://github.com/StanleyNull/AutoHunter)
  > 自动化 SRC 漏洞挖掘系统：FOFA 资产测绘 + LLM 多 worker 自主挖掘/审核/情报沉淀。Powered By StanleyNull

### [Super12138](https://github.com/Super12138)
- 🌟 👤 [Super12138](https://github.com/Super12138) Starred [adeeteya/Classipod](https://github.com/adeeteya/Classipod)
  > A local music player app designed to capture the nostalgic essence of the iconic iPod Classic.
- 🌟 👤 [Super12138](https://github.com/Super12138) Starred [be5invis/Sarasa-Gothic](https://github.com/be5invis/Sarasa-Gothic)
  > Sarasa Gothic / 更纱黑体 / 更紗黑體 / 更紗ゴシック / 사라사 고딕

### [TUGOhost](https://github.com/TUGOhost)
- 🌟 👤 [TUGOhost](https://github.com/TUGOhost) Starred [dyoshikawa/rulesync](https://github.com/dyoshikawa/rulesync)
...
- 🌟 👤 [TheQmaks](https://github.com/TheQmaks) Starred [ACD421/unchained-claude](https://github.com/ACD421/unchained-claude)
  > Removes Claude Code's behavioral restrictions at the binary, permission, and prompt layers.

### [Tlaster](https://github.com/Tlaster)
- 🍴 👤 [Tlaster](https://github.com/Tlaster) Forked [llsc12/textual](https://github.com/llsc12/textual) to [Tlaster/textual](https://github.com/Tlaster/textual)
  > Render and customize rich attributed text in SwiftUI

### [Tokeii0](https://github.com/Tokeii0)
- 🌟 👤 [Tokeii0](https://github.com/Tokeii0) Starred [Tokeii0/lovelymisclab](https://github.com/Tokeii0/lovelymisclab)
...
- 🌟 👤 [ViRb3](https://github.com/ViRb3) Starred [Dokploy/dokploy](https://github.com/Dokploy/dokploy)
...
- 🌟 👤 [WAY29](https://github.com/WAY29) Starred [weixiao030/poe2_price](https://github.com/weixiao030/poe2_price)
  > 使用补丁修改游戏通货显示价格
- 🌟 👤 [WAY29](https://github.com/WAY29) Starred [Sophomoresty/mediago](https://github.com/Sophomoresty/mediago)
...
- 🌟 👤 [afkT](https://github.com/afkT) Starred [juliangarnier/anime](https://github.com/juliangarnier/anime)
  > JavaScript animation engine
- 🌟 👤 [afkT](https://github.com/afkT) Starred [Snouzy/workout-cool](https://github.com/Snouzy/workout-cool)
  > 🏋 Modern open-source fitness coaching platform. Create workout plans, track progress, and access a c...
- 🌟 👤 [afkT](https://github.com/afkT) Starred [Egonex-AI/Understand-Anything](https://github.com/Egonex-AI/Understand-Anything)
  > Graphs that teach > graphs that impress. Turn any code into an interactive knowledge graph you can e...
- 🌟 👤 [afkT](https://github.com/afkT) Starred [DeusData/codebase-memory-mcp](https://github.com/DeusData/codebase-memory-mcp)
  > High-performance code intelligence MCP server. Indexes codebases into a persistent knowledge graph —...
- 🌟 👤 [afkT](https://github.com/afkT) Starred [safishamsi/graphify](https://github.com/safishamsi/graphify)
  > AI coding assistant skill (Claude Code, Codex, OpenCode, Cursor, Gemini CLI, and more). Turn any fol...
- 🌟 👤 [afkT](https://github.com/afkT) Starred [FSoft-AI4Code/CodeWiki](https://github.com/FSoft-AI4Code/CodeWiki)
  > [ACL 2026] Open-source framework for holistic, structured repository-level documentation across mult...
- 🌟 👤 [afkT](https://github.com/afkT) Starred [songquanpeng/one-api](https://github.com/songquanpeng/one-api)
...
- 🌟 👤 [androidmalin](https://github.com/androidmalin) Starred [waydabber/BetterDisplay](https://github.com/waydabber/BetterDisplay)
...
- 🍴 👤 [apkunpacker](https://github.com/apkunpacker) Forked [0xsha/CVE-2026-6307](https://github.com/0xsha/CVE-2026-6307) to [apkunpacker/CVE-2026-6307](https://github.com/apkunpacker/CVE-2026-6307)
  > Google Chrome CVE-2026-6307 PoC
- 🌟 👤 [apkunpacker](https://github.com/apkunpacker) Starred [michalbednarski/OrganizerTransaction](https://github.com/michalbednarski/OrganizerTransaction)
  > PoC for CVE-2021-39749, allowing starting arbitrary Activity on Android 12L Beta
- 🍴 👤 [apkunpacker](https://github.com/apkunpacker) Forked [michalbednarski/OrganizerTransaction](https://github.com/michalbednarski/OrganizerTransaction) to [apkunpacker/OrganizerTransaction](https://github.com/apkunpacker/OrganizerTransaction)
  > PoC for CVE-2021-39749, allowing starting arbitrary Activity on Android 12L Beta
...
- 🍴 👤 [ctkqiang](https://github.com/ctkqiang) Forked [matrixplusio/mxcwpp](https://github.com/matrixplusio/mxcwpp) to [ctkqiang/mxcwpp](https://github.com/ctkqiang/mxcwpp)
  > 企业级主机与容器安全管理平台。覆盖安全基线、资产管理、漏洞扫描、病毒查杀、文件完整性监控、运行时检测、容器安全、威胁情报与告警响应，面向安全运营团队提供统一管控视图。
- 🍴 👤 [ctkqiang](https://github.com/ctkqiang) Forked [anshug/claude-mythos](https://github.com/anshug/claude-mythos) to [ctkqiang/claude-mythos](https://github.com/ctkqiang/claude-mythos)
...
- 🌟 👤 [darvincisec](https://github.com/darvincisec) Starred [usestrix/strix](https://github.com/usestrix/strix)
  > Open-source AI penetration testing tool to find and fix your app’s vulnerabilities.

### [delikely](https://github.com/delikely)
- 🌟 👤 [delikely](https://github.com/delikely) Starred [34306/vphone-aio](https://github.com/34306/vphone-aio)
  > 1 script run the vphone

### [demon-i386](https://github.com/demon-i386)
- 🌟 👤 [demon-i386](https://github.com/demon-i386) Starred [rapid7/mettle](https://github.com/rapid7/mettle)
  > This is an implementation of a native-code Meterpreter, designed for portability, embeddability, and...
- 🌟 👤 [demon-i386](https://github.com/demon-i386) Starred [google/zerocopy](https://github.com/google/zerocopy)
  > Zerocopy makes zero-cost memory manipulation effortless. We write `unsafe` so you don’t have to.
- 🌟 👤 [demon-i386](https://github.com/demon-i386) Starred [bikini/exploitarium](https://github.com/bikini/exploitarium)
  > A single archive of public exploit PoCs and vulnerability research writeups. At the time I post thes...

### [djolertrk](https://github.com/djolertrk)
- 🍴 👤 [djolertrk](https://github.com/djolertrk) Forked [digital-asset/canton](https://github.com/digital-asset/canton) to [walnuthq/canton](https://github.com/walnuthq/canton)
  > Global Workflow Composition that is Scalable, Secure, and GDPR-compliant

### [dodola](https://github.com/dodola)
- 🌟 👤 [dodola](https://github.com/dodola) Starred [sermuns/ratatuefi](https://github.com/sermuns/ratatuefi)
  > Zero-bloat Ratatui apps in UEFI

### [doodlewind](https://github.com/doodlewind)
- 🌟 👤 [doodlewind](https://github.com/doodlewind) Starred [pop-os/cosmic-text](https://github.com/pop-os/cosmic-text)
  > Pure Rust multi-line text handling

### [dzxpert](https://github.com/dzxpert)
- 🌟 👤 [dzxpert](https://github.com/dzxpert) Starred [Jirubizu/reclass-rs](https://github.com/Jirubizu/reclass-rs)

### [easychen](https://github.com/easychen)
- 🌟 👤 [easychen](https://github.com/easychen) Starred [huggingface/speech-to-speech](https://github.com/huggingface/speech-to-speech)
...
- 🌟 👤 [einverne](https://github.com/einverne) Starred [ogulcancelik/herdr](https://github.com/ogulcancelik/herdr)
...
- 🌟 👤 [elllusion](https://github.com/elllusion) Starred [pc2/sus-compiler](https://github.com/pc2/sus-compiler)
  > A new Hardware Design Language that keeps you in the driver's seat
- 🌟 👤 [elllusion](https://github.com/elllusion) Starred [mit-plv/koika](https://github.com/mit-plv/koika)
  > A core language for rule-based hardware design 🦑
- 🌟 👤 [elllusion](https://github.com/elllusion) Starred [microsoft/kanagawa](https://github.com/microsoft/kanagawa)
  > High level synthesis language for hardware design
- 🌟 👤 [elllusion](https://github.com/elllusion) Starred [stanford-ppl/spatial](https://github.com/stanford-ppl/spatial)
  > Spatial: "Specify Parameterized Accelerators Through Inordinately Abstract Language"
- 🌟 👤 [elllusion](https://github.com/elllusion) Starred [calyxir/calyx](https://github.com/calyxir/calyx)
  > Intermediate Language (IL) for Hardware Accelerator Generators
- 🌟 👤 [elllusion](https://github.com/elllusion) Starred [cocotb/cocotb](https://github.com/cocotb/cocotb)
  > cocotb: Python-based chip (RTL) verification
- 🌟 👤 [elllusion](https://github.com/elllusion) Starred [naman-ranka/siliconcrew](https://github.com/naman-ranka/siliconcrew)
  > Autonomous LLM agent for hardware design — natural language to GDSII via Verilog generation, simulat...
- 🌟 👤 [elllusion](https://github.com/elllusion) Starred [Naveen2070/min-mozhi](https://github.com/Naveen2070/min-mozhi)
  > A modern, safe-by-default Hardware Description Language (HDL) designed to teach digital design — and...
- 🌟 👤 [elllusion](https://github.com/elllusion) Starred [mattpocock/skills](https://github.com/mattpocock/skills)
...
### [gershnik](https://github.com/gershnik)
- 🚀 👤 [gershnik](https://github.com/gershnik) Made [gershnik/mkdaemonuser](https://github.com/gershnik/mkdaemonuser) public
...
- 🌟 👤 [guiying712](https://github.com/guiying712) Starred [GyulyVGC/sniffnet](https://github.com/GyulyVGC/sniffnet)
  > Comfortably monitor your Internet traffic 🕵️‍♂️

### [guoshan-yang](https://github.com/guoshan-yang)
- 🍴 👤 [guoshan-yang](https://github.com/guoshan-yang) Forked [ZhuLinsen/daily_stock_analysis](https://github.com/ZhuLinsen/daily_stock_analysis) to [guoshan-yang/daily_stock_analysis](https://github.com/guoshan-yang/daily_stock_analysis)
...
- 🌟 👤 [hellodword](https://github.com/hellodword) Starred [Sophomoresty/mediago](https://github.com/Sophomoresty/mediago)
  > Download videos from 90+ Chinese educational platforms. Single binary, yt-dlp style.

### [heyhu](https://github.com/heyhu)
- 🌟 👤 [heyhu](https://github.com/heyhu) Starred [sleeyax/burp-awesome-tls](https://github.com/sleeyax/burp-awesome-tls)
  > Burp extension to evade TLS fingerprinting. Bypass WAF, spoof any browser.

### [hhhaiai](https://github.com/hhhaiai)
- 🌟 👤 [hhhaiai](https://github.com/hhhaiai) Starred [RoadBicycle-C/RootHawk](https://github.com/RoadBicycle-C/RootHawk)
  > Linux提权
...
- 🌟 👤 [hoffstadt](https://github.com/hoffstadt) Starred [erincatto/box3d](https://github.com/erincatto/box3d)
...
- 🌟 👤 [jianglin-code](https://github.com/jianglin-code) Starred [ggml-org/ggml](https://github.com/ggml-org/ggml)
  > Tensor library for machine learning
- 🌟 👤 [jianglin-code](https://github.com/jianglin-code) Starred [ggml-org/whisper.cpp](https://github.com/ggml-org/whisper.cpp)
  > Port of OpenAI's Whisper model in C/C++
- 🌟 👤 [jianglin-code](https://github.com/jianglin-code) Starred [openai/whisper](https://github.com/openai/whisper)
  > Robust Speech Recognition via Large-Scale Weak Supervision
- 🌟 👤 [jianglin-code](https://github.com/jianglin-code) Starred [LMCache/LMCache](https://github.com/LMCache/LMCache)
  > LMCache: Supercharge Your LLM with the Fastest KV Cache Layer

### [jiji262](https://github.com/jiji262)
- 🌟 👤 [jiji262](https://github.com/jiji262) Starred [happycola233/tchMaterial-parser](https://github.com/happycola233/tchMaterial-parser)
  > 国家中小学智慧教育平台 电子课本下载工具，帮助您从智慧教育平台中获取电子课本的 PDF 文件网址并进行下载，让您更方便地获取课本内容。

### [jmpews](https://github.com/jmpews)
- 🌟 👤 [jmpews](https://github.com/jmpews) Starred [HduSy/tokenscope](https://github.com/HduSy/tokenscope)
  > MacOS menu-bar dashboard for Claude CLI token usage, estimated cost, and per-model / MCP / Skill bre...
- 🌟 👤 [jmpews](https://github.com/jmpews) Starred [Fazechristian00/FilzaJailedDS](https://github.com/Fazechristian00/FilzaJailedDS)
  > Open source Filza Jailed tweak injector for iOS 17.0-26.0.1, adding jailed support for Filza IPA on ...
- 🌟 👤 [jmpews](https://github.com/jmpews) Starred [alin6668/autogo-daemon-objc](https://github.com/alin6668/autogo-daemon-objc)
  > iOS 综合设备控制守护进程 - 纯 ObjC 原生实现，集成 ios-mcp & go-ios 全部功能

### [joychic](https://github.com/joychic)
- 🌟 👤 [joychic](https://github.com/joychic) Starred [bytedance/appshark](https://github.com/bytedance/appshark)
  > Appshark is a static taint analysis platform to scan vulnerabilities in an Android app.

### [junjiexing](https://github.com/junjiexing)
- 🌟 👤 [junjiexing](https://github.com/junjiexing) Starred [sshnet/SSH.NET](https://github.com/sshnet/SSH.NET)
  > SSH.NET is a Secure Shell (SSH) library for .NET, optimized for parallelism.

### [jweny](https://github.com/jweny)
- 🌟 👤 [jweny](https://github.com/jweny) Starred [apache/pulsar](https://github.com/apache/pulsar)
  > Apache Pulsar - distributed pub-sub messaging system
- 🌟 👤 [jweny](https://github.com/jweny) Starred [caido/caido](https://github.com/caido/caido)
  > 🚀 Caido releases, wiki and roadmap

### [kaganisildak](https://github.com/kaganisildak)
- 🌟 👤 [kaganisildak](https://github.com/kaganisildak) Starred [AIxCyberChallenge/sherpa](https://github.com/AIxCyberChallenge/sherpa)
  > Security Harness Engineering for Robust Program Analysis

### [kasnria001](https://github.com/kasnria001)
- 🌟 👤 [kasnria001](https://github.com/kasnria001) Starred [RoadBicycle-C/RootHawk](https://github.com/RoadBicycle-C/RootHawk)
  > Linux提权
- 🌟 👤 [kasnria001](https://github.com/kasnria001) Starred [android-rooting-tools/android_get_essential_address](https://github.com/android-rooting-tools/android_get_essential_address)
  > Get essential address to get root, unlock security, and so on. This is based on android_run_root_she...

### [kkkgo](https://github.com/kkkgo)
- 🌟 👤 [kkkgo](https://github.com/kkkgo) Starred [yurukusa/claude-code-hooks](https://github.com/yurukusa/claude-code-hooks)
...
- 🌟 👤 [lightsummer233](https://github.com/lightsummer233) Starred [vvb2060/pxeboot](https://github.com/vvb2060/pxeboot)

### [ltlly](https://github.com/ltlly)
- 🌟 👤 [ltlly](https://github.com/ltlly) Starred [wwweeeqqu/honor-of-kings-RE-research](https://github.com/wwweeeqqu/honor-of-kings-RE-research)
...
- 🌟 👤 [lynnux](https://github.com/lynnux) Starred [LauZzL/doubao-downloader](https://github.com/LauZzL/doubao-downloader)
...
- 🌟 👤 [marlkiller](https://github.com/marlkiller) Starred [joxeankoret/diaphora](https://github.com/joxeankoret/diaphora)
  > Diaphora, the most advanced Free and Open Source program diffing tool.

### [mkr-infinity](https://github.com/mkr-infinity)
- 🌟 👤 [mkr-infinity](https://github.com/mkr-infinity) Starred [Archimetrix/Youtube-Pro-Plus](https://github.com/Archimetrix/Youtube-Pro-Plus)
  > Youtube Pro+ is a extension with many crazy functionalities and styles . Star the Repo for future up...
...
- 🌟 👤 [moonD4rk](https://github.com/moonD4rk) Starred [open-telemetry/opentelemetry-swift](https://github.com/open-telemetry/opentelemetry-swift)
...
- 🌟 👤 [natsumerinchan](https://github.com/natsumerinchan) Starred [Uminory/ruruDown](https://github.com/Uminory/ruruDown)
  > B站视频缓存导出工具 - Export BiliBili cached videos
...
- 🌟 👤 [null-dev](https://github.com/null-dev) Starred [StephenDev0/StikDebug](https://github.com/StephenDev0/StikDebug)
  > An on-device debugger/JIT enabler for iOS versions 17.4+, powered by idevice.
- 🌟 👤 [null-dev](https://github.com/null-dev) Starred [StephenDev0/StikPair](https://github.com/StephenDev0/StikPair)
  > A simple SwiftUI iOS app that creates a pairing file on-device.
- 🌟 👤 [null-dev](https://github.com/null-dev) Starred [xddxdd/sidestore-vpn](https://github.com/xddxdd/sidestore-vpn)
  > Enable SideStore app refreshes network-wide, alternative to StosVPN/WireGuard
- 🌟 👤 [null-dev](https://github.com/null-dev) Starred [herbrine8403/Amethyst-iOS-MyRemastered](https://github.com/herbrine8403/Amethyst-iOS-MyRemastered)
  > 我制作的 Amethyst (iOS) 重制版，在实用性、稳定性等方面做出了全面修改，为iOS用户提供良好的体验。
- 🌟 👤 [null-dev](https://github.com/null-dev) Starred [hugeBlack/GetMoreRam](https://github.com/hugeBlack/GetMoreRam)
  > A simple AltSign wrapper app that allows you to enable "Increased Memory Limit" to your sideloaded a...
...
- 🌟 👤 [paradiseduo](https://github.com/paradiseduo) Starred [wux1an/wxapkg](https://github.com/wux1an/wxapkg)
  > 跨平台微信小程序反编译 GUI 工具，.wxapkg 文件扫描 + 解密 + 解包工具

### [penguin-wwy](https://github.com/penguin-wwy)
- 🌟 👤 [penguin-wwy](https://github.com/penguin-wwy) Starred [tile-ai/TileFoundry](https://github.com/tile-ai/TileFoundry)

### [plumk97](https://github.com/plumk97)
- 🌟 👤 [plumk97](https://github.com/plumk97) Starred [Lakr233/vphone-cli](https://github.com/Lakr233/vphone-cli)
...
- 🌟 👤 [rabbitstack](https://github.com/rabbitstack) Starred [n0qword/win32k-callback-detouring](https://github.com/n0qword/win32k-callback-detouring)
...
- 🌟 👤 [ret2ldz](https://github.com/ret2ldz) Starred [Dr-TSNG/ApplistDetector](https://github.com/Dr-TSNG/ApplistDetector)
  > A library to detect suspicious apps like Magisk

### [riba2534](https://github.com/riba2534)
- 🌟 👤 [riba2534](https://github.com/riba2534) Starred [joewongjc/type4me](https://github.com/joewongjc/type4me)
  > MacOS语音输入法，实时识别、大模型文本优化、全本地存储
- 🌟 👤 [riba2534](https://github.com/riba2534) Starred [initxy/noeta](https://github.com/initxy/noeta)
  > A single-host, durable, event-sourced runtime for AI agents (runtime + SDK + coding-agent app).

### [rogxo](https://github.com/rogxo)
- 🌟 👤 [rogxo](https://github.com/rogxo) Starred [ijingyi125/jyweb](https://github.com/ijingyi125/jyweb)
  > 精易web浏览器开源项目

### [sh1ma](https://github.com/sh1ma)
- 🌟 👤 [sh1ma](https://github.com/sh1ma) Starred [gumyr/build123d](https://github.com/gumyr/build123d)
  > A python CAD programming library

### [shadow3aaa](https://github.com/shadow3aaa)
- 🚀 👤 [shadow3aaa](https://github.com/shadow3aaa) Made [shadow3aaa/filegraph-agents](https://github.com/shadow3aaa/filegraph-agents) public

### [std-microblock](https://github.com/std-microblock)
- 🍴 👤 [std-microblock](https://github.com/std-microblock) Forked [OrfeasZ/ZHMModSDK](https://github.com/OrfeasZ/ZHMModSDK) to [std-microblock/ZHMModSDK](https://github.com/std-microblock/ZHMModSDK)
  > A modding SDK for Hitman 3
- 🌟 👤 [std-microblock](https://github.com/std-microblock) Starred [thedmd/imgui-node-editor](https://github.com/thedmd/imgui-node-editor)
  > Node Editor built using Dear ImGui

### [stuxnet147](https://github.com/stuxnet147)
- 🌟 👤 [stuxnet147](https://github.com/stuxnet147) Starred [BicaMindLabs/FuguNano](https://github.com/BicaMindLabs/FuguNano)
  > Open & nano reimplementation of Sakana Fugu. A repo-native, multi-agent coding loop powered by 9+ LL...
- 🌟 👤 [stuxnet147](https://github.com/stuxnet147) Starred [Brillar0101/claude-code-on-fugu](https://github.com/Brillar0101/claude-code-on-fugu)
  > Run the Claude Code CLI on Sakana Fugu via a local OpenAI<->Anthropic translating router
- 🌟 👤 [stuxnet147](https://github.com/stuxnet147) Starred [postgigg/sakana-fugu-claude-plugin](https://github.com/postgigg/sakana-fugu-claude-plugin)
  > Claude Code plugin for running Sakana Fugu Ultra through a local Anthropic-compatible adapter
- 🌟 👤 [stuxnet147](https://github.com/stuxnet147) Starred [musistudio/claude-code-router](https://github.com/musistudio/claude-code-router)
  > Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact ...
- 🌟 👤 [stuxnet147](https://github.com/stuxnet147) Starred [musistudio/CodexL](https://github.com/musistudio/CodexL)
  > CodexL is the all-in-one launcher and enhancement suite for Codex App. It lets you launch, manage, c...
- 🌟 👤 [stuxnet147](https://github.com/stuxnet147) Starred [trotsky1997/OpenFugu](https://github.com/trotsky1997/OpenFugu)
  > Open reimplementation of Sakana Fugu — the 'one model to command them all' LLM orchestrator. Read → ...
- 🌟 👤 [stuxnet147](https://github.com/stuxnet147) Starred [Sakana-AI-labs/Sakana-Fugu](https://github.com/Sakana-AI-labs/Sakana-Fugu)
...
- 🌟 👤 [surendrajat](https://github.com/surendrajat) Starred [Diniboy1123/usque](https://github.com/Diniboy1123/usque)
  > Open-source reimplementation of the Cloudflare WARP client's MASQUE protocol. 
- 🍴 👤 [surendrajat](https://github.com/surendrajat) Forked [Diniboy1123/usque](https://github.com/Diniboy1123/usque) to [surendrajat/usque](https://github.com/surendrajat/usque)
  > Open-source reimplementation of the Cloudflare WARP client's MASQUE protocol. 

### [vavkamil](https://github.com/vavkamil)
- 🌟 👤 [vavkamil](https://github.com/vavkamil) Starred [bomly-dev/bomly-cli](https://github.com/bomly-dev/bomly-cli)
  > Free, open-source CLI for dependency intelligence, SBOMs, vulnerability auditing, and CI policy gate...

### [wa1ki0g](https://github.com/wa1ki0g)
- 🌟 👤 [wa1ki0g](https://github.com/wa1ki0g) Starred [nextlevelbuilder/ui-ux-pro-max-skill](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill)
  > An AI SKILL that provide design intelligence for building professional UI/UX multiple platforms

### [wainshine](https://github.com/wainshine)
- 🌟 👤 [wainshine](https://github.com/wainshine) Starred [google-research/flood-forecasting](https://github.com/google-research/flood-forecasting)
- 🌟 👤 [wainshine](https://github.com/wainshine) Starred [LY-muyanshiqi/smart-water-demo](https://github.com/LY-muyanshiqi/smart-water-demo)
...
- 🍴 👤 [wizardforcel](https://github.com/wizardforcel) Forked [OpenDocCN/dsai-notes-pt2-zh](https://github.com/OpenDocCN/dsai-notes-pt2-zh) to [OpenDocCN-Archive/dsai-notes-pt2-zh](https://github.com/OpenDocCN-Archive/dsai-notes-pt2-zh)
- 🍴 👤 [wizardforcel](https://github.com/wizardforcel) Forked [OpenDocCN/cs-notes-pt1-zh](https://github.com/OpenDocCN/cs-notes-pt1-zh) to [OpenDocCN-Archive/cs-notes-pt1-zh](https://github.com/OpenDocCN-Archive/cs-notes-pt1-zh)
- 🍴 👤 [wizardforcel](https://github.com/wizardforcel) Forked [OpenDocCN/cs-notes-pt2-zh](https://github.com/OpenDocCN/cs-notes-pt2-zh) to [OpenDocCN-Archive/cs-notes-pt2-zh](https://github.com/OpenDocCN-Archive/cs-notes-pt2-zh)
- 🍴 👤 [wizardforcel](https://github.com/wizardforcel) Forked [OpenDocCN/towardsdatascience-blog-zh-2025](https://github.com/OpenDocCN/towardsdatascience-blog-zh-2025) to [OpenDocCN-Archive/towardsdatascience-blog-zh-2025](https://github.com/OpenDocCN-Archive/towardsdatascience-blog-zh-2025)
- 🍴 👤 [wizardforcel](https://github.com/wizardforcel) Forked [OpenDocCN/dsai-notes-pt4-zh](https://github.com/OpenDocCN/dsai-notes-pt4-zh) to [OpenDocCN-Archive/dsai-notes-pt4-zh](https://github.com/OpenDocCN-Archive/dsai-notes-pt4-zh)
- 🍴 👤 [wizardforcel](https://github.com/wizardforcel) Forked [OpenDocCN/waytoagi-zh](https://github.com/OpenDocCN/waytoagi-zh) to [OpenDocCN-Archive/waytoagi-zh](https://github.com/OpenDocCN-Archive/waytoagi-zh)
- 🍴 👤 [wizardforcel](https://github.com/wizardforcel) Forked [OpenDocCN/asr-202604](https://github.com/OpenDocCN/asr-202604) to [OpenDocCN-Archive/asr-202604](https://github.com/OpenDocCN-Archive/asr-202604)
- 🍴 👤 [wizardforcel](https://github.com/wizardforcel) Forked [OpenDocCN/vkdoc-misc-zh](https://github.com/OpenDocCN/vkdoc-misc-zh) to [OpenDocCN-Archive/vkdoc-misc-zh](https://github.com/OpenDocCN-Archive/vkdoc-misc-zh)
- 🍴 👤 [wizardforcel](https://github.com/wizardforcel) Forked [OpenDocCN/tutorialspoint-zh](https://github.com/OpenDocCN/tutorialspoint-zh) to [OpenDocCN-Archive/tutorialspoint-zh](https://github.com/OpenDocCN-Archive/tutorialspoint-zh)
- 🍴 👤 [wizardforcel](https://github.com/wizardforcel) Forked [OpenDocCN/geekdoc-csharp-zh](https://github.com/OpenDocCN/geekdoc-csharp-zh) to [OpenDocCN-Archive/geekdoc-csharp-zh](https://github.com/OpenDocCN-Archive/geekdoc-csharp-zh)

### [wszqkzqk](https://github.com/wszqkzqk)
- 🍴 👤 [wszqkzqk](https://github.com/wszqkzqk) Forked [borgbackup/borg](https://github.com/borgbackup/borg) to [wszqkzqk/borg](https://github.com/wszqkzqk/borg)
  > Deduplicating archiver with compression and authenticated encryption.

### [wszxl516](https://github.com/wszxl516)
- 🌟 👤 [wszxl516](https://github.com/wszxl516) Starred [kurtbuilds/ormlite](https://github.com/kurtbuilds/ormlite)
...
- 🌟 👤 [zhangyoufu](https://github.com/zhangyoufu) Starred [Majorfi/immich-in-finder](https://github.com/Majorfi/immich-in-finder)
  > Browse your self-hosted Immich photo library as a native folder in the macOS Finder

### [zhoujun94511](https://github.com/zhoujun94511)
- 🌟 👤 [zhoujun94511](https://github.com/zhoujun94511) Starred [macacajs/android-unicode](https://github.com/macacajs/android-unicode)
...
### [zzcentury](https://github.com/zzcentury)
- 🍴 👤 [zzcentury](https://github.com/zzcentury) Forked [unkaer/Actions-OpenWrt-Xiaomi-R4A](https://github.com/unkaer/Actions-OpenWrt-Xiaomi-R4A) to [zzcentury/Actions-OpenWrt-Xiaomi-R4A](https://github.com/zzcentury/Actions-OpenWrt-Xiaomi-R4A)
  > 自己编译小米R4A千兆breed直刷版用
