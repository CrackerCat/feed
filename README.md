...
- 🌟 👤 [3intermute](https://github.com/3intermute) Starred [athanorlabs/atomic-swap](https://github.com/athanorlabs/atomic-swap)
  > 💫 ETH-XMR atomic swap implementation

### [Anatdx](https://github.com/Anatdx)
- 🌟 👤 [Anatdx](https://github.com/Anatdx) Starred [Andrea-lyz/LKM-PathMask](https://github.com/Andrea-lyz/LKM-PathMask)
  > Android LKM path masking module with KernelSU WebUI, blacklist scope, persistent config, and diagnos...
- 🍴 👤 [Anatdx](https://github.com/Anatdx) Forked [Andrea-lyz/LKM-PathMask](https://github.com/Andrea-lyz/LKM-PathMask) to [Anatdx/LKM-PathMask](https://github.com/Anatdx/LKM-PathMask)
  > Android LKM path masking module with KernelSU WebUI, blacklist scope, persistent config, and diagnos...
...
- 🍴 👤 [Keno](https://github.com/Keno) Forked [JuliaSNN/SNNModels.jl](https://github.com/JuliaSNN/SNNModels.jl) to [KenoAIStaging/SNNModels.jl](https://github.com/KenoAIStaging/SNNModels.jl)
  > Base package with types and functions for simulations
- 🍴 👤 [Keno](https://github.com/Keno) Forked [EnzymeAD/Enzyme.jl](https://github.com/EnzymeAD/Enzyme.jl) to [KenoAIStaging/Enzyme.jl](https://github.com/KenoAIStaging/Enzyme.jl)
...
- 🌟 👤 [Satar07](https://github.com/Satar07) Starred [Xiyu-Cao/EFBot](https://github.com/Xiyu-Cao/EFBot)
  > 终末地排轴编辑器与伤害模拟工具
- 🌟 👤 [Satar07](https://github.com/Satar07) Starred [taudoustar/endfield-damege-calculator](https://github.com/taudoustar/endfield-damege-calculator)
  > 一个用于计算终末地编队伤害的简易网页。

### [Sndav](https://github.com/Sndav)
- 🌟 👤 [Sndav](https://github.com/Sndav) Starred [kernullist/kn-live-dbg](https://github.com/kernullist/kn-live-dbg)
  > Windows kernel research tool. Looks like a debugger, but it is not a debugger. It uses a kernel driv...
- 🌟 👤 [Sndav](https://github.com/Sndav) Starred [Tencent/VulnGym](https://github.com/Tencent/VulnGym)
  > VulnGym: A Real-World, Project-Level Vulnerability Benchmark for White-Box Vulnerability-Hunting Age...
- 🌟 👤 [Sndav](https://github.com/Sndav) Starred [wuha0926/CVE-2026-31431-Advanced-Exploit](https://github.com/wuha0926/CVE-2026-31431-Advanced-Exploit)
  > CVE-2026-31431 纯文件利用

### [XayahSuSuSu](https://github.com/XayahSuSuSu)
- 🌟 👤 [XayahSuSuSu](https://github.com/XayahSuSuSu) Starred [corrosion-rs/corrosion](https://github.com/corrosion-rs/corrosion)
  > Marrying Rust and CMake - Easy Rust and C/C++ Integration!
- 🌟 👤 [XayahSuSuSu](https://github.com/XayahSuSuSu) Starred [sunface/rust-course](https://github.com/sunface/rust-course)
  > 什么？你敢放心的把后背交给 AI? 我赌你不敢，那就来学学 AI 时代最安全的语言吧(Python无法战胜！)。本书拥有全面且深入的讲解、生动贴切的示例、德芙般丝滑的内容，这可能是目前最用心的 Rus...
...
- 🍴 👤 [atlas4381](https://github.com/atlas4381) Forked [TWRP-Test/android_bootable_recovery](https://github.com/TWRP-Test/android_bootable_recovery) to [atlas4381/android_bootable_recovery](https://github.com/atlas4381/android_bootable_recovery)
...
- 🌟 👤 [barry-ran](https://github.com/barry-ran) Starred [immortalwrt/immortalwrt](https://github.com/immortalwrt/immortalwrt)
  > An opensource OpenWrt variant for mainland China users.
- 🌟 👤 [barry-ran](https://github.com/barry-ran) Starred [wukongdaily/ImmortalWrt-ImageBuilder](https://github.com/wukongdaily/ImmortalWrt-ImageBuilder)
...
- 🌟 👤 [darbra](https://github.com/darbra) Starred [zqbxdev/webchat2api](https://github.com/zqbxdev/webchat2api)
  > OpenAI-compatible Web Chat API proxy with GPT/Grok account management

### [dzxpert](https://github.com/dzxpert)
- 🌟 👤 [dzxpert](https://github.com/dzxpert) Starred [Imbad0202/academic-research-skills](https://github.com/Imbad0202/academic-research-skills)
...
- 🌟 👤 [hellodword](https://github.com/hellodword) Starred [CloakHQ/CloakBrowser](https://github.com/CloakHQ/CloakBrowser)
...
- 🌟 👤 [hhhaiai](https://github.com/hhhaiai) Starred [libimobiledevice/idevicerestore](https://github.com/libimobiledevice/idevicerestore)
  > Restore/upgrade firmware of iOS devices
- 🌟 👤 [hhhaiai](https://github.com/hhhaiai) Starred [DEEIX-AI/DEEIX-Chat](https://github.com/DEEIX-AI/DEEIX-Chat)
  > An enterprise AI workspace for model routing, multimodal chat, files, tools, billing, identity, and ...

### [hyuunnn](https://github.com/hyuunnn)
- 🌟 👤 [hyuunnn](https://github.com/hyuunnn) Starred [elementalsouls/Claude-BugHunter](https://github.com/elementalsouls/Claude-BugHunter)
  > A Claude Code skill bundle for bug hunting and external red-team work - 51 skills, 15 slash commands...
- 🌟 👤 [hyuunnn](https://github.com/hyuunnn) Starred [yhs0602/Android-Disassembler](https://github.com/yhs0602/Android-Disassembler)
...
- 🌟 👤 [kenvix](https://github.com/kenvix) Starred [dsd2077/CyberVerse](https://github.com/dsd2077/CyberVerse)
  > Open-source real-time digital human agent platform. Build voice-first AI agents with WebRTC, persona...
...
- 🌟 👤 [kyle-sylvestre](https://github.com/kyle-sylvestre) Starred [DOS-History/Paterson-Listings](https://github.com/DOS-History/Paterson-Listings)
  > Transcription of Tim Paterson's DOS printouts.

### [leolovenet](https://github.com/leolovenet)
- 🌟 👤 [leolovenet](https://github.com/leolovenet) Starred [leolovenet/tailscale-routes](https://github.com/leolovenet/tailscale-routes)
  > macOS Tailscale exit node bypass route manager — bulk manage thousands of routes via PF_ROUTE socket

### [lightless233](https://github.com/lightless233)
- 🌟 👤 [lightless233](https://github.com/lightless233) Starred [colbymchenry/codegraph](https://github.com/colbymchenry/codegraph)
  > Pre-indexed code knowledge graph for Claude Code, Codex, Cursor, OpenCode, and Hermes Agent — fewer ...

### [linxid](https://github.com/linxid)
- 🌟 👤 [linxid](https://github.com/linxid) Starred [gokborayilmaz/daily-briefing-agent](https://github.com/gokborayilmaz/daily-briefing-agent)
  >  ☀️ Daily Executive Briefing Agent (Every day New AI Agent Twitter Series Day -1- Agent  is a execut...

### [lordidiot](https://github.com/lordidiot)
- 🌟 👤 [lordidiot](https://github.com/lordidiot) Starred [lukilabs/beautiful-mermaid](https://github.com/lukilabs/beautiful-mermaid)

### [lqqyt2423](https://github.com/lqqyt2423)
- 🌟 👤 [lqqyt2423](https://github.com/lqqyt2423) Starred [jianshuo/ccglass](https://github.com/jianshuo/ccglass)
  > See what your coding agent (Claude Code, Codex, Kimi) sends to the model — local proxy + web dashboa...
- 🌟 👤 [lqqyt2423](https://github.com/lqqyt2423) Starred [amatsuda/rubish](https://github.com/amatsuda/rubish)

### [marlkiller](https://github.com/marlkiller)
- 🌟 👤 [marlkiller](https://github.com/marlkiller) Starred [blacktop/ida-mcp-rs](https://github.com/blacktop/ida-mcp-rs)
...
- 🌟 👤 [prife](https://github.com/prife) Starred [perlin-network/life](https://github.com/perlin-network/life)
  > A secure WebAssembly VM catered for decentralized applications.
- 🌟 👤 [prife](https://github.com/prife) Starred [simeji/jid](https://github.com/simeji/jid)
  > json incremental digger
- 🌟 👤 [prife](https://github.com/prife) Starred [ynqa/jnv](https://github.com/ynqa/jnv)
  > Interactive JSON filter using jq
- 🌟 👤 [prife](https://github.com/prife) Starred [openai/symphony](https://github.com/openai/symphony)
  > Symphony turns project work into isolated, autonomous implementation runs, allowing teams to manage ...

### [pureqh](https://github.com/pureqh)
- 🌟 👤 [pureqh](https://github.com/pureqh) Starred [Z2j-dt/python_api](https://github.com/Z2j-dt/python_api)
  > 大同证券数据中台门户

### [qwqdanchun](https://github.com/qwqdanchun)
- 🌟 👤 [qwqdanchun](https://github.com/qwqdanchun) Starred [nettitude/CLR-Stomp](https://github.com/nettitude/CLR-Stomp)
  > .NET CLR-Stomping

### [r0t0tiller](https://github.com/r0t0tiller)
- 🍴 👤 [r0t0tiller](https://github.com/r0t0tiller) Forked [orinimron123/CVE-2026-40369-EXPLOIT](https://github.com/orinimron123/CVE-2026-40369-EXPLOIT) to [r0t0tiller/CVE-2026-40369-EXPLOIT](https://github.com/r0t0tiller/CVE-2026-40369-EXPLOIT)
...
- 🍴 👤 [salokrwhite](https://github.com/salokrwhite) Forked [Andrea-lyz/Scene-Port-Hider-by-eBPF](https://github.com/Andrea-lyz/Scene-Port-Hider-by-eBPF) to [salokrwhite/Scene-Port-Hider-by-eBPF](https://github.com/salokrwhite/Scene-Port-Hider-by-eBPF)
  > 隐藏Scene运行时的端口

### [shadow3aaa](https://github.com/shadow3aaa)
- 🌟 👤 [shadow3aaa](https://github.com/shadow3aaa) Starred [ericc-ch/copilot-api](https://github.com/ericc-ch/copilot-api)
...
- 🌟 👤 [skywind3000](https://github.com/skywind3000) Starred [chenshuo/dspfirst](https://github.com/chenshuo/dspfirst)
