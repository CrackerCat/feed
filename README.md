...
- 🌟 👤 [0xWhiteMage](https://github.com/0xWhiteMage) Starred [QuixiAI/open-gpu-kernel-modules](https://github.com/QuixiAI/open-gpu-kernel-modules)
...
- 🌟 👤 [FishMan132](https://github.com/FishMan132) Starred [34306/vphone-web](https://github.com/34306/vphone-web)
  > vphone-cli but you can use your mac as a host and control it over the web

### [FldBudin](https://github.com/FldBudin)
- 🌟 👤 [FldBudin](https://github.com/FldBudin) Starred [jiyin004-jpg/ommega](https://github.com/jiyin004-jpg/ommega)
...
- 🌟 👤 [Fplyth0ner-Combie](https://github.com/Fplyth0ner-Combie) Starred [s-b-repo/rustsploit](https://github.com/s-b-repo/rustsploit)
  > orgininaly this was a rewrite of routersploit rebuild in rust but it has grown and started shaping i...
- 🌟 👤 [Fplyth0ner-Combie](https://github.com/Fplyth0ner-Combie) Starred [fankh/vulnerability-poc](https://github.com/fankh/vulnerability-poc)
...
- 🍴 👤 [PhoenixHairpin](https://github.com/PhoenixHairpin) Forked [Lei-rr/ctyun-pro](https://github.com/Lei-rr/ctyun-pro) to [PhoenixHairpin/ctyun-pro](https://github.com/PhoenixHairpin/ctyun-pro)
- 🍴 👤 [PhoenixHairpin](https://github.com/PhoenixHairpin) Forked [liaoyh9422-creator/CLIProxyAPI](https://github.com/liaoyh9422-creator/CLIProxyAPI) to [PhoenixHairpin/CLIProxyAPI](https://github.com/PhoenixHairpin/CLIProxyAPI)
  > Android CLIProxy API service with smart caching, multi-guest key management and Tailscale integratio...
- 🍴 👤 [PhoenixHairpin](https://github.com/PhoenixHairpin) Forked [muyicn/ctyun-dashboard](https://github.com/muyicn/ctyun-dashboard) to [PhoenixHairpin/ctyun-dashboard](https://github.com/PhoenixHairpin/ctyun-dashboard)
  > 天翼云电脑保活及签到

### [PoomSmart](https://github.com/PoomSmart)
- 🌟 👤 [PoomSmart](https://github.com/PoomSmart) Starred [MobAI-App/simslim](https://github.com/MobAI-App/simslim)
...
- 🌟 👤 [SimonTheCoder](https://github.com/SimonTheCoder) Starred [nomi-san/parsec-vdd](https://github.com/nomi-san/parsec-vdd)
...
- 🌟 👤 [ThunderCls](https://github.com/ThunderCls) Starred [dstotijn/hetty](https://github.com/dstotijn/hetty)
  > An HTTP toolkit for security research.

### [Udyz](https://github.com/Udyz)
- 🌟 👤 [Udyz](https://github.com/Udyz) Starred [dinosn/mikrotrick-poc](https://github.com/dinosn/mikrotrick-poc)
...
- 🍴 👤 [Xieansecn](https://github.com/Xieansecn) Forked [zhishile/codex-auth-helper](https://github.com/zhishile/codex-auth-helper) to [Xieansecn/codex-auth-helper](https://github.com/Xieansecn/codex-auth-helper)
  > Codex登陆助手：安全地在本地导出您的已登录 ChatGPT 会话配置，生成符合 Codex 规范的 auth.json 本地备份文件。

### [Yervant7](https://github.com/Yervant7)
- 🌟 👤 [Yervant7](https://github.com/Yervant7) Starred [slint-ui/slint](https://github.com/slint-ui/slint)
  > Slint is an open-source declarative GUI toolkit to build native user interfaces for Rust, C++, JavaS...
- 🌟 👤 [Yervant7](https://github.com/Yervant7) Starred [MhmRdd/KernelPatch](https://github.com/MhmRdd/KernelPatch)
  > Patching and hooking the Linux kernel with only a stripped Linux kernel image.
- 🌟 👤 [Yervant7](https://github.com/Yervant7) Starred [Rouyashiki/Kasumi](https://github.com/Rouyashiki/Kasumi)
  > Kasumi - a kernel-level path manipulation and hiding framework
- 🌟 👤 [Yervant7](https://github.com/Yervant7) Starred [reveny/Android-Native-Root-Detector](https://github.com/reveny/Android-Native-Root-Detector)
...
- 🍴 👤 [ZhangZhuoSJTU](https://github.com/ZhangZhuoSJTU) Forked [direnv/direnv](https://github.com/direnv/direnv) to [ZhangZhuoSJTU/direnv](https://github.com/ZhangZhuoSJTU/direnv)
  > unclutter your .profile
- 🍴 👤 [ZhangZhuoSJTU](https://github.com/ZhangZhuoSJTU) Forked [ducaale/xh](https://github.com/ducaale/xh) to [ZhangZhuoSJTU/xh](https://github.com/ZhangZhuoSJTU/xh)
  > Friendly and fast tool for sending HTTP requests
- 🍴 👤 [ZhangZhuoSJTU](https://github.com/ZhangZhuoSJTU) Forked [FiloSottile/age](https://github.com/FiloSottile/age) to [ZhangZhuoSJTU/age](https://github.com/ZhangZhuoSJTU/age)
  > A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config opt...
- 🍴 👤 [ZhangZhuoSJTU](https://github.com/ZhangZhuoSJTU) Forked [Isona/dirble](https://github.com/Isona/dirble) to [ZhangZhuoSJTU/dirble](https://github.com/ZhangZhuoSJTU/dirble)
  > Fast directory scanning and scraping tool
- 🍴 👤 [ZhangZhuoSJTU](https://github.com/ZhangZhuoSJTU) Forked [Esubaalew/run](https://github.com/Esubaalew/run) to [ZhangZhuoSJTU/run](https://github.com/ZhangZhuoSJTU/run)
  > Universal multi-language runner and smart REPL written in Rust.
- 🍴 👤 [ZhangZhuoSJTU](https://github.com/ZhangZhuoSJTU) Forked [hush-shell/hush](https://github.com/hush-shell/hush) to [ZhangZhuoSJTU/hush](https://github.com/ZhangZhuoSJTU/hush)
  > Hush is a unix shell based on the Lua programming language
- 🍴 👤 [ZhangZhuoSJTU](https://github.com/ZhangZhuoSJTU) Forked [ivanceras/svgbob](https://github.com/ivanceras/svgbob) to [ZhangZhuoSJTU/svgbob](https://github.com/ZhangZhuoSJTU/svgbob)
  > Convert your ascii diagram scribbles into happy little SVG
- 🍴 👤 [ZhangZhuoSJTU](https://github.com/ZhangZhuoSJTU) Forked [lua/lua](https://github.com/lua/lua) to [ZhangZhuoSJTU/lua](https://github.com/ZhangZhuoSJTU/lua)
  > A copy of the Lua development repository, as seen by the Lua team. Mirrored irregularly. All communi...
- 🍴 👤 [ZhangZhuoSJTU](https://github.com/ZhangZhuoSJTU) Forked [LuaJIT/LuaJIT](https://github.com/LuaJIT/LuaJIT) to [ZhangZhuoSJTU/LuaJIT](https://github.com/ZhangZhuoSJTU/LuaJIT)
  > Mirror of the LuaJIT git repository
- 🍴 👤 [ZhangZhuoSJTU](https://github.com/ZhangZhuoSJTU) Forked [sharkdp/hyperfine](https://github.com/sharkdp/hyperfine) to [ZhangZhuoSJTU/hyperfine](https://github.com/ZhangZhuoSJTU/hyperfine)
  > A command-line benchmarking tool
- 🍴 👤 [ZhangZhuoSJTU](https://github.com/ZhangZhuoSJTU) Forked [ip7z/7zip](https://github.com/ip7z/7zip) to [ZhangZhuoSJTU/7zip](https://github.com/ZhangZhuoSJTU/7zip)
  > 7-Zip
- 🍴 👤 [ZhangZhuoSJTU](https://github.com/ZhangZhuoSJTU) Forked [Miserlou/Loop](https://github.com/Miserlou/Loop) to [ZhangZhuoSJTU/Loop](https://github.com/ZhangZhuoSJTU/Loop)
  > UNIX's missing `loop` command
- 🍴 👤 [ZhangZhuoSJTU](https://github.com/ZhangZhuoSJTU) Forked [nachoparker/dutree](https://github.com/nachoparker/dutree) to [ZhangZhuoSJTU/dutree](https://github.com/ZhangZhuoSJTU/dutree)
  > a tool to analyze file system usage written in Rust
- 🍴 👤 [ZhangZhuoSJTU](https://github.com/ZhangZhuoSJTU) Forked [o2sh/onefetch](https://github.com/o2sh/onefetch) to [ZhangZhuoSJTU/onefetch](https://github.com/ZhangZhuoSJTU/onefetch)
  > Command-line Git information tool
- 🍴 👤 [ZhangZhuoSJTU](https://github.com/ZhangZhuoSJTU) Forked [ogham/dog](https://github.com/ogham/dog) to [ZhangZhuoSJTU/dog](https://github.com/ZhangZhuoSJTU/dog)
  > A command-line DNS client.
- 🍴 👤 [ZhangZhuoSJTU](https://github.com/ZhangZhuoSJTU) Forked [raviqqe/muffet](https://github.com/raviqqe/muffet) to [ZhangZhuoSJTU/muffet](https://github.com/ZhangZhuoSJTU/muffet)
  > Fast website link checker in Go
- 🍴 👤 [ZhangZhuoSJTU](https://github.com/ZhangZhuoSJTU) Forked [robertdavidgraham/masscan](https://github.com/robertdavidgraham/masscan) to [ZhangZhuoSJTU/masscan](https://github.com/ZhangZhuoSJTU/masscan)
...
- 🍴 👤 [aviraxp](https://github.com/aviraxp) Forked [YuKongA/ghostlock-app](https://github.com/YuKongA/ghostlock-app) to [aviraxp/ghostlock-app](https://github.com/aviraxp/ghostlock-app)
...
- 🌟 👤 [cyal1](https://github.com/cyal1) Starred [MegatronKing/NetBare-Android](https://github.com/MegatronKing/NetBare-Android)
  > Net packets capture & injection library designed for Android

### [darbra](https://github.com/darbra)
- 🌟 👤 [darbra](https://github.com/darbra) Starred [ysharma3501/LuxTTS](https://github.com/ysharma3501/LuxTTS)
  > A high-quality rapid TTS voice cloning model that reaches speeds of 150x realtime.
- 🌟 👤 [darbra](https://github.com/darbra) Starred [Ccccccccvvm/qemu-android-arm64](https://github.com/Ccccccccvvm/qemu-android-arm64)
...
- 🌟 👤 [feicong](https://github.com/feicong) Starred [shuaiplus/nodewarden](https://github.com/shuaiplus/nodewarden)
  > Bitwarden-compatible server running on Cloudflare Workers
- 🌟 👤 [feicong](https://github.com/feicong) Starred [elliothux/open-compute](https://github.com/elliothux/open-compute)
...
- 🌟 👤 [hyuunnn](https://github.com/hyuunnn) Starred [anthropics/commerce-agents](https://github.com/anthropics/commerce-agents)
  > Reference blueprint for building shopping and merchant agents with Claude. Examples in retail, comme...
- 🌟 👤 [hyuunnn](https://github.com/hyuunnn) Starred [MiaAI-Lab/Qwen3.8-Flash-Next-Single-DGX-Spark](https://github.com/MiaAI-Lab/Qwen3.8-Flash-Next-Single-DGX-Spark)
  > Qwen3.8-Flash-Next on ONE DGX Spark (TP=1)

### [idkhidden](https://github.com/idkhidden)
- 🌟 👤 [idkhidden](https://github.com/idkhidden) Starred [icedland/iced](https://github.com/icedland/iced)
...
- 🌟 👤 [j0nk0](https://github.com/j0nk0) Starred [htimesnine/DarkSword-RCE](https://github.com/htimesnine/DarkSword-RCE)
...
- 🌟 👤 [jmpews](https://github.com/jmpews) Starred [agfnow/agentflow](https://github.com/agfnow/agentflow)
  > File-logged conversation protocol and on-demand development pipeline
- 🌟 👤 [jmpews](https://github.com/jmpews) Starred [icodesign/remote-installer](https://github.com/icodesign/remote-installer)
  > Quickly install signed iOS and Android builds on real devices over the internet without waiting for ...
- 🌟 👤 [jmpews](https://github.com/jmpews) Starred [insidegui/VirtualBuddy](https://github.com/insidegui/VirtualBuddy)
  > Virtualize macOS 12 and later on Apple Silicon, VirtualBuddy is a virtual machine GUI for macOS M1, ...
- 🌟 👤 [jmpews](https://github.com/jmpews) Starred [rxliuli/AppDowngrader](https://github.com/rxliuli/AppDowngrader)
  > Downgrade iOS apps to older versions
- 🌟 👤 [jmpews](https://github.com/jmpews) Starred [rfk1118/okx-bnexchange](https://github.com/rfk1118/okx-bnexchange)
  > 没啥用
- 🌟 👤 [jmpews](https://github.com/jmpews) Starred [rfk1118/exchages_open](https://github.com/rfk1118/exchages_open)
...
- 🚀 👤 [kkkgo](https://github.com/kkkgo) Made [kkkgo/stmp2log](https://github.com/kkkgo/stmp2log) public

### [kujian](https://github.com/kujian)
- 🌟 👤 [kujian](https://github.com/kujian) Starred [AgriciDaniel/claude-seo](https://github.com/AgriciDaniel/claude-seo)
...
- 🌟 👤 [kyle-sylvestre](https://github.com/kyle-sylvestre) Starred [wfr/unshieldv3](https://github.com/wfr/unshieldv3)
  > Extract InstallShield V3 archives (*.Z)

### [lanyi233](https://github.com/lanyi233)
- 🌟 👤 [lanyi233](https://github.com/lanyi233) Starred [shuaiplus/nodewarden](https://github.com/shuaiplus/nodewarden)
  > Bitwarden-compatible server running on Cloudflare Workers

### [lightless233](https://github.com/lightless233)
- 🌟 👤 [lightless233](https://github.com/lightless233) Starred [MoonTechLab/LunaTV](https://github.com/MoonTechLab/LunaTV)
  > 本项目采用 CC BY-NC-SA 协议，禁止任何商业化行为，任何衍生项目必须保留本项目地址并以相同协议开源

### [lightsummer233](https://github.com/lightsummer233)
- 🌟 👤 [lightsummer233](https://github.com/lightsummer233) Starred [YuKongA/ghostlock-app](https://github.com/YuKongA/ghostlock-app)
  > GhostLock One-Tap Execution App (CVE-2026-43499)

### [liuzjMr](https://github.com/liuzjMr)
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [iconben/z-image-studio](https://github.com/iconben/z-image-studio) to [liuzjMr/z-image-studio](https://github.com/liuzjMr/z-image-studio)
  > A Cli, a webUI, and a MCP server for the Z-Image-Turbo text-to-image generation model (Tongyi-MAI/Z-...
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [KrissTos/off-line-Image-gen-mac](https://github.com/KrissTos/off-line-Image-gen-mac) to [liuzjMr/off-line-Image-gen-mac](https://github.com/liuzjMr/off-line-Image-gen-mac)
  > Fully offline AI image generation for Mac Silicon (MPS). FLUX.2, Z-Image Turbo, LTX-Video — no cloud...
- 🌟 👤 [liuzjMr](https://github.com/liuzjMr) Starred [NormanMises/z-image-turbo-modal-openai-api](https://github.com/NormanMises/z-image-turbo-modal-openai-api)
  > Deploy Z-Image-Turbo on Modal as an OpenAI-compatible Images API.
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [NormanMises/z-image-turbo-modal-openai-api](https://github.com/NormanMises/z-image-turbo-modal-openai-api) to [liuzjMr/z-image-turbo-modal-openai-api](https://github.com/liuzjMr/z-image-turbo-modal-openai-api)
  > Deploy Z-Image-Turbo on Modal as an OpenAI-compatible Images API.
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [YLiu95/z-image-turbo-kaggle](https://github.com/YLiu95/z-image-turbo-kaggle) to [liuzjMr/z-image-turbo-kaggle](https://github.com/liuzjMr/z-image-turbo-kaggle)
  > z image turbo kaggle
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [pusatpakaiankime-bit/warm-bedroom-ootd-storyboard](https://github.com/pusatpakaiankime-bit/warm-bedroom-ootd-storyboard) to [liuzjMr/warm-bedroom-ootd-storyboard](https://github.com/liuzjMr/warm-bedroom-ootd-storyboard)
  > Codex skill for warm-bedroom OOTD storyboards and Kling, OMNI Flash, Seedance 2.0 prompts
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [Wyx-08/my-daily-ootd](https://github.com/Wyx-08/my-daily-ootd) to [liuzjMr/my-daily-ootd](https://github.com/liuzjMr/my-daily-ootd)
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [iiiiii107/ootd](https://github.com/iiiiii107/ootd) to [liuzjMr/ootd](https://github.com/liuzjMr/ootd)
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [anaiysaa/OOTD](https://github.com/anaiysaa/OOTD) to [liuzjMr/OOTD-anaiysaa](https://github.com/liuzjMr/OOTD-anaiysaa)
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [18120166903/ootd-fashion-workstation](https://github.com/18120166903/ootd-fashion-workstation) to [liuzjMr/ootd-fashion-workstation](https://github.com/liuzjMr/ootd-fashion-workstation)
  > OOTD 穿搭工作台 - 虚拟换装 PWA 应用
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [openkaiwu/OOTD](https://github.com/openkaiwu/OOTD) to [liuzjMr/openkaiwu-OOTD](https://github.com/liuzjMr/openkaiwu-OOTD)
  > 明天穿什么（OOTD）——本地衣橱与穿搭推荐 Android 应用（UniApp + Android WebView 壳）
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [Surge-Dan/ootd-color-compass](https://github.com/Surge-Dan/ootd-color-compass) to [liuzjMr/ootd-color-compass](https://github.com/liuzjMr/ootd-color-compass)
  > 自制小红书小工具：OOTD色彩雷达。离线优先的OOTD配色诊断工具：从穿搭照片中提取主色，分析配色关系与风格倾向，并提供可执行的穿搭优化建议。
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [SelinaZ07/OOTD-generator](https://github.com/SelinaZ07/OOTD-generator) to [liuzjMr/OOTD-generator](https://github.com/liuzjMr/OOTD-generator)
  > This is an outfit generator that help users pick out their outfit for the day based on the weather.
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [leah-yabu/OOTD](https://github.com/leah-yabu/OOTD) to [liuzjMr/leah-yabu-OOTD](https://github.com/liuzjMr/leah-yabu-OOTD)
  > Muse Wardrobe 是一个本地优先的智能穿搭管理与虚拟试穿应用。支持衣物上传、衣橱分类、上装/下装/连衣裙自由搭配、每日穿搭推荐、后台生成试穿效果、图案细节复核、穿搭记录、洗涤冷却、本地图片缓...
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [jassie-ee/OOTDify](https://github.com/jassie-ee/OOTDify) to [liuzjMr/OOTDify](https://github.com/liuzjMr/OOTDify)
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [piefermecklerb45976-spec/ootd-mini-program](https://github.com/piefermecklerb45976-spec/ootd-mini-program) to [liuzjMr/ootd-mini-program](https://github.com/liuzjMr/ootd-mini-program)
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [yizhi-chengzi/video-ai-talking](https://github.com/yizhi-chengzi/video-ai-talking) to [liuzjMr/video-ai-talking](https://github.com/liuzjMr/video-ai-talking)
  > 想做真人口播，又不必自己对着镜头念。上传一段真人出镜视频，写好字幕，本机配音并对口型，合成竖屏 MP4。密钥只留在浏览器里。
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [Vincentwei1021/video-shotcraft](https://github.com/Vincentwei1021/video-shotcraft) to [liuzjMr/video-shotcraft](https://github.com/liuzjMr/video-shotcraft)
  > AI video skill for Claude Code & Codex — cinematic product videos with Remotion: 152 shot recipe car...
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [liyue-aigc/female-outfit-director](https://github.com/liyue-aigc/female-outfit-director) to [liuzjMr/female-outfit-director](https://github.com/liuzjMr/female-outfit-director)
  > 女性多套穿搭拼贴首帧与卡点换装视频导演 Skill
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [Mr-funny/hbg-classical-poem-silk-video](https://github.com/Mr-funny/hbg-classical-poem-silk-video) to [liuzjMr/hbg-classical-poem-silk-video](https://github.com/liuzjMr/hbg-classical-poem-silk-video)
  > Agent Skill for turning Chinese classical poems into vertical Chinese-art videos with ImageGen still...
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [bytec-ai/book-video-factory](https://github.com/bytec-ai/book-video-factory) to [liuzjMr/book-video-factory](https://github.com/liuzjMr/book-video-factory)
  > 通用、可移植的多账号图书短视频生产 Skill
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [Endless1936/book-video](https://github.com/Endless1936/book-video) to [liuzjMr/book-video](https://github.com/liuzjMr/book-video)
  > A natural-language workflow for creating atmospheric short book videos with AI-generated visuals, Hy...

### [longtaoge](https://github.com/longtaoge)
- 🍴 👤 [longtaoge](https://github.com/longtaoge) Forked [garychowcmu/daizhigev20](https://github.com/garychowcmu/daizhigev20) to [longtaoge/daizhigev20](https://github.com/longtaoge/daizhigev20)
  > 殆知阁古代文献
- 🌟 👤 [longtaoge](https://github.com/longtaoge) Starred [longtaoge/daizhigev20](https://github.com/longtaoge/daizhigev20)
  > 殆知阁古代文献

### [lqqyt2423](https://github.com/lqqyt2423)
- 🌟 👤 [lqqyt2423](https://github.com/lqqyt2423) Starred [brendanzab/language-garden](https://github.com/brendanzab/language-garden)
  > A garden of small programming language implementations 🪴

### [lz6688](https://github.com/lz6688)
- 🍴 👤 [lz6688](https://github.com/lz6688) Forked [linshenkx/prompt-optimizer](https://github.com/linshenkx/prompt-optimizer) to [lz6688/prompt-optimizer](https://github.com/lz6688/prompt-optimizer)
  > An AI prompt optimizer for writing better prompts and getting better AI results.
- 🍴 👤 [lz6688](https://github.com/lz6688) Forked [gofiber/fiber](https://github.com/gofiber/fiber) to [lz6688/fiber](https://github.com/lz6688/fiber)
  > ⚡️ Express inspired web framework written in Go
- 🍴 👤 [lz6688](https://github.com/lz6688) Forked [gin-gonic/gin](https://github.com/gin-gonic/gin) to [lz6688/gin](https://github.com/lz6688/gin)
  > Gin is a high-performance HTTP web framework written in Go. It provides a Martini-like API but with ...
- 🌟 👤 [lz6688](https://github.com/lz6688) Starred [dongyubin/DockerHub](https://github.com/dongyubin/DockerHub)
  > 2026年9月更新，目前国内可用Docker镜像源汇总，DockerHub国内镜像加速列表，🚀DockerHub镜像加速器

### [mcxiaoke](https://github.com/mcxiaoke)
- 🌟 👤 [mcxiaoke](https://github.com/mcxiaoke) Starred [sigoden/dufs](https://github.com/sigoden/dufs)
  > A file server that supports static serving, uploading, searching, accessing control, webdav...
- 🌟 👤 [mcxiaoke](https://github.com/mcxiaoke) Starred [gtsteffaniak/filebrowser](https://github.com/gtsteffaniak/filebrowser)
  > 📂 Web File Browser
- 🌟 👤 [mcxiaoke](https://github.com/mcxiaoke) Starred [pldubouilh/gossa](https://github.com/pldubouilh/gossa)
...
- 🌟 👤 [mzfr](https://github.com/mzfr) Starred [CapSoftware/Cap](https://github.com/CapSoftware/Cap)
...
- 🌟 👤 [null-dev](https://github.com/null-dev) Starred [AzaharPlus/AzaharPlus](https://github.com/AzaharPlus/AzaharPlus)
  > A fork of the Azahar 3DS emulator with extra features
- 🌟 👤 [null-dev](https://github.com/null-dev) Starred [azahar-emu/azahar](https://github.com/azahar-emu/azahar)
  > An open-source 3DS emulator project based on Citra.
- 🌟 👤 [null-dev](https://github.com/null-dev) Starred [OFFTKP/felix86](https://github.com/OFFTKP/felix86)
...
- 🌟 👤 [oobbb](https://github.com/oobbb) Starred [dmzz-yyhyy/LightNovelReader](https://github.com/dmzz-yyhyy/LightNovelReader)
...
- 🌟 👤 [ravindu644](https://github.com/ravindu644) Starred [remotion-dev/skills](https://github.com/remotion-dev/skills)
  > Agent Skills
...
- 🍴 👤 [sh1ma](https://github.com/sh1ma) Forked [cloudflare/cloudflare-os](https://github.com/cloudflare/cloudflare-os) to [sh1ma/cloudflare-os](https://github.com/sh1ma/cloudflare-os)
...
- 🌟 👤 [sjshb57](https://github.com/sjshb57) Starred [DimensionDev/Flare](https://github.com/DimensionDev/Flare)
  > Browse Mastodon, Bluesky, X, Misskey, Nostr, Pixiv, Fanbox and RSS all in one app. One timeline, all...
- 🌟 👤 [sjshb57](https://github.com/sjshb57) Starred [kid1412621/SummaryExpressive](https://github.com/kid1412621/SummaryExpressive)
  > A modern, BYOK and FOSS android app to summarize videos(YouTube, BiliBili), articles, images and doc...
- 🌟 👤 [sjshb57](https://github.com/sjshb57) Starred [YuKongA/ghostlock-app](https://github.com/YuKongA/ghostlock-app)
  > GhostLock One-Tap Execution App (CVE-2026-43499)
- 🍴 👤 [sjshb57](https://github.com/sjshb57) Forked [lz233/Tarnhelm](https://github.com/lz233/Tarnhelm) to [sjshb57/Tarnhelm-R](https://github.com/sjshb57/Tarnhelm-R)
...
- 🌟 👤 [wangshub](https://github.com/wangshub) Starred [volcengine/OpenViking](https://github.com/volcengine/OpenViking)
...
- 🚀 👤 [wuhan005](https://github.com/wuhan005) Made [wuhan005/LightStick](https://github.com/wuhan005/LightStick) public
  > 点亮许嵩演唱会荧光棒

### [wxhzhwxhzh](https://github.com/wxhzhwxhzh)
- 🌟 👤 [wxhzhwxhzh](https://github.com/wxhzhwxhzh) Starred [go-gost/gost](https://github.com/go-gost/gost)
  > GO Simple Tunnel - a simple tunnel written in golang
- 🌟 👤 [wxhzhwxhzh](https://github.com/wxhzhwxhzh) Starred [go-gost/gost-ui](https://github.com/go-gost/gost-ui)
  > web ui for GOST API management

### [wy876](https://github.com/wy876)
- 🌟 👤 [wy876](https://github.com/wy876) Starred [XSecurityCN/XProxy](https://github.com/XSecurityCN/XProxy)
...
- 🌟 👤 [x7dbg](https://github.com/x7dbg) Starred [Terralyp/UnrealDbg-VT-engine](https://github.com/Terralyp/UnrealDbg-VT-engine)
...
- 🌟 👤 [xingguangcuican6666](https://github.com/xingguangcuican6666) Starred [junhoyeo/tokscale](https://github.com/junhoyeo/tokscale)
  > 🛰️ Track token usage across AI coding agents from your terminal. 🏅 Global leaderboard with trillions...

### [xubenji](https://github.com/xubenji)
- 🌟 👤 [xubenji](https://github.com/xubenji) Starred [canarybyte/veridrop](https://github.com/canarybyte/veridrop)
...
- 🌟 👤 [yanyaoli](https://github.com/yanyaoli) Starred [tencentmusic/jugg](https://github.com/tencentmusic/jugg)
...
- 🌟 👤 [yhs0602](https://github.com/yhs0602) Starred [edwardkim/rhwp](https://github.com/edwardkim/rhwp)
  > 아래한글 hwp viewer and editor by rust and wasm
- 🌟 👤 [yhs0602](https://github.com/yhs0602) Starred [golbin/hop](https://github.com/golbin/hop)

### [yifengyou](https://github.com/yifengyou)
- 🌟 👤 [yifengyou](https://github.com/yifengyou) Starred [zhangyumingsh/uboot-rk3588-v2024](https://github.com/zhangyumingsh/uboot-rk3588-v2024)

### [zer0def](https://github.com/zer0def)
- 🌟 👤 [zer0def](https://github.com/zer0def) Starred [keymapperorg/KeyMapperHackersKeyboard](https://github.com/keymapperorg/KeyMapperHackersKeyboard)
  > Hacker's Keyboard (official)
- 🌟 👤 [zer0def](https://github.com/zer0def) Starred [Gabriel2392/ErosFlashTool](https://github.com/Gabriel2392/ErosFlashTool)
  > Non-Root Alternative to Odin/Heimdall.
- 🌟 👤 [zer0def](https://github.com/zer0def) Starred [ianka/xfs_undelete](https://github.com/ianka/xfs_undelete)
  > An undelete tool for the XFS filesystem.
- 🌟 👤 [zer0def](https://github.com/zer0def) Starred [dijia1124/PlusPlusBattery](https://github.com/dijia1124/PlusPlusBattery)
  > A lightweight battery info and health estimation tool.
- 🌟 👤 [zer0def](https://github.com/zer0def) Starred [cafali/SnapKey](https://github.com/cafali/SnapKey)
  > SnapKey provides a user-friendly Razer Snap Tap/Wooting SOCD alternative, making it accessible acros...
- 🌟 👤 [zer0def](https://github.com/zer0def) Starred [massivemadness/Squircle-CE](https://github.com/massivemadness/Squircle-CE)
  > 👨‍💻 Squircle CE is a fast and free multi-language code editor for Android
- 🌟 👤 [zer0def](https://github.com/zer0def) Starred [DynamoRIO/drmemory](https://github.com/DynamoRIO/drmemory)
  > Memory Debugger for Windows, Linux, Mac, and Android

### [zhangyoufu](https://github.com/zhangyoufu)
- 🌟 👤 [zhangyoufu](https://github.com/zhangyoufu) Starred [agegr/pi-web](https://github.com/agegr/pi-web)
  > Web UI for the pi coding agent
- 🌟 👤 [zhangyoufu](https://github.com/zhangyoufu) Starred [inja-online/llm-gateway](https://github.com/inja-online/llm-gateway)
  > Inja LLM Gateway — stateless OpenAI/Anthropic API gateway with multi-provider routing and usage hook...
