...
- 🌟 👤 [Proteas](https://github.com/Proteas) Starred [eliben/pykaleidoscope](https://github.com/eliben/pykaleidoscope)
  > Implementation of the LLVM tutorial in Python using llvmlite
- 🌟 👤 [Proteas](https://github.com/Proteas) Starred [typst/typst](https://github.com/typst/typst)
...
- 🌟 👤 [THISISAGOODNAME](https://github.com/THISISAGOODNAME) Starred [websnarf/bstrlib](https://github.com/websnarf/bstrlib)
  > The Better String Library

### [WAY29](https://github.com/WAY29)
- 🍴 👤 [WAY29](https://github.com/WAY29) Forked [glanceapp/glance](https://github.com/glanceapp/glance) to [WAY29/glance](https://github.com/WAY29/glance)
  > A self-hosted dashboard that puts all your feeds in one place

### [ak47king](https://github.com/ak47king)
- 🌟 👤 [ak47king](https://github.com/ak47king) Starred [CrackerCat/FartExt](https://github.com/CrackerCat/FartExt)
...
- 🌟 👤 [duanluan](https://github.com/duanluan) Starred [fmhy/edit](https://github.com/fmhy/edit)
  > Make changes to FMHY
- 🌟 👤 [duanluan](https://github.com/duanluan) Starred [loks666/get_jobs](https://github.com/loks666/get_jobs)
...
- 🌟 👤 [h3h3qaq](https://github.com/h3h3qaq) Starred [NPC2000/elf_to_shellcode](https://github.com/NPC2000/elf_to_shellcode)
  > 将任何 elf 或命令转换为 shellcode
- 🌟 👤 [h3h3qaq](https://github.com/h3h3qaq) Starred [spipm/Depixelization_poc](https://github.com/spipm/Depixelization_poc)
  > Depix is a PoC for a technique to recover plaintext from pixelized screenshots.

### [h4sh5](https://github.com/h4sh5)
- ✨ 👤 [h4sh5](https://github.com/h4sh5) Created new repo [h4sh5/optar-fork](https://github.com/h4sh5/optar-fork)
  > github fork and mirror of https://ronja.twibright.com/optar/
...
- 🌟 👤 [jiji262](https://github.com/jiji262) Starred [lzA6/inception-2api](https://github.com/lzA6/inception-2api)
  > 本仓库只做教学思路，都均在合理的范围中使用

### [jpillora](https://github.com/jpillora)
- 🌟 👤 [jpillora](https://github.com/jpillora) Starred [timelinize/timelinize](https://github.com/timelinize/timelinize)
...
- 🌟 👤 [luochuanyuewu](https://github.com/luochuanyuewu) Starred [1Panel-dev/appstore](https://github.com/1Panel-dev/appstore)
...
- 🌟 👤 [mzfr](https://github.com/mzfr) Starred [Ch0pin/uncrackable](https://github.com/Ch0pin/uncrackable)
...
### [tftrtcuh](https://github.com/tftrtcuh)
- 🍴 👤 [tftrtcuh](https://github.com/tftrtcuh) Forked [CrackerCat/windows-docker](https://github.com/CrackerCat/windows-docker) to [tftrtcuh/windows-docker](https://github.com/tftrtcuh/windows-docker)
...
- 🌟 👤 [yhnu](https://github.com/yhnu) Starred [p0deje/Maccy](https://github.com/p0deje/Maccy)
  > Lightweight clipboard manager for macOS
- 🌟 👤 [yhnu](https://github.com/yhnu) Starred [EcoPasteHub/EcoPaste](https://github.com/EcoPasteHub/EcoPaste)
  > 🎉跨平台的剪贴板管理工具 | Cross-platform clipboard management tool

### [yhs0602](https://github.com/yhs0602)
- 🌟 👤 [yhs0602](https://github.com/yhs0602) Starred [Pryaxis/TShock](https://github.com/Pryaxis/TShock)
