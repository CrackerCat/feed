...
- 🌟 👤 [AabyssZG](https://github.com/AabyssZG) Starred [oops4git/ShellCode-Interpreter](https://github.com/oops4git/ShellCode-Interpreter)
  > ShellCode 解释器 (样例)，无可执行权限加载 ShellCode (点点 Star，非常感谢!)
- 🌟 👤 [AabyssZG](https://github.com/AabyssZG) Starred [ricardojoserf/SAMDump](https://github.com/ricardojoserf/SAMDump)
  > Extract the SAM and SYSTEM hives using the Volume Shadow Copy (VSS) API. With exfiltration and XOR o...

### [AlexiaChen](https://github.com/AlexiaChen)
- 🌟 👤 [AlexiaChen](https://github.com/AlexiaChen) Starred [BIMCoderLiang/LNLib](https://github.com/BIMCoderLiang/LNLib)
  > NURBS Algorithms Library, match the NURBS Book
...
- 🌟 👤 [ctkqiang](https://github.com/ctkqiang) Starred [KuekHaoYang/KVideo](https://github.com/KuekHaoYang/KVideo)
