...
### [Aquariushsj](https://github.com/Aquariushsj)
- 🌟 👤 [Aquariushsj](https://github.com/Aquariushsj) Starred [aliasrobotics/cai](https://github.com/aliasrobotics/cai)
...
- 🍴 👤 [CrackerCat](https://github.com/CrackerCat) Forked [CrackerCat/NPatch](https://github.com/CrackerCat/NPatch) to [CrackerCat/NPatch](https://github.com/CrackerCat/NPatch)
...
### [Raymond8174](https://github.com/Raymond8174)
- 🌟 👤 [Raymond8174](https://github.com/Raymond8174) Starred [aliasrobotics/cai](https://github.com/aliasrobotics/cai)
  > Cybersecurity AI (CAI), the framework for AI Security
...
### [bukharyay](https://github.com/bukharyay)
- 🌟 👤 [bukharyay](https://github.com/bukharyay) Starred [aliasrobotics/cai](https://github.com/aliasrobotics/cai)
  > Cybersecurity AI (CAI), the framework for AI Security
...
### [passer12](https://github.com/passer12)
- 🌟 👤 [passer12](https://github.com/passer12) Starred [aliasrobotics/cai](https://github.com/aliasrobotics/cai)
  > Cybersecurity AI (CAI), the framework for AI Security

### [qiyuanyu0602](https://github.com/qiyuanyu0602)
- 🌟 👤 [qiyuanyu0602](https://github.com/qiyuanyu0602) Starred [dibingfa/flash-linux0.11-talk](https://github.com/dibingfa/flash-linux0.11-talk)
  > 你管这破玩意叫操作系统源码 — 像小说一样品读 Linux 0.11 核心代码
...
### [renjinxi](https://github.com/renjinxi)
- 🌟 👤 [renjinxi](https://github.com/renjinxi) Starred [Jack-Cherish/PythonPark](https://github.com/Jack-Cherish/PythonPark)
  > Python 开源项目之「自学编程之路」，保姆级教程：AI实验室、宝藏视频、数据结构、学习指南、机器学习实战、深度学习实战、网络爬虫、大厂面经、程序人生、资源分享。

### [snowsong42](https://github.com/snowsong42)
- 🌟 👤 [snowsong42](https://github.com/snowsong42) Starred [dibingfa/flash-linux0.11-talk](https://github.com/dibingfa/flash-linux0.11-talk)
  > 你管这破玩意叫操作系统源码 — 像小说一样品读 Linux 0.11 核心代码
...
### [talk2noob](https://github.com/talk2noob)
