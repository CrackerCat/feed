...
- 🌟 👤 [0x1c1101](https://github.com/0x1c1101) Starred [MatheuZSecurity/ksentinel](https://github.com/MatheuZSecurity/ksentinel)
  > Linux kernel integrity monitor for detecting syscall hooking

### [AlexiaChen](https://github.com/AlexiaChen)
- 🌟 👤 [AlexiaChen](https://github.com/AlexiaChen) Starred [zeroclaw-labs/zeroclaw](https://github.com/zeroclaw-labs/zeroclaw)
  > Fast, small, and fully autonomous AI assistant infrastructure — deploy anywhere, swap anything 🦀
- 🌟 👤 [AlexiaChen](https://github.com/AlexiaChen) Starred [sipeed/picoclaw](https://github.com/sipeed/picoclaw)
  > Tiny, Fast, and Deployable anywhere — automate the mundane, unleash your creativity

### [AlongWY](https://github.com/AlongWY)
- 🌟 👤 [AlongWY](https://github.com/AlongWY) Starred [zeroclaw-labs/zeroclaw](https://github.com/zeroclaw-labs/zeroclaw)
  > Fast, small, and fully autonomous AI assistant infrastructure — deploy anywhere, swap anything 🦀
- 🌟 👤 [AlongWY](https://github.com/AlongWY) Starred [moltis-org/moltis](https://github.com/moltis-org/moltis)
...
- 🍴 👤 [Enaium](https://github.com/Enaium) Forked [wszqkzqk/PvZ-Portable](https://github.com/wszqkzqk/PvZ-Portable) to [Enaium-Fork/PvZ-Portable](https://github.com/Enaium-Fork/PvZ-Portable)
...
- 🌟 👤 [G4rb3n](https://github.com/G4rb3n) Starred [BiboyQG/WeChat-MCP](https://github.com/BiboyQG/WeChat-MCP)
...
- 🍴 👤 [KHwang9883](https://github.com/KHwang9883) Forked [InnovationLeap/super-mario-worker-project-2](https://github.com/InnovationLeap/super-mario-worker-project-2) to [KHwang9883/super-mario-worker-project-2](https://github.com/KHwang9883/super-mario-worker-project-2)
  > SMWP 2 (Super Mario Worker Project 2)
...
- 🌟 👤 [Lz1y](https://github.com/Lz1y) Starred [MaorSabag/Adaptix-StealthPalace](https://github.com/MaorSabag/Adaptix-StealthPalace)
  > Crystal Palace RDLL loader for Adaptix C2 with Ekko sleep obfuscation, IAT hooking via PICO, and per...
- 🌟 👤 [Lz1y](https://github.com/Lz1y) Starred [kozmer/dcsync-bof](https://github.com/kozmer/dcsync-bof)
  > dcsync bof

### [Mati365](https://github.com/Mati365)
- 🌟 👤 [Mati365](https://github.com/Mati365) Starred [boricj/ghidra-delinker-extension](https://github.com/boricj/ghidra-delinker-extension)
...
- 🌟 👤 [Nep-Timeline](https://github.com/Nep-Timeline) Starred [chsbuffer/ReVancedXposed_Spotify](https://github.com/chsbuffer/ReVancedXposed_Spotify)
...
- 🌟 👤 [Super12138](https://github.com/Super12138) Starred [hi-manshu/kalendar](https://github.com/hi-manshu/kalendar)
...
- 🌟 👤 [XiaoliChan](https://github.com/XiaoliChan) Starred [zeroclaw-labs/zeroclaw](https://github.com/zeroclaw-labs/zeroclaw)
  > Fast, small, and fully autonomous AI assistant infrastructure — deploy anywhere, swap anything 🦀

### [ZJ595](https://github.com/ZJ595)
- 🌟 👤 [ZJ595](https://github.com/ZJ595) Starred [JimLiu/baoyu-skills](https://github.com/JimLiu/baoyu-skills)
...
- 🌟 👤 [cn-kali-team](https://github.com/cn-kali-team) Starred [moltis-org/moltis](https://github.com/moltis-org/moltis)
  > A personal AI assistant built in Rust. Single binary, multi-provider LLMs, long-term memory, sandbox...

### [codehz](https://github.com/codehz)
- 🌟 👤 [codehz](https://github.com/codehz) Starred [voltropy/volt](https://github.com/voltropy/volt)
...
- 🌟 👤 [dlitz](https://github.com/dlitz) Starred [fragglet/ipxbox](https://github.com/fragglet/ipxbox)
  > DOSbox IPX-over-UDP server with TAP integration, built-in PPTP server, Quake server proxying and man...
- 🌟 👤 [dlitz](https://github.com/dlitz) Starred [collosdeveloper/IPX-SPX-Client-Server-Examples](https://github.com/collosdeveloper/IPX-SPX-Client-Server-Examples)

### [doodlewind](https://github.com/doodlewind)
- 🌟 👤 [doodlewind](https://github.com/doodlewind) Starred [farion1231/cc-switch](https://github.com/farion1231/cc-switch)
  > A cross-platform desktop All-in-One assistant tool for Claude Code, Codex, OpenCode & Gemini CLI.

### [dwisiswant0](https://github.com/dwisiswant0)
- 🌟 👤 [dwisiswant0](https://github.com/dwisiswant0) Starred [Milkshiift/GoofCord](https://github.com/Milkshiift/GoofCord)
  > :shield: Take control of your Discord experience with GoofCord – a highly configurable and privacy m...
- 🌟 👤 [dwisiswant0](https://github.com/dwisiswant0) Starred [louisho5/picobot](https://github.com/louisho5/picobot)
...
- 🌟 👤 [gh0stkey](https://github.com/gh0stkey) Starred [GH05TCREW/MetasploitMCP](https://github.com/GH05TCREW/MetasploitMCP)
  > MCP Server for Metasploit
- 🌟 👤 [gh0stkey](https://github.com/gh0stkey) Starred [mrphrazer/reverser_ai](https://github.com/mrphrazer/reverser_ai)
...
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [ddttom/mlx-llm-tutorial](https://github.com/ddttom/mlx-llm-tutorial) to [gmh5225/mlx-llm-tutorial](https://github.com/gmh5225/mlx-llm-tutorial)
  > A tutorial on Apple MLX and LLM
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [voltropy/volt](https://github.com/voltropy/volt) to [gmh5225/volt-agent](https://github.com/gmh5225/volt-agent)
  > Coding agent with lossless context management
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [d-kfmnn/multiling](https://github.com/d-kfmnn/multiling) to [gmh5225/multiling](https://github.com/gmh5225/multiling)
  > Extracting Linear Relations from Gröbner Bases for Formal Verification of And-Inverter Graphs
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [d-kfmnn/multiling](https://github.com/d-kfmnn/multiling) to [MBA-research/multiling](https://github.com/MBA-research/multiling)
  > Extracting Linear Relations from Gröbner Bases for Formal Verification of And-Inverter Graphs
- 🌟 👤 [gmh5225](https://github.com/gmh5225) Starred [Michaelliv/mental](https://github.com/Michaelliv/mental)
  > The mental model layer for agent-written code
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [kbravh/obsidian-tweet-to-markdown](https://github.com/kbravh/obsidian-tweet-to-markdown) to [gmh5225/obsidian-tweet-to-markdown](https://github.com/gmh5225/obsidian-tweet-to-markdown)
  > An Obsidian.md plugin to save tweets as Markdown files.
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [prinsss/twitter-web-exporter](https://github.com/prinsss/twitter-web-exporter) to [gmh5225/twitter-web-exporter](https://github.com/gmh5225/twitter-web-exporter)
  > Export tweets, bookmarks, lists and much more from Twitter(X) web app. (推文/书签/收藏/列表导出工具)
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [louisho5/picobot](https://github.com/louisho5/picobot) to [gmh5225/picobot](https://github.com/gmh5225/picobot)
  > A lightweight self-hosted bot in a single binary, written in Go.
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [fynnfluegge/agtx](https://github.com/fynnfluegge/agtx) to [gmh5225/agtx](https://github.com/gmh5225/agtx)
  > Autonomous multi-session agent coding in the terminal
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [MikeVeerman/tool-calling-benchmark](https://github.com/MikeVeerman/tool-calling-benchmark) to [gmh5225/tool-calling-benchmark](https://github.com/gmh5225/tool-calling-benchmark)
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [vercel-labs/portless](https://github.com/vercel-labs/portless) to [gmh5225/portless](https://github.com/gmh5225/portless)
  > Replace port numbers with stable, named .localhost URLs. For humans and agents.
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [earendil-works/gondolin](https://github.com/earendil-works/gondolin) to [gmh5225/gondolin](https://github.com/gmh5225/gondolin)
...
- 🌟 👤 [jianglin-code](https://github.com/jianglin-code) Starred [dassl-uiuc/blkcache](https://github.com/dassl-uiuc/blkcache)

### [jpacg](https://github.com/jpacg)
- 🌟 👤 [jpacg](https://github.com/jpacg) Starred [Hybrid-Mount/meta-hybrid_mount](https://github.com/Hybrid-Mount/meta-hybrid_mount)
  > Hybrid Mount Metamodule

### [junknet](https://github.com/junknet)
- 🌟 👤 [junknet](https://github.com/junknet) Starred [VectifyAI/PageIndex](https://github.com/VectifyAI/PageIndex)
  > 📑 PageIndex: Document Index for Vectorless, Reasoning-based RAG

### [kost](https://github.com/kost)
- 🌟 👤 [kost](https://github.com/kost) Starred [zeroclaw-labs/zeroclaw](https://github.com/zeroclaw-labs/zeroclaw)
  > Fast, small, and fully autonomous AI assistant infrastructure — deploy anywhere, swap anything 🦀
- 🌟 👤 [kost](https://github.com/kost) Starred [alibaba/zvec](https://github.com/alibaba/zvec)
  > A lightweight, lightning-fast, in-process vector database
- 🌟 👤 [kost](https://github.com/kost) Starred [morcibacsi/PSAVanCanBridge](https://github.com/morcibacsi/PSAVanCanBridge)
  > VAN - CAN protocol bridge (V2C) for cars made by PSA Group (Peugeot, Citroen)
- 🌟 👤 [kost](https://github.com/kost) Starred [Ridter/noPac](https://github.com/Ridter/noPac)
...
- 🌟 👤 [moyada](https://github.com/moyada) Starred [QwenLM/Qwen3.5](https://github.com/QwenLM/Qwen3.5)
...
- 🌟 👤 [null-dev](https://github.com/null-dev) Starred [cjpais/Handy](https://github.com/cjpais/Handy)
  > A free, open source, and extensible speech-to-text application that works completely offline.
- 🌟 👤 [null-dev](https://github.com/null-dev) Starred [zachlatta/freeflow](https://github.com/zachlatta/freeflow)
  > Free and open source alternative to Wispr Flow / Superwhisper / Monologue / etc
- 🌟 👤 [null-dev](https://github.com/null-dev) Starred [unicode-org/message-format-wg](https://github.com/unicode-org/message-format-wg)
  > Developing a standard for localizable message strings
- 🌟 👤 [null-dev](https://github.com/null-dev) Starred [tolgee/tolgee-platform](https://github.com/tolgee/tolgee-platform)
  > Developer & translator friendly web-based localization platform
- 🌟 👤 [null-dev](https://github.com/null-dev) Starred [mbbill/Silverfir-nano](https://github.com/mbbill/Silverfir-nano)
  > A blazing-fast, ultra-compact WebAssembly 2.0 interpreter built from the ground up for performance, ...

### [oblique](https://github.com/oblique)
- 🌟 👤 [oblique](https://github.com/oblique) Starred [zeroclaw-labs/zeroclaw](https://github.com/zeroclaw-labs/zeroclaw)
  > Fast, small, and fully autonomous AI assistant infrastructure — deploy anywhere, swap anything 🦀

### [odzhan](https://github.com/odzhan)
- 🌟 👤 [odzhan](https://github.com/odzhan) Starred [blacktop/ida-mcp-rs](https://github.com/blacktop/ida-mcp-rs)
  > Headless IDA Pro MCP Server

### [qwqdanchun](https://github.com/qwqdanchun)
- 🌟 👤 [qwqdanchun](https://github.com/qwqdanchun) Starred [wietze/lnk-it-up](https://github.com/wietze/lnk-it-up)
  > Project for generating and identifying deceptive LNK files.

### [ravindu644](https://github.com/ravindu644)
- 🌟 👤 [ravindu644](https://github.com/ravindu644) Starred [guillevc/yubal](https://github.com/guillevc/yubal)
  > Self-hosted YouTube Music downloader with automatic metadata tagging and playlist sync
- 🍴 👤 [ravindu644](https://github.com/ravindu644) Forked [guillevc/yubal](https://github.com/guillevc/yubal) to [ravindu644/yubal](https://github.com/ravindu644/yubal)
  > Self-hosted YouTube Music downloader with automatic metadata tagging and playlist sync
- 🌟 👤 [ravindu644](https://github.com/ravindu644) Starred [Madotra/Youtube-music-downloader](https://github.com/Madotra/Youtube-music-downloader)
  > Download YouTube Music playlists as high-quality MP3s with metadata and album art, organized by play...
- 🍴 👤 [ravindu644](https://github.com/ravindu644) Forked [Madotra/Youtube-music-downloader](https://github.com/Madotra/Youtube-music-downloader) to [ravindu644/Youtube-music-downloader](https://github.com/ravindu644/Youtube-music-downloader)
  > Download YouTube Music playlists as high-quality MP3s with metadata and album art, organized by play...
- 🌟 👤 [ravindu644](https://github.com/ravindu644) Starred [glomatico/gytmdl](https://github.com/glomatico/gytmdl)
  > A command-line app for downloading YouTube Music songs with tags from YouTube Music.
- 🍴 👤 [ravindu644](https://github.com/ravindu644) Forked [glomatico/gytmdl](https://github.com/glomatico/gytmdl) to [ravindu644/gytmdl](https://github.com/ravindu644/gytmdl)
  > A command-line app for downloading YouTube Music songs with tags from YouTube Music.
- 🌟 👤 [ravindu644](https://github.com/ravindu644) Starred [juanfont/headscale](https://github.com/juanfont/headscale)
...
- 🌟 👤 [un4ckn0wl3z](https://github.com/un4ckn0wl3z) Starred [bugzmanov/awesome-ratatui](https://github.com/bugzmanov/awesome-ratatui)
  > A curated list of TUI apps and libraries built with Ratatui
- 🌟 👤 [un4ckn0wl3z](https://github.com/un4ckn0wl3z) Starred [ratatui/awesome-ratatui](https://github.com/ratatui/awesome-ratatui)
  > A curated list of TUI apps and libraries built with Ratatui
- 🌟 👤 [un4ckn0wl3z](https://github.com/un4ckn0wl3z) Starred [LongSoft/UEFITool](https://github.com/LongSoft/UEFITool)
  > UEFI firmware image viewer and editor

### [veaba](https://github.com/veaba)
- 🌟 👤 [veaba](https://github.com/veaba) Starred [volcengine/OpenViking](https://github.com/volcengine/OpenViking)
  > OpenViking is an open-source context database designed specifically for AI Agents. OpenViking unifie...
- 🌟 👤 [veaba](https://github.com/veaba) Starred [VoltAgent/awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills)
