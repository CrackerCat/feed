...
- 🌟 👤 [0xHJK](https://github.com/0xHJK) Starred [zhaoxuya520/reverse-skill](https://github.com/zhaoxuya520/reverse-skill)
...
- 🌟 👤 [0xdad0](https://github.com/0xdad0) Starred [SIA-IOTechnology/Kittysploit-framework](https://github.com/SIA-IOTechnology/Kittysploit-framework)
  > Python Exploitation Framework, V8 Engine Debugger, Proxy interceptor, marketplace, post-exploitation...
...
- 🌟 👤 [1orz](https://github.com/1orz) Starred [ikuaidev/qemu-ga](https://github.com/ikuaidev/qemu-ga)
  > iKuai QEMU plugin, for iKuai VM on PVE, QEMU to communicate host

### [AlexiaChen](https://github.com/AlexiaChen)
- 🌟 👤 [AlexiaChen](https://github.com/AlexiaChen) Starred [OpendTect/OpendTect](https://github.com/OpendTect/OpendTect)
  > 4cce3e7a
- 🌟 👤 [AlexiaChen](https://github.com/AlexiaChen) Starred [ruvnet/RuView](https://github.com/ruvnet/RuView)
...
- 🌟 👤 [AnkioTomas](https://github.com/AnkioTomas) Starred [Aabyss-Team/WebShell](https://github.com/Aabyss-Team/WebShell)
...
- 🌟 👤 [CHIZI-0618](https://github.com/CHIZI-0618) Starred [Willie169/termux-android-sdk-ndk](https://github.com/Willie169/termux-android-sdk-ndk)
...
- 🌟 👤 [Dere3046](https://github.com/Dere3046) Starred [XtrLumen/FS-Enhancer-Extreme](https://github.com/XtrLumen/FS-Enhancer-Extreme)
...
- 🍴 👤 [Dump-GUY](https://github.com/Dump-GUY) Forked [0xDbgMan/0xDbgMan.github.io](https://github.com/0xDbgMan/0xDbgMan.github.io) to [Dump-GUY/0xDbgMan.github.io](https://github.com/Dump-GUY/0xDbgMan.github.io)
...
- 🌟 👤 [Fansirsqi](https://github.com/Fansirsqi) Starred [herdrdev/herdr](https://github.com/herdrdev/herdr)
...
- 🍴 👤 [JoinChang](https://github.com/JoinChang) Forked [CHIZI-0618/sing-box](https://github.com/CHIZI-0618/sing-box) to [JoinChang/sing-box](https://github.com/JoinChang/sing-box)
...
- 🌟 👤 [Lakr233](https://github.com/Lakr233) Starred [ChefKissInc/Inferno](https://github.com/ChefKissInc/Inferno)
...
- 🌟 👤 [PalmDevs](https://github.com/PalmDevs) Starred [BuSung-dev/Root-My-Galaxy](https://github.com/BuSung-dev/Root-My-Galaxy)
...
- 🚀 👤 [PalmDevs](https://github.com/PalmDevs) Made [revenge-mod/revenge-plugin-template](https://github.com/revenge-mod/revenge-plugin-template) public
- 🌟 👤 [PalmDevs](https://github.com/PalmDevs) Starred [revenge-mod/revenge-plugin-template](https://github.com/revenge-mod/revenge-plugin-template)

### [Pengrey](https://github.com/Pengrey)
- 🌟 👤 [Pengrey](https://github.com/Pengrey) Starred [NeverSight/NeverC](https://github.com/NeverSight/NeverC)
  > The AI-friendly C23 compiler for security research, built on LLVM [WIP]

### [Petitoto](https://github.com/Petitoto)
- 🌟 👤 [Petitoto](https://github.com/Petitoto) Starred [BishopFox/sliver](https://github.com/BishopFox/sliver)
...
- 🍴 👤 [RiccardoAncarani](https://github.com/RiccardoAncarani) Forked [SecurityRiskAdvisors/VECTR](https://github.com/SecurityRiskAdvisors/VECTR) to [OpponentSec/VECTR](https://github.com/OpponentSec/VECTR)
  > VECTR is a tool that facilitates tracking of your red and blue team testing activities to measure de...
...
- 🌟 👤 [Skorpion96](https://github.com/Skorpion96) Starred [datfooldive/ghostlock-emerald](https://github.com/datfooldive/ghostlock-emerald)
...
- 🌟 👤 [Super12138](https://github.com/Super12138) Starred [WangGithubUser/FastGitHub](https://github.com/WangGithubUser/FastGitHub)
...
- 🌟 👤 [XiaoTong6666](https://github.com/XiaoTong6666) Starred [Admirepowered/selinux_hook](https://github.com/Admirepowered/selinux_hook)
  > For APatch hide dity selinux rules
- 🌟 👤 [XiaoTong6666](https://github.com/XiaoTong6666) Starred [bggRGjQaUbCoE/PiliPlus](https://github.com/bggRGjQaUbCoE/PiliPlus)
  > PiliPlus

### [Xieansecn](https://github.com/Xieansecn)
- 🌟 👤 [Xieansecn](https://github.com/Xieansecn) Starred [zhaoxuya520/reverse-skill](https://github.com/zhaoxuya520/reverse-skill)
  > Reverse Engineering / Authorized Penetration Testing / Security Research Skill Router Pack AI-powere...
- 🌟 👤 [Xieansecn](https://github.com/Xieansecn) Starred [FEX-Emu/FEX](https://github.com/FEX-Emu/FEX)
  > A fast usermode x86 and x86-64 emulator for Arm64 Linux
- 🌟 👤 [Xieansecn](https://github.com/Xieansecn) Starred [bojieli/ai-agent-book](https://github.com/bojieli/ai-agent-book)
  > 《深入理解 AI Agent：设计原理与工程实践》（李博杰 著）开源主仓库：全书正文、编译版 PDF 与按章配套代码

### [XtrLumen](https://github.com/XtrLumen)
- 🌟 👤 [XtrLumen](https://github.com/XtrLumen) Starred [Dere3046/Safemod](https://github.com/Dere3046/Safemod)
  > sukisu presence detector.
- 🌟 👤 [XtrLumen](https://github.com/XtrLumen) Starred [XtrLumen/ZLoader-Next](https://github.com/XtrLumen/ZLoader-Next)
  > Emperor ZLoader 😋

### [ZacharyZcR](https://github.com/ZacharyZcR)
- 🌟 👤 [ZacharyZcR](https://github.com/ZacharyZcR) Starred [vllm-project/vllm](https://github.com/vllm-project/vllm)
  > A high-throughput and memory-efficient inference and serving engine for LLMs
- 🌟 👤 [ZacharyZcR](https://github.com/ZacharyZcR) Starred [deepseek-ai/DeepGEMM](https://github.com/deepseek-ai/DeepGEMM)
  > DeepGEMM: clean and efficient BLAS kernel library on GPU

### [adysec](https://github.com/adysec)
- 🌟 👤 [adysec](https://github.com/adysec) Starred [lyogavin/airllm](https://github.com/lyogavin/airllm)
...
- 🌟 👤 [badboycxcc](https://github.com/badboycxcc) Starred [Ed1s0nZ/CyberStrikeAI](https://github.com/Ed1s0nZ/CyberStrikeAI)
...
- 🌟 👤 [boy-hack](https://github.com/boy-hack) Starred [jazzenchen/VibeAround](https://github.com/jazzenchen/VibeAround)
  > Keep your AI coding agents around. Launch Claude Code, Codex CLI, Gemini CLI, Pi Agent, and more fro...
- 🍴 👤 [boy-hack](https://github.com/boy-hack) Forked [jazzenchen/VibeAround](https://github.com/jazzenchen/VibeAround) to [boy-hack/VibeAround](https://github.com/boy-hack/VibeAround)
  > Keep your AI coding agents around. Launch Claude Code, Codex CLI, Gemini CLI, Pi Agent, and more fro...

### [burpheart](https://github.com/burpheart)
- 🌟 👤 [burpheart](https://github.com/burpheart) Starred [coder/agentapi](https://github.com/coder/agentapi)
...
- 🌟 👤 [dartcv](https://github.com/dartcv) Starred [NationalSecurityAgency/ghidra](https://github.com/NationalSecurityAgency/ghidra)
...
- 🌟 👤 [dzxpert](https://github.com/dzxpert) Starred [microsoft/AI-For-Beginners](https://github.com/microsoft/AI-For-Beginners)
  > 12 Weeks, 24 Lessons, AI for All!
- 🌟 👤 [dzxpert](https://github.com/dzxpert) Starred [tr4m0ryp/tr4mpass](https://github.com/tr4m0ryp/tr4mpass)
...
- 🌟 👤 [fynch3r](https://github.com/fynch3r) Starred [liaohch3/claude-tap](https://github.com/liaohch3/claude-tap)
...
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [foxreymann/cyberSOCks](https://github.com/foxreymann/cyberSOCks) to [gmh5225/cyberSOCks](https://github.com/gmh5225/cyberSOCks)
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [CyberStrikeus/CyberStrike](https://github.com/CyberStrikeus/CyberStrike) to [gmh5225/CyberStrike](https://github.com/gmh5225/CyberStrike)
  > Open-source AI-augmented offensive security harness. 13+ autonomous agents, 150+ LLM providers, 5,30...
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [batteryshark/batteryshark.github.io](https://github.com/batteryshark/batteryshark.github.io) to [gmh5225/batteryshark.github.io](https://github.com/gmh5225/batteryshark.github.io)
  > Reverse engineering, game hacking, AI security, and low-level systems blog
- 🌟 👤 [gmh5225](https://github.com/gmh5225) Starred [karpathy/autoresearch](https://github.com/karpathy/autoresearch)
  > AI agents running research on single-GPU nanochat training automatically
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [OpenPipe/pii-redaction](https://github.com/OpenPipe/pii-redaction) to [gmh5225/pii-redaction](https://github.com/gmh5225/pii-redaction)
...
- 🌟 👤 [gmh5225](https://github.com/gmh5225) Starred [NeverSight/NeverC](https://github.com/NeverSight/NeverC)
  > The AI-friendly C23 compiler for security research, built on LLVM [WIP]
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [NeverSight/NeverC](https://github.com/NeverSight/NeverC) to [gmh5225/NeverC](https://github.com/gmh5225/NeverC)
  > The AI-friendly C23 compiler for security research, built on LLVM [WIP]
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [bashalarmistalt/decimen-optical-transfer](https://github.com/bashalarmistalt/decimen-optical-transfer) to [gmh5225/decimen-optical-transfer](https://github.com/gmh5225/decimen-optical-transfer)
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [BehiSecc/fgau](https://github.com/BehiSecc/fgau) to [gmh5225/fgau](https://github.com/gmh5225/fgau)
  > A fast version of gau.
- 🌟 👤 [gmh5225](https://github.com/gmh5225) Starred [yc-software/qm](https://github.com/yc-software/qm)
  > Multiplayer agent harness for work
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [yc-software/qm](https://github.com/yc-software/qm) to [gmh5225/qm](https://github.com/gmh5225/qm)
  > Multiplayer agent harness for work
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [webxsid/crona](https://github.com/webxsid/crona) to [gmh5225/crona](https://github.com/gmh5225/crona)
  > Local-first work tracking for people who live in the terminal.
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [nakasyou/local-mcp](https://github.com/nakasyou/local-mcp) to [gmh5225/local-mcp](https://github.com/gmh5225/local-mcp)
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [0rangec3t/Black-cat](https://github.com/0rangec3t/Black-cat) to [gmh5225/Black-cat](https://github.com/gmh5225/Black-cat)
  > Claude Code RedTeam Skill — Hypothesis-Driven Cognitive Architecture。一个假设-证据驱动的红队skill
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [iocodev/kernel-4.19](https://github.com/iocodev/kernel-4.19) to [gmh5225/kernel-4.19](https://github.com/gmh5225/kernel-4.19)
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [mpgn/NetExec-mcp](https://github.com/mpgn/NetExec-mcp) to [gmh5225/NetExec-mcp](https://github.com/gmh5225/NetExec-mcp)
  > NetExec MCP
...
- 🌟 👤 [hahwul](https://github.com/hahwul) Starred [kemalcr/kemal-hmac](https://github.com/kemalcr/kemal-hmac)
  > HMAC middleware for Kemal applications

### [hhhaiai](https://github.com/hhhaiai)
- 🌟 👤 [hhhaiai](https://github.com/hhhaiai) Starred [Panniantong/Agent-Reach](https://github.com/Panniantong/Agent-Reach)
  > Give your AI agent eyes to see the entire internet. Read & search Twitter, Reddit, YouTube, GitHub, ...

### [hyuunnn](https://github.com/hyuunnn)
- 🌟 👤 [hyuunnn](https://github.com/hyuunnn) Starred [agegr/pi-web](https://github.com/agegr/pi-web)
  > Web UI for the pi coding agent
- 🌟 👤 [hyuunnn](https://github.com/hyuunnn) Starred [danny-avila/LibreChat](https://github.com/danny-avila/LibreChat)
...
- 🍴 👤 [iraizo](https://github.com/iraizo) Forked [TripSit/TripBot](https://github.com/TripSit/TripBot) to [iraizo/TripBot](https://github.com/iraizo/TripBot)
  > The discord bot on TripSit.Me
- 🌟 👤 [iraizo](https://github.com/iraizo) Starred [libkrun/krunvm](https://github.com/libkrun/krunvm)
...
- 🌟 👤 [jialeicui](https://github.com/jialeicui) Starred [bytedance/flowgram.ai](https://github.com/bytedance/flowgram.ai)
...
- 🌟 👤 [jiji262](https://github.com/jiji262) Starred [QwenAudio/qwen-audio-agent](https://github.com/QwenAudio/qwen-audio-agent)
  > A realtime voice runtime that keeps Agents talking, working, and present.  Real-time Voice Runtime f...
- 🌟 👤 [jiji262](https://github.com/jiji262) Starred [basketikun/chatgpt2api](https://github.com/basketikun/chatgpt2api)
  > ChatGPT官网接口纯协议的逆向实现，支持GPT-Image-2模型、文本模型，兼容OpenAI接口协议，在线批量生图/编辑图，号池管理，支持可编辑PPT/PSD文件逆向，支持导入CPA、sub2a...
...
- 🌟 👤 [kylesmile1103](https://github.com/kylesmile1103) Starred [Nutlope/hallmark](https://github.com/Nutlope/hallmark)
  > Anti-AI-slop design skill for Claude Code, Cursor, and Codex.
- 🌟 👤 [kylesmile1103](https://github.com/kylesmile1103) Starred [tt-a1i/archify](https://github.com/tt-a1i/archify)
  > Agent skill for beautiful, verifiable architecture, workflow, sequence, data-flow, and lifecycle dia...
- 🌟 👤 [kylesmile1103](https://github.com/kylesmile1103) Starred [Zackriya-Solutions/meetily](https://github.com/Zackriya-Solutions/meetily)
  > Privacy first, AI meeting assistant with 4x faster Parakeet/Whisper live transcription, speaker diar...
- 🌟 👤 [kylesmile1103](https://github.com/kylesmile1103) Starred [pbakaus/impeccable](https://github.com/pbakaus/impeccable)
  > The design language that makes your AI harness better at design.
- 🌟 👤 [kylesmile1103](https://github.com/kylesmile1103) Starred [iOfficeAI/OfficeCLI](https://github.com/iOfficeAI/OfficeCLI)
...
- 🌟 👤 [lightless233](https://github.com/lightless233) Starred [wxxsfxyzm/InstallerX-Revived](https://github.com/wxxsfxyzm/InstallerX-Revived)
  > More Expressive InstallerX !
- 🌟 👤 [lightless233](https://github.com/lightless233) Starred [asuojun/claude-vision-skill](https://github.com/asuojun/claude-vision-skill)

### [linxid](https://github.com/linxid)
- 🌟 👤 [linxid](https://github.com/linxid) Starred [LYL1015/JarvisHub](https://github.com/LYL1015/JarvisHub)
  > JarvisHub: An Open Harness for Canvas-Native Multimodal Creative Agents
- 🌟 👤 [linxid](https://github.com/linxid) Starred [antirez/ds4](https://github.com/antirez/ds4)
  > DeepSeek 4 Flash and PRO local inference engine for Metal, CUDA and ROCm

### [liuzjMr](https://github.com/liuzjMr)
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [pangao1990/RotaDay-WX](https://github.com/pangao1990/RotaDay-WX) to [liuzjMr/RotaDay-WX](https://github.com/liuzjMr/RotaDay-WX)
  > 班妥了（微信小程序版）——智能倒班排班助手
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [q286073088/PicPoem](https://github.com/q286073088/PicPoem) to [liuzjMr/PicPoem](https://github.com/liuzjMr/PicPoem)
  > 用视觉具象化重构中小学古诗词学习。按年级分类，一图懂诗意，秒记古诗词，打造开源的古诗词图解记忆库。
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [juhoonlilghost/course-schedule-miniprogram](https://github.com/juhoonlilghost/course-schedule-miniprogram) to [liuzjMr/course-schedule-miniprogram](https://github.com/liuzjMr/course-schedule-miniprogram)
  > 课程表管理微信小程序 - 支持课程增删改查、周历视图、上课提醒
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [ZECHENGXU/MyAtlas](https://github.com/ZECHENGXU/MyAtlas) to [liuzjMr/MyAtlas](https://github.com/liuzjMr/MyAtlas)
  > 一款个人旅行足迹记录工具。用户可以在地图上点亮去过的城市，上传旅行照片，记录游玩时间、城市简介、标签和景点，并通过地图、时间线、城市详情页和相册动效回看自己的旅行经历。
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [Sulumer/caolvji](https://github.com/Sulumer/caolvji) to [liuzjMr/caolvji](https://github.com/liuzjMr/caolvji)
  > 一款记录、分享你的旅游足迹、故事的微信小程序
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [GISerAndMusician/FootprintWeb](https://github.com/GISerAndMusician/FootprintWeb) to [liuzjMr/FootprintWeb](https://github.com/liuzjMr/FootprintWeb)
  > 足迹旅游地图WebApp，用以创建并展示个人的旅行行程，包括旅行过程中的轨迹、拍摄的照片、留言等等，并生成个人旅行报告。
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [pascalorg/editor](https://github.com/pascalorg/editor) to [liuzjMr/editor](https://github.com/liuzjMr/editor)
  > Create and share 3D architectural projects.
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [Robbyant/lingbot-map](https://github.com/Robbyant/lingbot-map) to [liuzjMr/lingbot-map](https://github.com/liuzjMr/lingbot-map)
  > A feed-forward 3D foundation model for reconstructing scenes from streaming data
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [HBAI-Ltd/Toonflow-app](https://github.com/HBAI-Ltd/Toonflow-app) to [liuzjMr/Toonflow-app](https://github.com/liuzjMr/Toonflow-app)
  > Toonflow 是开源一站式 AI 短剧创作工具，将小说、剧本快速转化为动画短剧。集成 AI 编剧、智能分镜、角色与视频生成，跨平台桌面端轻量部署，助力创作者低成本批量产出视觉内容。Toonflow...
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [chatfire-AI/huobao-drama](https://github.com/chatfire-AI/huobao-drama) to [liuzjMr/huobao-drama](https://github.com/liuzjMr/huobao-drama)
  > 🎬 火宝短剧 - 基于AI的一站式短剧生成平台 《一句话生成完整短剧，从剧本到成片全自动化》  Huobao Drama - An AI-Powered End-to-End Short Drama ...
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [koala73/worldmonitor](https://github.com/koala73/worldmonitor) to [liuzjMr/worldmonitor](https://github.com/liuzjMr/worldmonitor)
  > Real-time global intelligence dashboard. AI-powered news aggregation, geopolitical monitoring, and i...
- 🌟 👤 [liuzjMr](https://github.com/liuzjMr) Starred [sansan0/TrendRadar](https://github.com/sansan0/TrendRadar)
  > ⭐AI-driven public opinion & trend monitor with multi-platform aggregation, RSS, and smart alerts.🎯 告...
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [sansan0/TrendRadar](https://github.com/sansan0/TrendRadar) to [liuzjMr/TrendRadar](https://github.com/liuzjMr/TrendRadar)
  > ⭐AI-driven public opinion & trend monitor with multi-platform aggregation, RSS, and smart alerts.🎯 告...
- 🍴 👤 [liuzjMr](https://github.com/liuzjMr) Forked [OpenBMB/VoxCPM](https://github.com/OpenBMB/VoxCPM) to [liuzjMr/VoxCPM](https://github.com/liuzjMr/VoxCPM)
...
- 🍴 👤 [m4ll0k](https://github.com/m4ll0k) Forked [Kritt-ai/open-kritt](https://github.com/Kritt-ai/open-kritt) to [m4ll0k/open-kritt](https://github.com/m4ll0k/open-kritt)
  > Orchestrate AI agents to find real vulnerabilities in code.

### [madeye](https://github.com/madeye)
- 🌟 👤 [madeye](https://github.com/madeye) Starred [Veloresearch/velocity-mta-proof](https://github.com/Veloresearch/velocity-mta-proof)
  > Local AI execution stack for .mfy artifacts — MTA Exact / Adapt proof build, CUDA-first, no Python, ...
...
- 🌟 👤 [quanyeyang](https://github.com/quanyeyang) Starred [bsc-loca/core_tile](https://github.com/bsc-loca/core_tile)
- 🍴 👤 [quanyeyang](https://github.com/quanyeyang) Forked [bsc-loca/core_tile](https://github.com/bsc-loca/core_tile) to [quanyeyang/core_tile](https://github.com/quanyeyang/core_tile)
...
- 🌟 👤 [ravindu644](https://github.com/ravindu644) Starred [Figma-Linux/figma-linux](https://github.com/Figma-Linux/figma-linux)
  > Figma is the first interface design tool based in the browser, making it easier for teams to create ...
...
- 🌟 👤 [semlinker](https://github.com/semlinker) Starred [HugeCatLab/ChatTutor](https://github.com/HugeCatLab/ChatTutor)
  > 👨‍🏫 ChatTutor: Visual and Interactive AI Tutor
- 🌟 👤 [semlinker](https://github.com/semlinker) Starred [QwenAudio/qwen-audio-agent](https://github.com/QwenAudio/qwen-audio-agent)
  > A realtime voice runtime that keeps Agents talking, working, and present.  Real-time Voice Runtime f...

### [serein-213](https://github.com/serein-213)
- 🌟 👤 [serein-213](https://github.com/serein-213) Starred [awesome-selfhosted/awesome-selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted)
...
- 🌟 👤 [sh1ma](https://github.com/sh1ma) Starred [yc-software/qm](https://github.com/yc-software/qm)
  > Multiplayer agent harness for work
...
- 🌟 👤 [sotasan](https://github.com/sotasan) Starred [air-verse/air](https://github.com/air-verse/air)
...
- 🌟 👤 [weixiansen574](https://github.com/weixiansen574) Starred [shpkng/Bamboo-Cicadidae](https://github.com/shpkng/Bamboo-Cicadidae)
  > 1000万以内最好的玩具，现以电子形式发售。赛博竹知了，摇摇以领先。

### [wszxl516](https://github.com/wszxl516)
- 🌟 👤 [wszxl516](https://github.com/wszxl516) Starred [lyogavin/airllm](https://github.com/lyogavin/airllm)
  > AirLLM 70B inference with single 4GB GPU

### [wxxsfxyzm](https://github.com/wxxsfxyzm)
- 🌟 👤 [wxxsfxyzm](https://github.com/wxxsfxyzm) Starred [salvogiangri/KnoxPatch](https://github.com/salvogiangri/KnoxPatch)
  > LSPosed module to get Samsung apps/features working again in your rooted Galaxy device.

### [wy876](https://github.com/wy876)
- 🌟 👤 [wy876](https://github.com/wy876) Starred [FeeiCN/security-engineering](https://github.com/FeeiCN/security-engineering)
  > 网络安全空间安全

### [xhz444](https://github.com/xhz444)
- 🍴 👤 [xhz444](https://github.com/xhz444) Forked [Mangi-11/TwiFucker-Revived](https://github.com/Mangi-11/TwiFucker-Revived) to [xhz444/TwiFucker-Revived](https://github.com/xhz444/TwiFucker-Revived)
  > Yet Another Adkiller for X (Twitter), with bilingual translation

### [yfe404](https://github.com/yfe404)
- 🌟 👤 [yfe404](https://github.com/yfe404) Starred [plabayo/rama](https://github.com/plabayo/rama)
...
- 🌟 👤 [ymdzq](https://github.com/ymdzq) Starred [open-ani/animeko](https://github.com/open-ani/animeko)
  > 集找番、追番、看番的一站式弹幕追番平台，云收藏同步 (Bangumi)，离线缓存，BitTorrent，弹幕云过滤。100% Kotlin/Compose Multiplatform

### [yuandiv](https://github.com/yuandiv)
- 🌟 👤 [yuandiv](https://github.com/yuandiv) Starred [freeCodeCamp/freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp)
  > freeCodeCamp.org's open-source codebase and curriculum. Learn math, programming, and computer scienc...
- 🌟 👤 [yuandiv](https://github.com/yuandiv) Starred [microsoft/generative-ai-for-beginners](https://github.com/microsoft/generative-ai-for-beginners)
  > 21 Lessons, Get Started Building with Generative AI 
- 🌟 👤 [yuandiv](https://github.com/yuandiv) Starred [requarks/wiki](https://github.com/requarks/wiki)
  > Wiki.js | A modern and powerful wiki app built on Node.js

### [zhzyker](https://github.com/zhzyker)
- 🍴 👤 [zhzyker](https://github.com/zhzyker) Forked [Ape1ron/fastjson1283poc_public](https://github.com/Ape1ron/fastjson1283poc_public) to [Sec-Fork/fastjson1283poc_public](https://github.com/Sec-Fork/fastjson1283poc_public)
  > Fastjson 1.2.83 漏洞验证环境 + POC + 调试。

### [zzyccs](https://github.com/zzyccs)
- 🍴 👤 [zzyccs](https://github.com/zzyccs) Forked [xiaoleGun/KernelSU_Action](https://github.com/xiaoleGun/KernelSU_Action) to [zzyccs/KernelSU_Action](https://github.com/zzyccs/KernelSU_Action)
