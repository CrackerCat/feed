...
- 🌟 👤 [AnkioTomas](https://github.com/AnkioTomas) Starred [SecAegis/SecAutoBan](https://github.com/SecAegis/SecAutoBan)
  > 恶意IP全自动封禁平台。支持收集如下安全设备告警：长亭WAF社区版（SafeLine）、微步蜜罐HFish、奇安信天眼、奇安信椒图、绿盟WAF、天融信WAF、科来网络安全分析审计系统、深信服态势感知、...
...
- 🌟 👤 [Chordp](https://github.com/Chordp) Starred [HKUDS/Vibe-Trading](https://github.com/HKUDS/Vibe-Trading)
...
- 🌟 👤 [ColdWindScholar](https://github.com/ColdWindScholar) Starred [Ananbox/ananbox](https://github.com/Ananbox/ananbox)
...
- 🍴 👤 [DeviceObject](https://github.com/DeviceObject) Forked [tdragon6/Supershell](https://github.com/tdragon6/Supershell) to [DeviceObject/Supershell](https://github.com/DeviceObject/Supershell)
  > Supershell C2 远控平台，基于反向SSH隧道获取完全交互式Shell

### [DragonQuestHero](https://github.com/DragonQuestHero)
- 🌟 👤 [DragonQuestHero](https://github.com/DragonQuestHero) Starred [GreenSheep01201/claw-empire](https://github.com/GreenSheep01201/claw-empire)
  > Command Your AI Agent Empire from the CEO Desk — A local-first AI agent office simulator that orches...
- 🌟 👤 [DragonQuestHero](https://github.com/DragonQuestHero) Starred [DeusData/codebase-memory-mcp](https://github.com/DeusData/codebase-memory-mcp)
...
- 🌟 👤 [FiYHer](https://github.com/FiYHer) Starred [paullouisageneau/libdatachannel](https://github.com/paullouisageneau/libdatachannel)
  > C/C++ WebRTC network library featuring Data Channels, Media Transport, and WebSockets
- 🌟 👤 [FiYHer](https://github.com/FiYHer) Starred [farion1231/cc-switch](https://github.com/farion1231/cc-switch)
...
- 🌟 👤 [Fischsalat](https://github.com/Fischsalat) Starred [Encryqed/Dumper-7](https://github.com/Encryqed/Dumper-7)
  > Unreal Engine SDK Generator

### [Fplyth0ner-Combie](https://github.com/Fplyth0ner-Combie)
- 🌟 👤 [Fplyth0ner-Combie](https://github.com/Fplyth0ner-Combie) Starred [gabriellandau/Redux](https://github.com/gabriellandau/Redux)
- 🍴 👤 [Fplyth0ner-Combie](https://github.com/Fplyth0ner-Combie) Forked [gabriellandau/Redux](https://github.com/gabriellandau/Redux) to [Fplyth0ner-Combie/Redux](https://github.com/Fplyth0ner-Combie/Redux)
...
- 🌟 👤 [HSSkyBoy](https://github.com/HSSkyBoy) Starred [Mrmiaomrzh/PVZ_Weihua_installer](https://github.com/Mrmiaomrzh/PVZ_Weihua_installer)
...
- 🌟 👤 [Howard20181](https://github.com/Howard20181) Starred [google/oboe](https://github.com/google/oboe)
  > Oboe is a C++ library that makes it easy to build high-performance audio apps on Android.
- 🍴 👤 [Howard20181](https://github.com/Howard20181) Forked [dream7180/foobox-cn](https://github.com/dream7180/foobox-cn) to [Howard20181/foobox-cn](https://github.com/Howard20181/foobox-cn)
  > DUI 配置 for foobar2000

### [JunioJsv](https://github.com/JunioJsv)
- 🌟 👤 [JunioJsv](https://github.com/JunioJsv) Starred [adityadasika21/NorthStar](https://github.com/adityadasika21/NorthStar)
- 🌟 👤 [JunioJsv](https://github.com/JunioJsv) Starred [norbertFeron/better-dash](https://github.com/norbertFeron/better-dash)
  > An alternative navigation app for your Royal Enfield TFT screen

### [Keno](https://github.com/Keno)
- 🍴 👤 [Keno](https://github.com/Keno) Forked [JuliaDebug/JuliaInterpreter.jl](https://github.com/JuliaDebug/JuliaInterpreter.jl) to [KenoAIStaging/JuliaInterpreter.jl](https://github.com/KenoAIStaging/JuliaInterpreter.jl)
  > Interpreter for Julia code

### [Konano](https://github.com/Konano)
- 🌟 👤 [Konano](https://github.com/Konano) Starred [nolangz/pixel2motion](https://github.com/nolangz/pixel2motion)
...
- 🌟 👤 [S3cur3Th1sSh1t](https://github.com/S3cur3Th1sSh1t) Starred [bikini/exploitarium](https://github.com/bikini/exploitarium)
  > A single archive of public exploit PoCs and vulnerability research writeups. At the time I post thes...
...
- 🌟 👤 [Sndav](https://github.com/Sndav) Starred [oxfemale/rop_scanner](https://github.com/oxfemale/rop_scanner)
  > Gadget scanner that finds ROP gadgets inside any Windows DLL
- 🌟 👤 [Sndav](https://github.com/Sndav) Starred [starlight36/vibecoding-signal-light](https://github.com/starlight36/vibecoding-signal-light)
  > A real traffic light for AI agents.
- 🌟 👤 [Sndav](https://github.com/Sndav) Starred [P4nda0s/reverse-skills](https://github.com/P4nda0s/reverse-skills)
  > Reverse engineering skills for Claude Code | 逆向工程 Claude Code Skills 插件
- 🌟 👤 [Sndav](https://github.com/Sndav) Starred [MAIF/yozefu](https://github.com/MAIF/yozefu)
  >  An interactive terminal user interface (TUI) application for exploring data of a kafka cluster. 
- 🌟 👤 [Sndav](https://github.com/Sndav) Starred [nextlevelbuilder/ui-ux-pro-max-skill](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill)
  > An AI SKILL that provide design intelligence for building professional UI/UX multiple platforms
- 🌟 👤 [Sndav](https://github.com/Sndav) Starred [frkngksl/Shoggoth](https://github.com/frkngksl/Shoggoth)
  > Shoggoth: Asmjit Based Polymorphic Encryptor

### [SoyBeanMilkx](https://github.com/SoyBeanMilkx)
- 🌟 👤 [SoyBeanMilkx](https://github.com/SoyBeanMilkx) Starred [voocel/ainovel-cli](https://github.com/voocel/ainovel-cli)
  > ✨多agent实现全自动AI小说生成

### [SummerSec](https://github.com/SummerSec)
- 🌟 👤 [SummerSec](https://github.com/SummerSec) Starred [DietrichGebert/ponytail](https://github.com/DietrichGebert/ponytail)
...
- 🌟 👤 [TGSAN](https://github.com/TGSAN) Starred [qianxuntudou-ops/MyTVB](https://github.com/qianxuntudou-ops/MyTVB)
  > AI复刻BLBL播放器，加了一些自己的功能。将就用吧~
- 🌟 👤 [TGSAN](https://github.com/TGSAN) Starred [reisxd/TizenTubeCobalt](https://github.com/reisxd/TizenTubeCobalt)
  > Experience TizenTube on other devices that are not Tizen.

### [TKazer](https://github.com/TKazer)
- 🌟 👤 [TKazer](https://github.com/TKazer) Starred [ntop/n2n](https://github.com/ntop/n2n)
  > Peer-to-peer VPN

### [TheNetAdmin](https://github.com/TheNetAdmin)
- 🌟 👤 [TheNetAdmin](https://github.com/TheNetAdmin) Starred [microsoft/msccl](https://github.com/microsoft/msccl)
...
- 🌟 👤 [Unclecheng-li](https://github.com/Unclecheng-li) Starred [siddharthvaddem/openscreen](https://github.com/siddharthvaddem/openscreen)
...
- 🌟 👤 [X1r0z](https://github.com/X1r0z) Starred [XiaoMi/ha_xiaomi_home](https://github.com/XiaoMi/ha_xiaomi_home)
  > Xiaomi Home Integration for Home Assistant
- 🌟 👤 [X1r0z](https://github.com/X1r0z) Starred [al-one/hass-xiaomi-miot](https://github.com/al-one/hass-xiaomi-miot)
...
- 🌟 👤 [XiaoTong6666](https://github.com/XiaoTong6666) Starred [Xieansecn/PaddleOCR_android_demo](https://github.com/Xieansecn/PaddleOCR_android_demo)
  > 复活这个demo
...
- 🌟 👤 [YuKongA](https://github.com/YuKongA) Starred [go-gitea/gitea](https://github.com/go-gitea/gitea)
...
- 🌟 👤 [afkT](https://github.com/afkT) Starred [anthropics/skills](https://github.com/anthropics/skills)
  > Public repository for Agent Skills
- 🌟 👤 [afkT](https://github.com/afkT) Starred [2025Emma/vibe-coding-cn](https://github.com/2025Emma/vibe-coding-cn)
...
- 🍴 👤 [bet4it](https://github.com/bet4it) Forked [asterinas/asterinas](https://github.com/asterinas/asterinas) to [bet4it/asterinas](https://github.com/bet4it/asterinas)
...
- 🌟 👤 [chizhanyuefeng](https://github.com/chizhanyuefeng) Starred [deepseek-ai/DeepSpec](https://github.com/deepseek-ai/DeepSpec)
  > DeepSpec: a full-stack codebase for training and evaluating speculative decoding algorithms

### [cloudwindby](https://github.com/cloudwindby)
- 🌟 👤 [cloudwindby](https://github.com/cloudwindby) Starred [backengineering/themida-devirt](https://github.com/backengineering/themida-devirt)
  > Themida Devirt Results
- 🌟 👤 [cloudwindby](https://github.com/cloudwindby) Starred [0xor0ne/awesome-list](https://github.com/0xor0ne/awesome-list)
  > Cybersecurity oriented awesome list

### [codingsf](https://github.com/codingsf)
- 🌟 👤 [codingsf](https://github.com/codingsf) Starred [Lakr233/AssppWeb](https://github.com/Lakr233/AssppWeb)

### [cozis](https://github.com/cozis)
- 🌟 👤 [cozis](https://github.com/cozis) Starred [lighttpd/lighttpd1.4](https://github.com/lighttpd/lighttpd1.4)
  > lighttpd1.4 on github for easier collaboration - main repo still on lighttpd.net

### [ctkqiang](https://github.com/ctkqiang)
- 🌟 👤 [ctkqiang](https://github.com/ctkqiang) Starred [dstotijn/hetty](https://github.com/dstotijn/hetty)
  > An HTTP toolkit for security research.
- 🌟 👤 [ctkqiang](https://github.com/ctkqiang) Starred [gradle/gradle](https://github.com/gradle/gradle)
  > Adaptable, fast automation for all
- 🌟 👤 [ctkqiang](https://github.com/ctkqiang) Starred [Threekiii/Awesome-Laws](https://github.com/Threekiii/Awesome-Laws)
  > 一个网络安全相关法律法规、安全政策、国家标准、行业标准知识库。A knowledge base of cybersecurity policies, laws, guidelines, and tec...
- 🌟 👤 [ctkqiang](https://github.com/ctkqiang) Starred [cloudflare/security-audit-skill](https://github.com/cloudflare/security-audit-skill)
  > A coding-agent skill for multi-phase security audits with independently verified, machine-readable f...

### [easychen](https://github.com/easychen)
- 🌟 👤 [easychen](https://github.com/easychen) Starred [Joker-of-Gotham/virea](https://github.com/Joker-of-Gotham/virea)
  > VRM-native motion model project for interactive embodied avatars, aiming to generate continuous skel...

### [einverne](https://github.com/einverne)
- 🌟 👤 [einverne](https://github.com/einverne) Starred [manaflow-ai/cmux](https://github.com/manaflow-ai/cmux)
...
- 🌟 👤 [fuhei](https://github.com/fuhei) Starred [fuhei/tomato-writer-mcp](https://github.com/fuhei/tomato-writer-mcp)
  > 番茄小说作者后台MCP工具，辅助将AI创作的内容一键提交审核，查看书籍数据等
...
- 🍴 👤 [ggggmllll](https://github.com/ggggmllll) Forked [bibinocode/rust-frida-shadow-hook](https://github.com/bibinocode/rust-frida-shadow-hook) to [ggggmllll/rustfrida](https://github.com/ggggmllll/rustfrida)
  > 无痕HOOK，for来源rustFrida,修复部分问题
...
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [tomasz-lisowski/swsim](https://github.com/tomasz-lisowski/swsim) to [gmh5225/swsim](https://github.com/gmh5225/swsim)
  > A software SIM card.
...
- 🌟 👤 [happydog-intj](https://github.com/happydog-intj) Starred [mlc-ai/modern-gpu-programming-for-mlsys](https://github.com/mlc-ai/modern-gpu-programming-for-mlsys)
  > modern gpu programming

### [hhhaiai](https://github.com/hhhaiai)
- 🌟 👤 [hhhaiai](https://github.com/hhhaiai) Starred [hmjz100/LinkSwift](https://github.com/hmjz100/LinkSwift)
...
- 🌟 👤 [imbaya2466](https://github.com/imbaya2466) Starred [zuster/EconometricsResources](https://github.com/zuster/EconometricsResources)
  > 经济学相关专业资料集

### [imlk0](https://github.com/imlk0)
- 🌟 👤 [imlk0](https://github.com/imlk0) Starred [mlc-ai/modern-gpu-programming-for-mlsys](https://github.com/mlc-ai/modern-gpu-programming-for-mlsys)
  > modern gpu programming
...
- 🌟 👤 [mahmoudimus](https://github.com/mahmoudimus) Starred [greensock/GSAP](https://github.com/greensock/GSAP)
...
- 🌟 👤 [mcxiaoke](https://github.com/mcxiaoke) Starred [lepoco/wpfui](https://github.com/lepoco/wpfui)
...
- 🌟 👤 [merces](https://github.com/merces) Starred [avast/authenticode-parser](https://github.com/avast/authenticode-parser)
  > Authenticode-parser is a simple C library for Authenticode format parsing using OpenSSL.
- 🌟 👤 [merces](https://github.com/merces) Starred [HyperDbg/HyperDbg](https://github.com/HyperDbg/HyperDbg)
...
- 🌟 👤 [moyada](https://github.com/moyada) Starred [calesthio/OpenMontage](https://github.com/calesthio/OpenMontage)
...
- 🌟 👤 [mzfr](https://github.com/mzfr) Starred [simplex-chat/simplex-chat](https://github.com/simplex-chat/simplex-chat)
  > SimpleX - the first messaging network operating without user identifiers of any kind - 100% private ...
- 🌟 👤 [mzfr](https://github.com/mzfr) Starred [google-labs-code/design.md](https://github.com/google-labs-code/design.md)
  > A format specification for describing a visual identity to coding agents. DESIGN.md gives agents a p...
- 🌟 👤 [mzfr](https://github.com/mzfr) Starred [bikini/exploitarium](https://github.com/bikini/exploitarium)
  > A single archive of public exploit PoCs and vulnerability research writeups. At the time I post thes...
...
- 🌟 👤 [omeraydindev](https://github.com/omeraydindev) Starred [open-webui/open-terminal](https://github.com/open-webui/open-terminal)
  > A computer you can curl ⚡
- 🌟 👤 [omeraydindev](https://github.com/omeraydindev) Starred [AlexSergey/opensa](https://github.com/AlexSergey/opensa)
  > An open-source, from-scratch game engine built compatible with RenderWare (the GTA San Andreas engin...
...
- 🌟 👤 [qwqdanchun](https://github.com/qwqdanchun) Starred [Zuigetzu/Donut-CustomHost](https://github.com/Zuigetzu/Donut-CustomHost)
...
- 🌟 👤 [sakana164](https://github.com/sakana164) Starred [vesaaa/vstv](https://github.com/vesaaa/vstv)
  > VsTV 让你在 智能电视、电视盒子、平板或手机 上收看直播频道，支持国产及常见品牌电视 / 盒子（如 TCL、海信、酷开、华为智慧屏、荣耀、小米电视等）

### [sh1ma](https://github.com/sh1ma)
- 🌟 👤 [sh1ma](https://github.com/sh1ma) Starred [CadQuery/cadquery](https://github.com/CadQuery/cadquery)
...
- 🌟 👤 [sotasan](https://github.com/sotasan) Starred [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent)
...
- 🌟 👤 [vavkamil](https://github.com/vavkamil) Starred [gadievron/raptor](https://github.com/gadievron/raptor)
  > Raptor turns Claude Code into a general-purpose AI offensive/defensive security agent. By using Clau...
...
- 🍴 👤 [xiaolai](https://github.com/xiaolai) Forked [nagisanzenin/claude-code-production-grade-plugin](https://github.com/nagisanzenin/claude-code-production-grade-plugin) to [xiaolai/claude-code-production-grade-plugin](https://github.com/xiaolai/claude-code-production-grade-plugin)
  > Claude Code Plugin: Fully autonomous production-grade SaaS pipeline — 14 bundled skills, CEO/CTO com...
- 🍴 👤 [xiaolai](https://github.com/xiaolai) Forked [mlunato47/claude-grc-plugin](https://github.com/mlunato47/claude-grc-plugin) to [xiaolai/claude-grc-plugin](https://github.com/xiaolai/claude-grc-plugin)
  > A Claude Code plugin that turns Claude into a senior GRC (Governance, Risk, and Compliance) analyst....
- 🍴 👤 [xiaolai](https://github.com/xiaolai) Forked [firecrawl/firecrawl-claude-plugin](https://github.com/firecrawl/firecrawl-claude-plugin) to [xiaolai/firecrawl-claude-plugin](https://github.com/xiaolai/firecrawl-claude-plugin)
