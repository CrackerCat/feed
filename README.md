...
- 🌟 👤 [LabGuy94](https://github.com/LabGuy94) Starred [lguilhermee/EAC-Extractor-Utility](https://github.com/lguilhermee/EAC-Extractor-Utility)
  > This tool Decrypt and Extract the files from the EAC

### [Laurie-Lin](https://github.com/Laurie-Lin)
- 🍴 👤 [Laurie-Lin](https://github.com/Laurie-Lin) Forked [flutter/flutter](https://github.com/flutter/flutter) to [AuroraRecoveryProject/flutter](https://github.com/AuroraRecoveryProject/flutter)
  > Flutter makes it easy and fast to build beautiful apps for mobile and beyond
- 🍴 👤 [Laurie-Lin](https://github.com/Laurie-Lin) Forked [sony/flutter-embedded-linux](https://github.com/sony/flutter-embedded-linux) to [AuroraRecoveryProject/flutter-embedded-linux](https://github.com/AuroraRecoveryProject/flutter-embedded-linux)
  > Embedded Linux embedding for Flutter

### [LucisUrbe](https://github.com/LucisUrbe)
- 🌟 👤 [LucisUrbe](https://github.com/LucisUrbe) Starred [Raphire/Win11Debloat](https://github.com/Raphire/Win11Debloat)
...
- 🌟 👤 [Mati365](https://github.com/Mati365) Starred [vercel-labs/portless](https://github.com/vercel-labs/portless)
  > Replace port numbers with stable, named .localhost URLs. For humans and agents.

### [MikaCybertron](https://github.com/MikaCybertron)
- 🌟 👤 [MikaCybertron](https://github.com/MikaCybertron) Starred [YinMo19/sighook](https://github.com/YinMo19/sighook)
  > A multi-platform runtime instrumentation and inline hooking crate.

### [Natsume324](https://github.com/Natsume324)
- 🌟 👤 [Natsume324](https://github.com/Natsume324) Starred [Magisk-Modules-Alt-Repo/chroot-distro](https://github.com/Magisk-Modules-Alt-Repo/chroot-distro)
  > Install Gnu/Linux distributions on Android 

### [SodaMilk233](https://github.com/SodaMilk233)
- 🌟 👤 [SodaMilk233](https://github.com/SodaMilk233) Starred [uky007/FerrugoCC](https://github.com/uky007/FerrugoCC)
  > Rust-based reverse optimization (code obfuscation) C Compiler
- 🌟 👤 [SodaMilk233](https://github.com/SodaMilk233) Starred [SharkPika/Jnic](https://github.com/SharkPika/Jnic)
  > A Java obfuscator name JNIC that converts Java bytecode into C code
...
- 🌟 👤 [StephenDev0](https://github.com/StephenDev0) Starred [oven-sh/bun](https://github.com/oven-sh/bun)
  > Incredibly fast JavaScript runtime, bundler, test runner, and package manager – all in one

### [ThomasThelen](https://github.com/ThomasThelen)
- 🌟 👤 [ThomasThelen](https://github.com/ThomasThelen) Starred [fluxerapp/fluxer](https://github.com/fluxerapp/fluxer)
...
- 🌟 👤 [Tools-cx-app](https://github.com/Tools-cx-app) Starred [thedjchi/Shizuku](https://github.com/thedjchi/Shizuku)
...
- 🌟 👤 [b3x206](https://github.com/b3x206) Starred [rui314/chibicc](https://github.com/rui314/chibicc)
  > A small C compiler
...
- 🌟 👤 [byt3bl33d3r](https://github.com/byt3bl33d3r) Starred [vxcontrol/pentagi](https://github.com/vxcontrol/pentagi)
  > ✨ Fully autonomous AI Agents system capable of performing complex penetration testing tasks
- 🌟 👤 [byt3bl33d3r](https://github.com/byt3bl33d3r) Starred [GH05TCREW/pentestagent](https://github.com/GH05TCREW/pentestagent)
...
- 🍴 👤 [d419h](https://github.com/d419h) Forked [pwndbg/pwndbg](https://github.com/pwndbg/pwndbg) to [d419h/pwndbg](https://github.com/d419h/pwndbg)
  > Exploit Development and Reverse Engineering with GDB & LLDB Made Easy

### [dwisiswant0](https://github.com/dwisiswant0)
- 🌟 👤 [dwisiswant0](https://github.com/dwisiswant0) Starred [MatheuZSecurity/Singularity](https://github.com/MatheuZSecurity/Singularity)
  > Stealthy Linux Kernel Rootkit for modern kernels (6x)
- 🌟 👤 [dwisiswant0](https://github.com/dwisiswant0) Starred [millionco/react-doctor](https://github.com/millionco/react-doctor)
...
- 🌟 👤 [everettjf](https://github.com/everettjf) Starred [microclaw/skillsyoga](https://github.com/microclaw/skillsyoga)
  > SkillsYoga helps you manage SKILL.md-based skills for different AI tools in one place.
- 🌟 👤 [everettjf](https://github.com/everettjf) Starred [joshavant/clawbox](https://github.com/joshavant/clawbox)
  > OpenClaw-ready macOS VMs
- 🌟 👤 [everettjf](https://github.com/everettjf) Starred [volcengine/OpenViking](https://github.com/volcengine/OpenViking)
  > OpenViking is an open-source context database designed specifically for AI Agents. OpenViking unifie...
- 🌟 👤 [everettjf](https://github.com/everettjf) Starred [pinchtab/pinchtab](https://github.com/pinchtab/pinchtab)
...
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [ultrafunkamsterdam/nodriver](https://github.com/ultrafunkamsterdam/nodriver) to [gmh5225/nodriver](https://github.com/gmh5225/nodriver)
  > Successor of Undetected-Chromedriver. Providing a blazing fast framework for web automation, webscra...
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [BabylonJS/Babylon.js](https://github.com/BabylonJS/Babylon.js) to [gmh5225/Babylon.js](https://github.com/gmh5225/Babylon.js)
  > Babylon.js is a powerful, beautiful, simple, and open game and rendering engine packed into a friend...
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [minaminao/pure-python-deflate](https://github.com/minaminao/pure-python-deflate) to [gmh5225/pure-python-deflate](https://github.com/gmh5225/pure-python-deflate)
  > minimal pure Python Deflate implementation for CTF and fun
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [naorhaziz/irql](https://github.com/naorhaziz/irql) to [gmh5225/irql](https://github.com/gmh5225/irql)
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [murxla/murxla](https://github.com/murxla/murxla) to [gmh5225/murxla](https://github.com/gmh5225/murxla)
  > A model-based API Fuzzer for SMT Solvers.
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [jo-inc/camofox-browser](https://github.com/jo-inc/camofox-browser) to [gmh5225/camofox-browser](https://github.com/gmh5225/camofox-browser)
  > Headless browser automation server for AI agents to visit sites that are usually blocked
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [jo-inc/safe-skill-search](https://github.com/jo-inc/safe-skill-search) to [gmh5225/safe-skill-search](https://github.com/gmh5225/safe-skill-search)
  > Fast local search across agent skill registries with quality filtering (score >= 80 by default)
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [bkuri/jesse-mcp](https://github.com/bkuri/jesse-mcp) to [gmh5225/jesse-mcp](https://github.com/gmh5225/jesse-mcp)
  > Jesse trading framework MCP server for LLM agents
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [peg/rampart](https://github.com/peg/rampart) to [gmh5225/rampart-firewall](https://github.com/gmh5225/rampart-firewall)
  > Open-source firewall for AI agents. Policy engine that controls what OpenClaw, Claude Code, Cursor, ...
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [TaterTotterson/Tater](https://github.com/TaterTotterson/Tater) to [gmh5225/Tater](https://github.com/gmh5225/Tater)
  > Tater is a fully agent-driven AI assistant that connects to any OpenAI-compatible LLM and uses modul...
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [atrtde/feedyourai](https://github.com/atrtde/feedyourai) to [gmh5225/feedyourai](https://github.com/gmh5225/feedyourai)
  > A tool to combine text files for LLM processing with filtering options.
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [jsattler/BetterCapture](https://github.com/jsattler/BetterCapture) to [gmh5225/BetterCapture](https://github.com/gmh5225/BetterCapture)
...
- 🌟 👤 [jianglin-code](https://github.com/jianglin-code) Starred [zeroclaw-labs/zeroclaw](https://github.com/zeroclaw-labs/zeroclaw)
  > Fast, small, and fully autonomous AI assistant infrastructure — deploy anywhere, swap anything 🦀

### [kingking888](https://github.com/kingking888)
- 🌟 👤 [kingking888](https://github.com/kingking888) Starred [Mrack/TInjector_Symbi](https://github.com/Mrack/TInjector_Symbi)
  > 更稳定的劫持Zygote在App启动前注入so

### [luochuanyuewu](https://github.com/luochuanyuewu)
- 🌟 👤 [luochuanyuewu](https://github.com/luochuanyuewu) Starred [delmaredigital/payload-page-tree](https://github.com/delmaredigital/payload-page-tree)
  > Payload CMS plugin for folder-based hierarchical URL slugs with visual tree management

### [m4ll0k](https://github.com/m4ll0k)
- 🌟 👤 [m4ll0k](https://github.com/m4ll0k) Starred [vxcontrol/pentagi](https://github.com/vxcontrol/pentagi)
  > ✨ Fully autonomous AI Agents system capable of performing complex penetration testing tasks
- 🍴 👤 [m4ll0k](https://github.com/m4ll0k) Forked [vxcontrol/pentagi](https://github.com/vxcontrol/pentagi) to [m4ll0k/pentagi](https://github.com/m4ll0k/pentagi)
  > ✨ Fully autonomous AI Agents system capable of performing complex penetration testing tasks
- 🌟 👤 [m4ll0k](https://github.com/m4ll0k) Starred [p-e-w/heretic](https://github.com/p-e-w/heretic)
  > Fully automatic censorship removal for language models
- 🍴 👤 [m4ll0k](https://github.com/m4ll0k) Forked [p-e-w/heretic](https://github.com/p-e-w/heretic) to [m4ll0k/heretic](https://github.com/m4ll0k/heretic)
  > Fully automatic censorship removal for language models

### [mcxiaoke](https://github.com/mcxiaoke)
- 🌟 👤 [mcxiaoke](https://github.com/mcxiaoke) Starred [Comfy-Org/ComfyUI](https://github.com/Comfy-Org/ComfyUI)
  > The most powerful and modular diffusion model GUI, api and backend with a graph/nodes interface.
- 🌟 👤 [mcxiaoke](https://github.com/mcxiaoke) Starred [yolain/ComfyUI-Easy-Use](https://github.com/yolain/ComfyUI-Easy-Use)
  > In order to make it easier to use the ComfyUI, I have made some optimizations and integrations to so...
- 🌟 👤 [mcxiaoke](https://github.com/mcxiaoke) Starred [kijai/ComfyUI-SUPIR](https://github.com/kijai/ComfyUI-SUPIR)
  > SUPIR upscaling wrapper for ComfyUI
- 🌟 👤 [mcxiaoke](https://github.com/mcxiaoke) Starred [Kosinkadink/ComfyUI-VideoHelperSuite](https://github.com/Kosinkadink/ComfyUI-VideoHelperSuite)
  > Nodes related to video workflows

### [meowette](https://github.com/meowette)
- 🌟 👤 [meowette](https://github.com/meowette) Starred [CnRJay/xray-monolith-gc64](https://github.com/CnRJay/xray-monolith-gc64)
  > Modernized X-Ray Engine for Anomaly using LuaJIT GC64, TBB Malloc, and multithreaded optimization fi...
...
- 🌟 👤 [un4ckn0wl3z](https://github.com/un4ckn0wl3z) Starred [juliusdeane/bootloaders](https://github.com/juliusdeane/bootloaders)
  > Bootloaders books repository

### [wszxl516](https://github.com/wszxl516)
- 🌟 👤 [wszxl516](https://github.com/wszxl516) Starred [moltis-org/moltis](https://github.com/moltis-org/moltis)
...
- 🌟 👤 [xinyu2428](https://github.com/xinyu2428) Starred [lionsoul2014/ip2region](https://github.com/lionsoul2014/ip2region)
  > Ip2region is an offline IP address manager framework and locator with both IPv4 and IPv6 supported, ...
...
- 🌟 👤 [yanyaoli](https://github.com/yanyaoli) Starred [andyhuo520/rf-detr-detection](https://github.com/andyhuo520/rf-detr-detection)
  > 基于 RF-DETR 的浏览器端实时目标检测应用

### [yhy0](https://github.com/yhy0)
- 🌟 👤 [yhy0](https://github.com/yhy0) Starred [trailofbits/skills](https://github.com/trailofbits/skills)
  > Trail of Bits Claude Code skills for security research, vulnerability detection, and audit workflows

### [yifengyou](https://github.com/yifengyou)
- 🌟 👤 [yifengyou](https://github.com/yifengyou) Starred [007revad/DTC_GUI_for_Windows](https://github.com/007revad/DTC_GUI_for_Windows)
  > GUI for DTC.exe for Windows

### [zinja-coder](https://github.com/zinja-coder)
- 🌟 👤 [zinja-coder](https://github.com/zinja-coder) Starred [simondankelmann/Bluetooth-LE-Spam](https://github.com/simondankelmann/Bluetooth-LE-Spam)
- 🌟 👤 [zinja-coder](https://github.com/zinja-coder) Starred [smoochiee/Bluetooth-jammer-esp32](https://github.com/smoochiee/Bluetooth-jammer-esp32)
  > Bluetooth jamming esp32 with nrf24l01
- 🌟 👤 [zinja-coder](https://github.com/zinja-coder) Starred [smoochiee/Noisy-boy-esp32-Bluetooth-jammer](https://github.com/smoochiee/Noisy-boy-esp32-Bluetooth-jammer)
  > Bluetooth jammer using esp32 with webserver
- 🌟 👤 [zinja-coder](https://github.com/zinja-coder) Starred [eikarna/BluetoothJammer](https://github.com/eikarna/BluetoothJammer)
  > Simple Bluetooth Jammer in Android using kotlin. (WIP)
- 🌟 👤 [zinja-coder](https://github.com/zinja-coder) Starred [crypt0b0y/BLUETOOTH-DOS-ATTACK-SCRIPT](https://github.com/crypt0b0y/BLUETOOTH-DOS-ATTACK-SCRIPT)
  >   Script for quick and easy DOS-attacks on bluetooth devices for pentest purposes
- 🌟 👤 [zinja-coder](https://github.com/zinja-coder) Starred [0x90/bluetooth-arsenal](https://github.com/0x90/bluetooth-arsenal)
  > Bluetooth hacking tools
- 🌟 👤 [zinja-coder](https://github.com/zinja-coder) Starred [virtualabs/btlejack](https://github.com/virtualabs/btlejack)
  > Bluetooth Low Energy Swiss-army knife
- 🌟 👤 [zinja-coder](https://github.com/zinja-coder) Starred [justcallmekoko/ESP32Marauder](https://github.com/justcallmekoko/ESP32Marauder)
  > A suite of WiFi/Bluetooth offensive and defensive tools for the ESP32
- 🌟 👤 [zinja-coder](https://github.com/zinja-coder) Starred [engn33r/awesome-bluetooth-security](https://github.com/engn33r/awesome-bluetooth-security)
  > List of Bluetooth BR/EDR/LE security resources
- 🌟 👤 [zinja-coder](https://github.com/zinja-coder) Starred [TarlogicSecurity/BlueSpy](https://github.com/TarlogicSecurity/BlueSpy)
  > PoC to record audio from a Bluetooth device
- 🌟 👤 [zinja-coder](https://github.com/zinja-coder) Starred [Matheus-Garbelini/esp32_bluetooth_classic_sniffer](https://github.com/Matheus-Garbelini/esp32_bluetooth_classic_sniffer)
  > Active Bluetooth BR/EDR Sniffer/Injector as cheap as any ESP32 board can get. Works with Scapy ;-)
- 🌟 👤 [zinja-coder](https://github.com/zinja-coder) Starred [fO-000/bluing](https://github.com/fO-000/bluing)
  > An intelligence gathering tool for hacking Bluetooth
- 🌟 👤 [zinja-coder](https://github.com/zinja-coder) Starred [andrewmichaelsmith/bluepot](https://github.com/andrewmichaelsmith/bluepot)
  > Bluetooth Honeypot
- 🌟 👤 [zinja-coder](https://github.com/zinja-coder) Starred [Matheus-Garbelini/braktooth_esp32_bluetooth_classic_attacks](https://github.com/Matheus-Garbelini/braktooth_esp32_bluetooth_classic_attacks)
  > A Series of Baseband & LMP Exploits against Bluetooth Classic Controllers
- 🌟 👤 [zinja-coder](https://github.com/zinja-coder) Starred [cifertech/RF-Clown](https://github.com/cifertech/RF-Clown)
  > BLE and Bluetooth Jammer with nRF24L01 and ESP32
- 🌟 👤 [zinja-coder](https://github.com/zinja-coder) Starred [mikeryan/ice9-bluetooth-sniffer](https://github.com/mikeryan/ice9-bluetooth-sniffer)
  > Wireshark-compatible all-channel BLE sniffer for bladeRF, with wideband Bluetooth sniffing for HackR...
- 🌟 👤 [zinja-coder](https://github.com/zinja-coder) Starred [deviceplug/btleplug](https://github.com/deviceplug/btleplug)
  > Rust Cross-Platform Host-Side Bluetooth LE Access Library
- 🌟 👤 [zinja-coder](https://github.com/zinja-coder) Starred [hackgnar/ble_ctf](https://github.com/hackgnar/ble_ctf)
  > A Bluetooth low energy capture the flag
- 🌟 👤 [zinja-coder](https://github.com/zinja-coder) Starred [Matheus-Garbelini/sweyntooth_bluetooth_low_energy_attacks](https://github.com/Matheus-Garbelini/sweyntooth_bluetooth_low_energy_attacks)
  > Proof of Concept of Sweyntooth Bluetooth Low Energy (BLE) vulnerabilities.
- 🌟 👤 [zinja-coder](https://github.com/zinja-coder) Starred [sgxgsx/BlueToolkit](https://github.com/sgxgsx/BlueToolkit)
  >  BlueToolkit is an extensible Bluetooth Classic vulnerability testing framework that helps uncover n...
- 🌟 👤 [zinja-coder](https://github.com/zinja-coder) Starred [nccgroup/Sniffle](https://github.com/nccgroup/Sniffle)
  > A sniffer for Bluetooth 5 and 4.x LE
- 🌟 👤 [zinja-coder](https://github.com/zinja-coder) Starred [thanhlev/keyboard_mouse_emulate_on_raspberry](https://github.com/thanhlev/keyboard_mouse_emulate_on_raspberry)
  > Bluetooth Keyboard Mouse  Emulator on Raspberry Pi
- 🌟 👤 [zinja-coder](https://github.com/zinja-coder) Starred [ghostop14/sparrow-wifi](https://github.com/ghostop14/sparrow-wifi)
  > Next-Gen GUI-based WiFi and Bluetooth Analyzer for Linux
- 🌟 👤 [zinja-coder](https://github.com/zinja-coder) Starred [Charmve/BLE-Security-Attack-Defence](https://github.com/Charmve/BLE-Security-Attack-Defence)
  > ✨ Purpose only! The dangers of Bluetooth Low Energy（BLE）implementations: Unveiling zero day vulnerab...
- 🌟 👤 [zinja-coder](https://github.com/zinja-coder) Starred [yakuza8/peniot](https://github.com/yakuza8/peniot)
