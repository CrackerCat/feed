...
- 🌟 👤 [1193776794](https://github.com/1193776794) Starred [NandhaKishorM/laya](https://github.com/NandhaKishorM/laya)
...
- 🌟 👤 [2977094657](https://github.com/2977094657) Starred [jeremy-prt/bloub](https://github.com/jeremy-prt/bloub)
...
- 🌟 👤 [350030173](https://github.com/350030173) Starred [newliver666/apk-reverse](https://github.com/newliver666/apk-reverse)
  > Suitable for Android APK reverse engineering analysis
- 🌟 👤 [350030173](https://github.com/350030173) Starred [yaklang/hack-skills](https://github.com/yaklang/hack-skills)
...
- 🌟 👤 [CHIZI-0618](https://github.com/CHIZI-0618) Starred [LimpidMo/SvcHub](https://github.com/LimpidMo/SvcHub)
  > 一个 KernelSU / Magisk /APatch 开机启动和保活 Termux 服务和二进制服务的模块，并提供 WebUI 聚合管理
- 🌟 👤 [CHIZI-0618](https://github.com/CHIZI-0618) Starred [k2-fsa/OmniVoice](https://github.com/k2-fsa/OmniVoice)
  > High-Quality Voice Cloning TTS for 600+ Languages
- 🌟 👤 [CHIZI-0618](https://github.com/CHIZI-0618) Starred [vladelaina/BongoCat](https://github.com/vladelaina/BongoCat)
  > 🩷 💘C × SDL3 × OpenGL — Three Mysterious Forces, United as One! Bong~ Bongocat!!!Don't be shy, Join H...

### [CHYbeta](https://github.com/CHYbeta)
- 🌟 👤 [CHYbeta](https://github.com/CHYbeta) Starred [tantosec/tturl](https://github.com/tantosec/tturl)
  > The HTTP/2 CLI for finding tiny timing differences and winning request races
...
- 🌟 👤 [Chordp](https://github.com/Chordp) Starred [microsoft/openvmm](https://github.com/microsoft/openvmm)
  > Home of OpenVMM and OpenHCL

### [ColdWindScholar](https://github.com/ColdWindScholar)
- 🌟 👤 [ColdWindScholar](https://github.com/ColdWindScholar) Starred [yeliqin666/xjtu-toolbox-android](https://github.com/yeliqin666/xjtu-toolbox-android)
  > 交兵安卓工具箱
- 🌟 👤 [ColdWindScholar](https://github.com/ColdWindScholar) Starred [justistab3-bot/mtk-lk-warning-patch](https://github.com/justistab3-bot/mtk-lk-warning-patch)
  > Remove Orange State / Red State / dm-verity boot warnings and the 5-second boot delay from MediaTek ...
...
- 🌟 👤 [DavidBuchanan314](https://github.com/DavidBuchanan314) Starred [trailofbits/coop](https://github.com/trailofbits/coop)
...
- 🌟 👤 [EgeBalci](https://github.com/EgeBalci) Starred [AlexxIT/go2rtc](https://github.com/AlexxIT/go2rtc)
  > Ultimate camera streaming application

### [Fyyre](https://github.com/Fyyre)
- 🌟 👤 [Fyyre](https://github.com/Fyyre) Starred [joxeankoret/diaphora](https://github.com/joxeankoret/diaphora)
  > Diaphora, the most advanced Free and Open Source program diffing tool.

### [GAMMACASE](https://github.com/GAMMACASE)
- 🍴 👤 [GAMMACASE](https://github.com/GAMMACASE) Forked [Kenzzer/KHook](https://github.com/Kenzzer/KHook) to [GAMMACASE/KHook](https://github.com/GAMMACASE/KHook)
  > Centralized 'thread-safe' detouring library for x86/x86_64

### [Howard20181](https://github.com/Howard20181)
- 🌟 👤 [Howard20181](https://github.com/Howard20181) Starred [zwc456baby/ScrcpyForAndroid](https://github.com/zwc456baby/ScrcpyForAndroid)
  > scrcpy for android
- 🌟 👤 [Howard20181](https://github.com/Howard20181) Starred [Miuzarte/ScrcpyForAndroid](https://github.com/Miuzarte/ScrcpyForAndroid)
...
- 🍴 👤 [Laurie-Lin](https://github.com/Laurie-Lin) Forked [tt-a1i/archify](https://github.com/tt-a1i/archify) to [Laurie-Lin/archify](https://github.com/Laurie-Lin/archify)
...
- 🌟 👤 [Lil-Ran](https://github.com/Lil-Ran) Starred [whyorean/AuroraStore](https://github.com/whyorean/AuroraStore)

### [M0Rf30](https://github.com/M0Rf30)
- 🌟 👤 [M0Rf30](https://github.com/M0Rf30) Starred [esoltys/luminous](https://github.com/esoltys/luminous)
  > A high-performance home for the music you already own. Luminous is a fast, local-first player for yo...
...
- 🌟 👤 [MrIkso](https://github.com/MrIkso) Starred [stevemk14ebr/PolyHook_2_0](https://github.com/stevemk14ebr/PolyHook_2_0)
...
- 🌟 👤 [No-Github](https://github.com/No-Github) Starred [Yean-Sec/StrikeAgent_AtkBrain-Flash](https://github.com/Yean-Sec/StrikeAgent_AtkBrain-Flash)
  > 由夜安团队研发的AI Agent渗透测试平台，强调自监督，自循环，自进化首创寻宝机制，涵盖红队打点、SRC、CTF，特别是在红队领域有极为亮眼的存在

### [P4x1s](https://github.com/P4x1s)
- 🌟 👤 [P4x1s](https://github.com/P4x1s) Starred [stackryze/FreeDomains](https://github.com/stackryze/FreeDomains)
...
- 🌟 👤 [Pengrey](https://github.com/Pengrey) Starred [chokepoint/Jynx2](https://github.com/chokepoint/Jynx2)
  > JynxKit2 is an LD_PRELOAD userland rootkit based on the original JynxKit. The backdoor has been repl...
...
- 🍴 👤 [PranavPurwar](https://github.com/PranavPurwar) Forked [termux-pacman/glibc-packages](https://github.com/termux-pacman/glibc-packages) to [Cosmic-Ide/glibc-packages](https://github.com/Cosmic-Ide/glibc-packages)
  > Glibc packages for termux

### [Ridter](https://github.com/Ridter)
- 🌟 👤 [Ridter](https://github.com/Ridter) Starred [tt-a1i/archify](https://github.com/tt-a1i/archify)
  > Agent skill for beautiful, verifiable architecture, workflow, sequence, data-flow, and lifecycle dia...

### [SKeyerror](https://github.com/SKeyerror)
- 🌟 👤 [SKeyerror](https://github.com/SKeyerror) Starred [abozanona/pacman-contribution-graph](https://github.com/abozanona/pacman-contribution-graph)
  > 👻🧱🚀 Turn your GitHub contribution graph into an arcade game SVG animation! Easy to integrate into yo...

### [SMlc666](https://github.com/SMlc666)
- 🍴 👤 [SMlc666](https://github.com/SMlc666) Forked [Weiss-UltimateSavior/Tyranor-Next](https://github.com/Weiss-UltimateSavior/Tyranor-Next) to [SMlc666/Tyranor-Next](https://github.com/SMlc666/Tyranor-Next)
  > 多引擎视觉小说（Galgame）聚合启动器，面向 Android 平台。内置 Kirikiri / ONScripter / Tyrano / Artemis / Siglus / FVP 六套引擎运...

### [Seyud](https://github.com/Seyud)
- 🌟 👤 [Seyud](https://github.com/Seyud) Starred [Ianzb/HyperRefine](https://github.com/Ianzb/HyperRefine)

### [Silentsoul04](https://github.com/Silentsoul04)
- 🌟 👤 [Silentsoul04](https://github.com/Silentsoul04) Starred [google/artemis](https://github.com/google/artemis)
  > ARTEMIS turns natural-language instructions into reliable Android automation. It automates end-to-en...
- 🍴 👤 [Silentsoul04](https://github.com/Silentsoul04) Forked [google/artemis](https://github.com/google/artemis) to [Silentsoul04/artemis-google](https://github.com/Silentsoul04/artemis-google)
  > ARTEMIS turns natural-language instructions into reliable Android automation. It automates end-to-en...

### [Skorpion96](https://github.com/Skorpion96)
- 🌟 👤 [Skorpion96](https://github.com/Skorpion96) Starred [dikeckaan/mu300-linux](https://github.com/dikeckaan/mu300-linux)
  > Linux (Ubuntu 26.04 + systemd, custom 5.4 kernel) on the ZTE F50 / MU300 5G hotspot (Unisoc T760 / U...
- 🌟 👤 [Skorpion96](https://github.com/Skorpion96) Starred [diabl0w/DFRoot](https://github.com/diabl0w/DFRoot)

### [SnowNF](https://github.com/SnowNF)
- 🌟 👤 [SnowNF](https://github.com/SnowNF) Starred [GPUOpen-Effects/FidelityFX-ParallelSort](https://github.com/GPUOpen-Effects/FidelityFX-ParallelSort)
  > FidelityFX Parallel Sort
- 🌟 👤 [SnowNF](https://github.com/SnowNF) Starred [Tom94/tev](https://github.com/Tom94/tev)
  > High dynamic range (HDR) image viewer for people who care about colors

### [StanleyNull](https://github.com/StanleyNull)
- 🌟 👤 [StanleyNull](https://github.com/StanleyNull) Starred [Windsweet97/section-b-log](https://github.com/Windsweet97/section-b-log)
  > SECTION_B.LOG — a few websites that form one worldview: internet, alienation, postmodern loneliness.
...
- 🍴 👤 [Tokeii0](https://github.com/Tokeii0) Forked [JohnHeibel/PDoomVideo](https://github.com/JohnHeibel/PDoomVideo) to [Tokeii0/PDoomVideo](https://github.com/Tokeii0/PDoomVideo)
  > Source code for the Claude Opus 5.5 music video for I'm Upping My P(doom)

### [TomKing062](https://github.com/TomKing062)
- 🌟 👤 [TomKing062](https://github.com/TomKing062) Starred [shurikgo/cve-2026-25262-sm8450-research](https://github.com/shurikgo/cve-2026-25262-sm8450-research)
  > CVE-2026-25262 applicability to Snapdragon 8 Gen 1 — experimental results

### [Uevo001](https://github.com/Uevo001)
- 🌟 👤 [Uevo001](https://github.com/Uevo001) Starred [ExclaveNetwork/Exclave](https://github.com/ExclaveNetwork/Exclave)
  > Proxy client
- 🍴 👤 [Uevo001](https://github.com/Uevo001) Forked [ExclaveNetwork/Exclave](https://github.com/ExclaveNetwork/Exclave) to [Uevo001/Exclave](https://github.com/Uevo001/Exclave)
  > Proxy client

### [WAY29](https://github.com/WAY29)
- 🌟 👤 [WAY29](https://github.com/WAY29) Starred [koala73/worldmonitor](https://github.com/koala73/worldmonitor)
...
- 🌟 👤 [WenHao2130](https://github.com/WenHao2130) Starred [Zephyruso/zashboard](https://github.com/Zephyruso/zashboard)
...
- 🍴 👤 [WindySha](https://github.com/WindySha) Forked [google/artemis](https://github.com/google/artemis) to [WindySha/artemis](https://github.com/WindySha/artemis)
  > ARTEMIS turns natural-language instructions into reliable Android automation. It automates end-to-en...

### [WitherOrNot](https://github.com/WitherOrNot)
- 🌟 👤 [WitherOrNot](https://github.com/WitherOrNot) Starred [valeria-org/bitwright](https://github.com/valeria-org/bitwright)
  > Bit-vector expression simplifier for binary analysis and deobfuscation

### [XMuli](https://github.com/XMuli)
- 🌟 👤 [XMuli](https://github.com/XMuli) Starred [ZhhHugoChang/PushTV](https://github.com/ZhhHugoChang/PushTV)
  > PushTV 是一款全 AI 构建、专为 Android TV 打造的极速大屏工具箱

### [XiaoliChan](https://github.com/XiaoliChan)
- 🌟 👤 [XiaoliChan](https://github.com/XiaoliChan) Starred [Autumn-27/ScopeSentry](https://github.com/Autumn-27/ScopeSentry)
...
- 🌟 👤 [XtrLumen](https://github.com/XtrLumen) Starred [Dere3046/_patchHarmony](https://github.com/Dere3046/_patchHarmony)
  > no patch kernel Support DroidSpaces.

### [Youlor](https://github.com/Youlor)
- 🌟 👤 [Youlor](https://github.com/Youlor) Starred [openbot-coder/pytdxdata](https://github.com/openbot-coder/pytdxdata)
  > 通达信(TDX)行情数据客户端：动态连接池 + 双层TTL缓存 + 3连接并发分页，纯 asyncio、零运行时依赖；支持 A股/港股/美股/期货/期权

### [YuKongA](https://github.com/YuKongA)
- 🌟 👤 [YuKongA](https://github.com/YuKongA) Starred [Vysp3r/ProtonPlus](https://github.com/Vysp3r/ProtonPlus)
  > A modern compatibility tools manager
- 🌟 👤 [YuKongA](https://github.com/YuKongA) Starred [boykopovar/AnyPS5](https://github.com/boykopovar/AnyPS5)
  > Convert PS5 executables to run natively on Linux and Windows

### [acheong08](https://github.com/acheong08)
- 🌟 👤 [acheong08](https://github.com/acheong08) Starred [swoonqx/TypingPet](https://github.com/swoonqx/TypingPet)
  > 승우의 타이핑 펫

### [ant4g0nist](https://github.com/ant4g0nist)
- 🌟 👤 [ant4g0nist](https://github.com/ant4g0nist) Starred [TedDriggs/darling](https://github.com/TedDriggs/darling)
  > A Rust proc-macro attribute parser

### [apkunpacker](https://github.com/apkunpacker)
- 🌟 👤 [apkunpacker](https://github.com/apkunpacker) Starred [Ch0pin/rdx](https://github.com/Ch0pin/rdx)
  > A native APK and DEX decompiler written in Rust

### [aviraxp](https://github.com/aviraxp)
- 🍴 👤 [aviraxp](https://github.com/aviraxp) Forked [Wangs-official/op13t-cve-2026-64560](https://github.com/Wangs-official/op13t-cve-2026-64560) to [aviraxp/rmx5010-cve-2026-64560](https://github.com/aviraxp/rmx5010-cve-2026-64560)
  > 针对 OnePlus 13T 设备的 cve-2026-64560 复现

### [b3x206](https://github.com/b3x206)
- 🌟 👤 [b3x206](https://github.com/b3x206) Starred [sebbbi/NoGraphicsAPI](https://github.com/sebbbi/NoGraphicsAPI)
  > Minimal graphics API. Built on top of latest Vulkan extensions. As close as possibly to my "No Graph...

### [bet4it](https://github.com/bet4it)
- 🌟 👤 [bet4it](https://github.com/bet4it) Starred [tobi/disktree](https://github.com/tobi/disktree)
  > A treemap for finding and removing what fills your disk, for Omarchy. Rust + GPUI.
- 🌟 👤 [bet4it](https://github.com/bet4it) Starred [frostymur/aerofi](https://github.com/frostymur/aerofi)
...
- 🌟 👤 [chsbuffer](https://github.com/chsbuffer) Starred [WayDroid-ATV/waydroid-builds](https://github.com/WayDroid-ATV/waydroid-builds)
...
- 🚀 👤 [connorjaydunn](https://github.com/connorjaydunn) Made [connorjaydunn/CVE-2026-79417](https://github.com/connorjaydunn/CVE-2026-79417) public
  > CVE-2026-79417 PoC

### [ctkqiang](https://github.com/ctkqiang)
- 🌟 👤 [ctkqiang](https://github.com/ctkqiang) Starred [hoytech/strfry](https://github.com/hoytech/strfry)
  > a nostr relay
- 🌟 👤 [ctkqiang](https://github.com/ctkqiang) Starred [ctkqiang/NezhaSec](https://github.com/ctkqiang/NezhaSec)
  > 哪吒网络安全分析器是一款面向授权渗透测试的红队辅助工具。它通过 DeepSeek 大模型的函数调用能力动态规划攻击路径，并自动执行 nmap、sqlmap、nuclei、ffuf 等常用安全工具。整个...
- 🌟 👤 [ctkqiang](https://github.com/ctkqiang) Starred [Southclaws/storyden](https://github.com/Southclaws/storyden)
  >  With a fresh new take on traditional bulletin board forum software, Storyden is a modern, secure an...

### [duanluan](https://github.com/duanluan)
- 🚀 👤 [duanluan](https://github.com/duanluan) Made [duanluan/arch-cleaner](https://github.com/duanluan/arch-cleaner) public

### [eggfly](https://github.com/eggfly)
- 🍴 👤 [eggfly](https://github.com/eggfly) Forked [PizzaHandhelds/GameboyCartCAD](https://github.com/PizzaHandhelds/GameboyCartCAD) to [eggfly/GameboyCartCAD](https://github.com/eggfly/GameboyCartCAD)

### [einverne](https://github.com/einverne)
- 🌟 👤 [einverne](https://github.com/einverne) Starred [heygen-com/hyperframes](https://github.com/heygen-com/hyperframes)
  > Write HTML. Render video. Built for agents.

### [elllusion](https://github.com/elllusion)
- 🌟 👤 [elllusion](https://github.com/elllusion) Starred [WQARK/WQARK](https://github.com/WQARK/WQARK)
- 🌟 👤 [elllusion](https://github.com/elllusion) Starred [anthropics/claude-code](https://github.com/anthropics/claude-code)
  > Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and he...
- 🌟 👤 [elllusion](https://github.com/elllusion) Starred [GCWing/OpenBitFun](https://github.com/GCWing/OpenBitFun)
  > OpenBitFun combines a high-performance agent runtime written in Rust with a polished desktop applica...
...
- 🌟 👤 [evdenis](https://github.com/evdenis) Starred [tobi/disktree](https://github.com/tobi/disktree)
  > A treemap for finding and removing what fills your disk, for Omarchy. Rust + GPUI.
- 🌟 👤 [evdenis](https://github.com/evdenis) Starred [tobi/try](https://github.com/tobi/try)
  > fresh directories for every vibe
- 🌟 👤 [evdenis](https://github.com/evdenis) Starred [tobi/qmd](https://github.com/tobi/qmd)
...
- 🌟 👤 [everettjf](https://github.com/everettjf) Starred [zhaoxuya520/reverse-skill](https://github.com/zhaoxuya520/reverse-skill)
...
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [YuroGod/VMPStaticUnpacker](https://github.com/YuroGod/VMPStaticUnpacker) to [gmh5225/VMPStaticUnpacker](https://github.com/gmh5225/VMPStaticUnpacker)
  > Static VMProtect unpacker , supporting VMProtect 3.9.5
- 🌟 👤 [gmh5225](https://github.com/gmh5225) Starred [jev-chat/jev-chat-jarvis](https://github.com/jev-chat/jev-chat-jarvis)
  > 装在手机上的对话副驾：在 QQ / X / 飞书里读懂对方、给出候选回复、一键填入输入框，发不发由你。非侵入，只读屏幕，不 hook 不改包。
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [jev-chat/jev-chat-jarvis](https://github.com/jev-chat/jev-chat-jarvis) to [gmh5225/jev-chat-jarvis](https://github.com/gmh5225/jev-chat-jarvis)
  > 装在手机上的对话副驾：在 QQ / X / 飞书里读懂对方、给出候选回复、一键填入输入框，发不发由你。非侵入，只读屏幕，不 hook 不改包。
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [REAndroid/lib-global-metadata](https://github.com/REAndroid/lib-global-metadata) to [gmh5225/lib-global-metadata](https://github.com/gmh5225/lib-global-metadata)
  > A java library to read, write and edit unity's global-metadata.dat resource file
- 🌟 👤 [gmh5225](https://github.com/gmh5225) Starred [okcontract/oksolc](https://github.com/okcontract/oksolc)
  > A Solidity compiler written in Zig
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [okcontract/oksolc](https://github.com/okcontract/oksolc) to [gmh5225/oksolc](https://github.com/gmh5225/oksolc)
  > A Solidity compiler written in Zig
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [Harzva/learn-likecc](https://github.com/Harzva/learn-likecc) to [gmh5225/learn-likecc](https://github.com/gmh5225/learn-likecc)
...
- 🌟 👤 [hanc00l](https://github.com/hanc00l) Starred [Yean-Sec/StrikeAgent_AtkBrain-Flash](https://github.com/Yean-Sec/StrikeAgent_AtkBrain-Flash)
  > 由夜安团队研发的AI Agent渗透测试平台，强调自监督，自循环，自进化首创寻宝机制，涵盖红队打点、SRC、CTF，特别是在红队领域有极为亮眼的存在

### [huiliyi37](https://github.com/huiliyi37)
- 🌟 👤 [huiliyi37](https://github.com/huiliyi37) Starred [elysia395/dsh-wallpaper-engine](https://github.com/elysia395/dsh-wallpaper-engine)
  > 把本机 Wallpaper Engine 的壁纸变成 DSH 网页界面的背景：Video 动态播放、Web 以 iframe 加载、Scene 壁纸提取主纹理作为静态帧；iOS 液态玻璃设置窗口（配色...

### [hyuunnn](https://github.com/hyuunnn)
- 🌟 👤 [hyuunnn](https://github.com/hyuunnn) Starred [trailofbits/coop](https://github.com/trailofbits/coop)
  > Isolated VM environment for running Claude Code and Codex
- 🌟 👤 [hyuunnn](https://github.com/hyuunnn) Starred [vercel/eve](https://github.com/vercel/eve)
  > The Open Framework for Building Agents
- 🌟 👤 [hyuunnn](https://github.com/hyuunnn) Starred [HexRaysSA/ida-mcp](https://github.com/HexRaysSA/ida-mcp)
  > Official Hex-Rays IDA MCP Server.
...
### [i1tao](https://github.com/i1tao)
- 🌟 👤 [i1tao](https://github.com/i1tao) Starred [Minglink/dsh-infinite-gen-4](https://github.com/Minglink/dsh-infinite-gen-4)
...
- 🌟 👤 [imlk0](https://github.com/imlk0) Starred [WellsWang/vckb](https://github.com/WellsWang/vckb)
  > 创建一个可以灵活定义的USB键盘
- 🌟 👤 [imlk0](https://github.com/imlk0) Starred [noimank/tvbox](https://github.com/noimank/tvbox)
  > 自用tvbox源分享，影视仓多仓源分享，tvbox相关资源记录，iptv直播
- 🌟 👤 [imlk0](https://github.com/imlk0) Starred [HerbertHe/iptv-sources](https://github.com/HerbertHe/iptv-sources)
  > Autoupdate iptv sources

### [jiji262](https://github.com/jiji262)
- 🌟 👤 [jiji262](https://github.com/jiji262) Starred [lintsinghua/paint-mv-skills](https://github.com/lintsinghua/paint-mv-skills)
  > Agent skills that turn a song and its lyrics into a hand-painted watercolour music video (p5.brush +...
- 🌟 👤 [jiji262](https://github.com/jiji262) Starred [SilenceSik/media-indexer](https://github.com/SilenceSik/media-indexer)
  > 本地媒体库索引与整理框架：番号识别 → 磁力关联 → 质检 → 整理，含 MCP 工具层（v2 主线）
- 🌟 👤 [jiji262](https://github.com/jiji262) Starred [ewkzcz/bili-2-ppt](https://github.com/ewkzcz/bili-2-ppt)
  > init: 初始化 bili-2-ppt 项目
- 🌟 👤 [jiji262](https://github.com/jiji262) Starred [jsh135790/AIGC-Gallery](https://github.com/jsh135790/AIGC-Gallery)
  > A Vue 3 SPA for browsing NovelAI v5 artist style prompts and managing AI-generated images with autom...
- 🌟 👤 [jiji262](https://github.com/jiji262) Starred [liangdabiao/cloudbase-saas-starter](https://github.com/liangdabiao/cloudbase-saas-starter)
  > 腾讯云 CloudBase版本SaaS for AI : 一个使用 Next.js 14、TypeScript 和 Tailwind CSS 构建的现代、功能完善的 SaaS AI 模板。
- 🌟 👤 [jiji262](https://github.com/jiji262) Starred [wxwxOk/mediasite](https://github.com/wxwxOk/mediasite)
  > 自托管影视发现站 + DHT 磁力检索：TMDB 榜单、豆瓣/烂番茄评分、bitmagnet 爬虫 Web 控制台
- 🌟 👤 [jiji262](https://github.com/jiji262) Starred [StanlySGY/ComposeOps](https://github.com/StanlySGY/ComposeOps)
  > 一个运维管理项目，管理服务器上的各种服务

### [jmpews](https://github.com/jmpews)
- 🌟 👤 [jmpews](https://github.com/jmpews) Starred [valeria-org/bitwright](https://github.com/valeria-org/bitwright)
  > Bit-vector expression simplifier for binary analysis and deobfuscation

### [jonatan1024](https://github.com/jonatan1024)
- 🍴 👤 [jonatan1024](https://github.com/jonatan1024) Forked [ValveSoftware/halflife](https://github.com/ValveSoftware/halflife) to [GoldSrc-one/ricochet](https://github.com/GoldSrc-one/ricochet)
...
- 🌟 👤 [lightless233](https://github.com/lightless233) Starred [botiverse/raft-source](https://github.com/botiverse/raft-source)
...
- 🌟 👤 [lucky-oi](https://github.com/lucky-oi) Starred [greluoqixi/cc-switch-web](https://github.com/greluoqixi/cc-switch-web)
- 🍴 👤 [lucky-oi](https://github.com/lucky-oi) Forked [greluoqixi/cc-switch-web](https://github.com/greluoqixi/cc-switch-web) to [lucky-oi/cc-switch-web](https://github.com/lucky-oi/cc-switch-web)
...
- 🍴 👤 [mav8557](https://github.com/mav8557) Forked [drajb/whisper-local](https://github.com/drajb/whisper-local) to [mav8557/whisper-local](https://github.com/mav8557/whisper-local)
  > Free, open-source, 100% offline AI dictation for Windows & macOS. Wispr Flow / Dragon alternative. P...
- 🍴 👤 [mav8557](https://github.com/mav8557) Forked [PinW/whisper-key-local](https://github.com/PinW/whisper-key-local) to [mav8557/whisper-key-local](https://github.com/mav8557/whisper-key-local)
...
- 🌟 👤 [mos9527](https://github.com/mos9527) Starred [BnuuySolutions/PSVR2Toolkit](https://github.com/BnuuySolutions/PSVR2Toolkit)
...
- 🌟 👤 [muellan](https://github.com/muellan) Starred [tobi/disktree](https://github.com/tobi/disktree)
  > A treemap for finding and removing what fills your disk, for Omarchy. Rust + GPUI.

### [mzfr](https://github.com/mzfr)
- 🌟 👤 [mzfr](https://github.com/mzfr) Starred [debezium/debezium](https://github.com/debezium/debezium)
  > Change data capture for a variety of databases. Please log issues at https://github.com/debezium/dbz...
- 🌟 👤 [mzfr](https://github.com/mzfr) Starred [opa334/Dopamine](https://github.com/opa334/Dopamine)
  > Dopamine is a semi-untethered jailbreak for iOS 15 to 26(.0.1)

### [nicchongwb](https://github.com/nicchongwb)
- 🌟 👤 [nicchongwb](https://github.com/nicchongwb) Starred [deenrookie/pulse](https://github.com/deenrookie/pulse)

### [null-dev](https://github.com/null-dev)
- 🌟 👤 [null-dev](https://github.com/null-dev) Starred [JingMatrix/ChromeXt](https://github.com/JingMatrix/ChromeXt)
  > UserScript and DevTools supports for Chromium based and WebView based browsers
- 🌟 👤 [null-dev](https://github.com/null-dev) Starred [frisk1127/FuckCustomTab](https://github.com/frisk1127/FuckCustomTab)
  > FuckCustomTab
...
- 🌟 👤 [onhexgroup](https://github.com/onhexgroup) Starred [wesmar/KernelResearchKit](https://github.com/wesmar/KernelResearchKit)
...
- 🌟 👤 [phith0n](https://github.com/phith0n) Starred [yu1745/wetype-ime-linux](https://github.com/yu1745/wetype-ime-linux)
...
- 🌟 👤 [raesene](https://github.com/raesene) Starred [arni-labs/katagami](https://github.com/arni-labs/katagami)
...
- 🌟 👤 [rogxo](https://github.com/rogxo) Starred [noahware/kernemul](https://github.com/noahware/kernemul)
  > Windows kernel driver and usermode app emulator for x86-64 and ARM64 targets.

### [sakana164](https://github.com/sakana164)
- 🌟 👤 [sakana164](https://github.com/sakana164) Starred [yagay/ListCleaner](https://github.com/yagay/ListCleaner)

### [sh1ma](https://github.com/sh1ma)
- 🌟 👤 [sh1ma](https://github.com/sh1ma) Starred [L4Ph/Rinka](https://github.com/L4Ph/Rinka)
  > Opt-in per-route Dynamic Worker (Worker Loader) delegation for Hono on Cloudflare Workers

### [sjshb57](https://github.com/sjshb57)
- 🌟 👤 [sjshb57](https://github.com/sjshb57) Starred [vladelaina/BongoCat](https://github.com/vladelaina/BongoCat)
  > 🩷 💘C × SDL3 × OpenGL — Three Mysterious Forces, United as One! Bong~ Bongocat!!!Don't be shy, Join H...

### [skyzh](https://github.com/skyzh)
- 🌟 👤 [skyzh](https://github.com/skyzh) Starred [botiverse/raft-source](https://github.com/botiverse/raft-source)
  > Raft source-available release mirror. One snapshot commit per release; pull requests are not accepte...

### [smallevilbeast](https://github.com/smallevilbeast)
- 🌟 👤 [smallevilbeast](https://github.com/smallevilbeast) Starred [liuwenhuan/FileCommander](https://github.com/liuwenhuan/FileCommander)
  > 又酷又快的双栏文件管理器 / A dual-pane file manager for Linux and Windows
- 🌟 👤 [smallevilbeast](https://github.com/smallevilbeast) Starred [Sonic853/TTPlayer](https://github.com/Sonic853/TTPlayer)
  > 千千静听社区复刻版 Thousand Tunes Player
...
- 🌟 👤 [su-vikas](https://github.com/su-vikas) Starred [ShinoLeah/eDBG](https://github.com/ShinoLeah/eDBG)
  > eBPF-based lightweight debugger for Android with MCP support
- 🌟 👤 [su-vikas](https://github.com/su-vikas) Starred [amruth-sn/kong](https://github.com/amruth-sn/kong)
  > The world's first agentic reverse engineer.
- 🌟 👤 [su-vikas](https://github.com/su-vikas) Starred [NebuSec/CyberMeowfia](https://github.com/NebuSec/CyberMeowfia)
  > PoCs and exploits for CVEs discovered by NebuSec. 
- 🌟 👤 [su-vikas](https://github.com/su-vikas) Starred [xajkep/wordlists](https://github.com/xajkep/wordlists)
  > Infosec Wordlists and more.

### [surendrajat](https://github.com/surendrajat)
- 🌟 👤 [surendrajat](https://github.com/surendrajat) Starred [Recurse-Labs/recurse](https://github.com/Recurse-Labs/recurse)
  > AI Native IDE for reverse engineering

### [taisuii](https://github.com/taisuii)
- 🌟 👤 [taisuii](https://github.com/taisuii) Starred [earendil-works/pi](https://github.com/earendil-works/pi)
  > AI agent toolkit: unified LLM API, agent loop, TUI, coding agent CLI

### [thebabush](https://github.com/thebabush)
- 🌟 👤 [thebabush](https://github.com/thebabush) Starred [trailofbits/coop](https://github.com/trailofbits/coop)
  > Isolated VM environment for running Claude Code and Codex
- 🌟 👤 [thebabush](https://github.com/thebabush) Starred [lima-vm/lima](https://github.com/lima-vm/lima)
...
- 🌟 👤 [x0rz4](https://github.com/x0rz4) Starred [wlzh/dji-4g-vohive-mac](https://github.com/wlzh/dji-4g-vohive-mac)
...
- 🚀 👤 [xingguangcuican6666](https://github.com/xingguangcuican6666) Made [xingguangcuican6666/AnyCode](https://github.com/xingguangcuican6666/AnyCode) public
- 🍴 👤 [xingguangcuican6666](https://github.com/xingguangcuican6666) Forked [yiteei/ABK](https://github.com/yiteei/ABK) to [project-unused/ABK_t1](https://github.com/project-unused/ABK_t1)
  > AnyBase Kernel. To build GKI with your any idea!
- 🌟 👤 [xingguangcuican6666](https://github.com/xingguangcuican6666) Starred [weave-os/router](https://github.com/weave-os/router)
...
- 🌟 👤 [xixiaobei-bei](https://github.com/xixiaobei-bei) Starred [mxschmitt/action-tmate](https://github.com/mxschmitt/action-tmate)
  > Debug your GitHub Actions via SSH by using tmate to get access to the runner system itself.

### [yahch](https://github.com/yahch)
- 🌟 👤 [yahch](https://github.com/yahch) Starred [yb2460/harness-anything](https://github.com/yb2460/harness-anything)
...
- 🌟 👤 [yhs0602](https://github.com/yhs0602) Starred [snap-stanford/Biomni](https://github.com/snap-stanford/Biomni)
  > Biomni: a general-purpose biomedical AI agent

### [yinsel](https://github.com/yinsel)
- 🌟 👤 [yinsel](https://github.com/yinsel) Starred [HexRaysSA/ida-mcp](https://github.com/HexRaysSA/ida-mcp)
  > Official Hex-Rays IDA MCP Server.

### [ymdzq](https://github.com/ymdzq)
- 🌟 👤 [ymdzq](https://github.com/ymdzq) Starred [henrypp/memreduct](https://github.com/henrypp/memreduct)
...
- 🌟 👤 [zenghongtu](https://github.com/zenghongtu) Starred [cclank/jevclip](https://github.com/cclank/jevclip)
  > Jev-powered video highlights and cited summaries from subtitles and scripts
- 🌟 👤 [zenghongtu](https://github.com/zenghongtu) Starred [leter/zh-tech-writing](https://github.com/leter/zh-tech-writing)
  > 写中文技术文档的 Agent Skill，基于阮一峰《中文技术文档的写作规范》：短句、平实、没有 AI 腔
- 🌟 👤 [zenghongtu](https://github.com/zenghongtu) Starred [zh-lx/pinyin-pro](https://github.com/zh-lx/pinyin-pro)
  > 中文转拼音、拼音音调、拼音声母、拼音韵母、多音字拼音、姓氏拼音、拼音匹配、中文分词
- 🌟 👤 [zenghongtu](https://github.com/zenghongtu) Starred [eternity4719/HowToLiveBetter](https://github.com/eternity4719/HowToLiveBetter)
  > 按性价比排序的循证生活指南：长寿防病、急救、省钱理财、法律红线、失业与工伤、医保社保、恋爱婚育、怀孕育儿、创业与做平台合规、出国与技能。每条写明成本、收益、证据等级和原始出处，只引期刊论文与官方文件。
- 🌟 👤 [zenghongtu](https://github.com/zenghongtu) Starred [yetone/magpie](https://github.com/yetone/magpie)
  > Every agent's model. One place. Codex on DeepSeek, Claude Code on Kimi, from the menu bar.
- 🌟 👤 [zenghongtu](https://github.com/zenghongtu) Starred [xianxie6/qingming-riverside](https://github.com/xianxie6/qingming-riverside)
