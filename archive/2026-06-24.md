...
- 🍴 👤 [0x1306a94](https://github.com/0x1306a94) Forked [farion1231/cc-switch](https://github.com/farion1231/cc-switch) to [0x1306a94/cc-switch](https://github.com/0x1306a94/cc-switch)
...
- 🌟 👤 [0xjiayu](https://github.com/0xjiayu) Starred [TapXWorld/ChinaTextbook](https://github.com/TapXWorld/ChinaTextbook)
  > 所有小初高、大学PDF教材。

### [1193776794](https://github.com/1193776794)
- 🌟 👤 [1193776794](https://github.com/1193776794) Starred [zgy0x01/QTrace](https://github.com/zgy0x01/QTrace)
  > qbdi based android arm64 trace tool

### [1c7](https://github.com/1c7)
- 🚀 👤 [1c7](https://github.com/1c7) Made [MiraclePlus/mplus-cli-issues](https://github.com/MiraclePlus/mplus-cli-issues) public
  > mplus-cli 的问题反馈仓库。如果你在使用 mplus 命令行工具时遇到 bug、有功能建议或使用疑问，请提交 Issue。

### [4ra1n](https://github.com/4ra1n)
- 🌟 👤 [4ra1n](https://github.com/4ra1n) Starred [cloudflare/security-audit-skill](https://github.com/cloudflare/security-audit-skill)
...
- 🌟 👤 [Abbbbbi](https://github.com/Abbbbbi) Starred [harmony-on-android/HOA](https://github.com/harmony-on-android/HOA)
  > Run OpenHarmony hap on Android

### [AndnixSH](https://github.com/AndnixSH)
- 🌟 👤 [AndnixSH](https://github.com/AndnixSH) Starred [SeeFlowerX/stackplz](https://github.com/SeeFlowerX/stackplz)
  > 基于eBPF的堆栈追踪工具
...
- 🌟 👤 [FeiLingshu](https://github.com/FeiLingshu) Starred [ikas-mc/ContextMenuForWindows11](https://github.com/ikas-mc/ContextMenuForWindows11)
  > Add Custom Context Menu For Windows11

### [Forgo7ten](https://github.com/Forgo7ten)
- 🍴 👤 [Forgo7ten](https://github.com/Forgo7ten) Forked [5ec1cff/zygisk-module-template](https://github.com/5ec1cff/zygisk-module-template) to [Forgo7ten/zygisk-module-template](https://github.com/Forgo7ten/zygisk-module-template)

### [GaoYuCan](https://github.com/GaoYuCan)
- 🍴 👤 [GaoYuCan](https://github.com/GaoYuCan) Forked [skylot/jadx](https://github.com/skylot/jadx) to [GaoYuCan/jadx](https://github.com/GaoYuCan/jadx)
  > Dex to Java decompiler

### [Grigory-Rylov](https://github.com/Grigory-Rylov)
- 🌟 👤 [Grigory-Rylov](https://github.com/Grigory-Rylov) Starred [hogeheer499-commits/strix-halo-guide](https://github.com/hogeheer499-commits/strix-halo-guide)
  > AMD Strix Halo local LLM guide: setup for Ryzen AI MAX+ 395 / Radeon 8060S, Ollama, llama.cpp Vulkan...

### [HATTER-LONG](https://github.com/HATTER-LONG)
- 🌟 👤 [HATTER-LONG](https://github.com/HATTER-LONG) Starred [longbridge/gpui-component](https://github.com/longbridge/gpui-component)
...
- 🌟 👤 [Konano](https://github.com/Konano) Starred [tailscale/tailscale](https://github.com/tailscale/tailscale)
  > The easiest, most secure way to use WireGuard and 2FA.
- 🌟 👤 [Konano](https://github.com/Konano) Starred [openclaw/gogcli](https://github.com/openclaw/gogcli)
...
- 🌟 👤 [NeoMaster831](https://github.com/NeoMaster831) Starred [jamesstringer90/appsandbox](https://github.com/jamesstringer90/appsandbox)
  > Easily create full virtual machines that are sandboxed for development or computer use models.
- 🌟 👤 [NeoMaster831](https://github.com/NeoMaster831) Starred [amaralkaff/hyperv-pubg-external](https://github.com/amaralkaff/hyperv-pubg-external)
  > Rust + hyper-reV hypervisor backend. CPUID hypercalls for memory R/W.

### [NiTianErXing666](https://github.com/NiTianErXing666)
- 🌟 👤 [NiTianErXing666](https://github.com/NiTianErXing666) Starred [JingMatrix/Vector](https://github.com/JingMatrix/Vector)
...
- 🍴 👤 [OfficialKatana](https://github.com/OfficialKatana) Forked [npanel-dev/NPanel-backend](https://github.com/npanel-dev/NPanel-backend) to [Mundo-Connect/NPanel-backend](https://github.com/Mundo-Connect/NPanel-backend)

### [PangBaiWork](https://github.com/PangBaiWork)
- 🌟 👤 [PangBaiWork](https://github.com/PangBaiWork) Starred [CreditTone/hooker](https://github.com/CreditTone/hooker)
...
- 🌟 👤 [S3cur3Th1sSh1t](https://github.com/S3cur3Th1sSh1t) Starred [originsec/pocsmith](https://github.com/originsec/pocsmith)
  > Autonomous Windows POC developer from patchwatch diff reports

### [Seyud](https://github.com/Seyud)
- 🌟 👤 [Seyud](https://github.com/Seyud) Starred [harmony-on-android/HOA](https://github.com/harmony-on-android/HOA)
  > Run OpenHarmony hap on Android

### [Silentsoul04](https://github.com/Silentsoul04)
- 🍴 👤 [Silentsoul04](https://github.com/Silentsoul04) Forked [adshao/flounder](https://github.com/adshao/flounder) to [Silentsoul04/flounder](https://github.com/Silentsoul04/flounder)
  > Autonomous white-hat security auditor
...
- 🍴 👤 [ViRb3](https://github.com/ViRb3) Forked [jerkeeler/restoration](https://github.com/jerkeeler/restoration) to [ViRb3/restoration](https://github.com/ViRb3/restoration)
...
- 🌟 👤 [VonChange](https://github.com/VonChange) Starred [UrkeJH/ShizukuDhizuku-list](https://github.com/UrkeJH/ShizukuDhizuku-list)
  > 一个收集支持Shizuku和Dhizuku的软件的项目

### [Walkman100](https://github.com/Walkman100)
- 🌟 👤 [Walkman100](https://github.com/Walkman100) Starred [ozone10/7zip-Dark7zip](https://github.com/ozone10/7zip-Dark7zip)
  > Dark mode for 7-Zip and 7-Zip-zstd
- 🌟 👤 [Walkman100](https://github.com/Walkman100) Starred [mcmilk/7-Zip-zstd](https://github.com/mcmilk/7-Zip-zstd)
  > 7-Zip with support for Brotli, Fast-LZMA2, Lizard, LZ4, LZ5 and Zstandard

### [XiaoTong6666](https://github.com/XiaoTong6666)
- 🌟 👤 [XiaoTong6666](https://github.com/XiaoTong6666) Starred [ReSukiSU/ReSukiSU](https://github.com/ReSukiSU/ReSukiSU)
  > A KernelSU based root solution for Android
- 🌟 👤 [XiaoTong6666](https://github.com/XiaoTong6666) Starred [cctv18/oppo_oplus_realme_sm8750](https://github.com/cctv18/oppo_oplus_realme_sm8750)
...
- 🌟 👤 [Yu2erer](https://github.com/Yu2erer) Starred [godothub/godot-minigame](https://github.com/godothub/godot-minigame)
  > Godot 4 微信小游戏导出插件，使用 Release 模板分发与版本适配。

### [ZSA233](https://github.com/ZSA233)
- 🍴 👤 [ZSA233](https://github.com/ZSA233) Forked [mor-o/comfyui-2d-character-pipeline](https://github.com/mor-o/comfyui-2d-character-pipeline) to [ZSA233/comfyui-2d-character-pipeline](https://github.com/ZSA233/comfyui-2d-character-pipeline)
  > an ai harness-driven comfyui pipeline for creating 2d characters

### [afkT](https://github.com/afkT)
- 🌟 👤 [afkT](https://github.com/afkT) Starred [MustardChef/WSABuilds](https://github.com/MustardChef/WSABuilds)
...
- 🌟 👤 [apkunpacker](https://github.com/apkunpacker) Starred [akustikrausch/airplay2-sender-cpp](https://github.com/akustikrausch/airplay2-sender-cpp)
...
- 🌟 👤 [codehz](https://github.com/codehz) Starred [tractordev/wanix](https://github.com/tractordev/wanix)
  > A virtual environment runtime for the web, inspired by Plan 9

### [coder-pig](https://github.com/coder-pig)
- 🌟 👤 [coder-pig](https://github.com/coder-pig) Starred [lewislulu/html-ppt-skill](https://github.com/lewislulu/html-ppt-skill)
  > HTML PPT Studio — AgentSkill with 24 themes, 31 layouts, 20+ animations for building professional HT...
- 🌟 👤 [coder-pig](https://github.com/coder-pig) Starred [hugohe3/ppt-master](https://github.com/hugohe3/ppt-master)
  > AI generates a real, editable PowerPoint from any document — native shapes & animations, speaker not...
- 🌟 👤 [coder-pig](https://github.com/coder-pig) Starred [sunbigfly/ppt-agent-skills](https://github.com/sunbigfly/ppt-agent-skills)
  > A code-driven presentation generation framework. 像构建软件工程一样生成演示文稿。

### [crvvdev](https://github.com/crvvdev)
- 🌟 👤 [crvvdev](https://github.com/crvvdev) Starred [zhaoxuya520/reverse-skill](https://github.com/zhaoxuya520/reverse-skill)
...
- 🌟 👤 [ctkqiang](https://github.com/ctkqiang) Starred [wgpsec/AboutSecurity](https://github.com/wgpsec/AboutSecurity)
  > Everything for pentest. | 渗透测试知识库，以 AI Agent 可执行的格式沉淀安全方法论。
- 🍴 👤 [ctkqiang](https://github.com/ctkqiang) Forked [BishopFox/sliver](https://github.com/BishopFox/sliver) to [ctkqiang/sliver](https://github.com/ctkqiang/sliver)
  > Adversary Emulation Framework

### [cujanovic](https://github.com/cujanovic)
- 🌟 👤 [cujanovic](https://github.com/cujanovic) Starred [pashov/skills](https://github.com/pashov/skills)
  > Pashov Audit Group Skills

### [d3adzo](https://github.com/d3adzo)
- 🌟 👤 [d3adzo](https://github.com/d3adzo) Starred [nmht3t/RawHive](https://github.com/nmht3t/RawHive)
...
- 🌟 👤 [darbra](https://github.com/darbra) Starred [xiaojianbang8888/OLLVM_Deobfuscator](https://github.com/xiaojianbang8888/OLLVM_Deobfuscator)
  > OLLVM Deobfuscation Tool

### [darkskygit](https://github.com/darkskygit)
- 🌟 👤 [darkskygit](https://github.com/darkskygit) Starred [KasperskyLab/hrtng](https://github.com/KasperskyLab/hrtng)
...
- 🌟 👤 [dartcv](https://github.com/dartcv) Starred [oneQAQone/QFun](https://github.com/oneQAQone/QFun)
  > 一个QQ/TIM功能性Xposed模块
...
- 🌟 👤 [dzxpert](https://github.com/dzxpert) Starred [rust-diplomat/diplomat](https://github.com/rust-diplomat/diplomat)
  > Rust tool for generating FFI definitions allowing many other languages to call Rust code
- 🌟 👤 [dzxpert](https://github.com/dzxpert) Starred [mozilla/uniffi-rs](https://github.com/mozilla/uniffi-rs)
  > a multi-language bindings generator for rust

### [feixiao](https://github.com/feixiao)
- 🌟 👤 [feixiao](https://github.com/feixiao) Starred [electkismet/eltdx](https://github.com/electkismet/eltdx)
...
- 🌟 👤 [fishso](https://github.com/fishso) Starred [JuliusBrussee/caveman](https://github.com/JuliusBrussee/caveman)
...
- 🌟 👤 [gal2xy](https://github.com/gal2xy) Starred [romainthomas/droidguard-samples](https://github.com/romainthomas/droidguard-samples)
  > DroidGuard VM Samples
- 🌟 👤 [gal2xy](https://github.com/gal2xy) Starred [quarkslab/android-restriction-bypass](https://github.com/quarkslab/android-restriction-bypass)
  > PoC to bypass Android restrictions

### [gamelaster](https://github.com/gamelaster)
- 🌟 👤 [gamelaster](https://github.com/gamelaster) Starred [JuanCF/scrcpy-mcp](https://github.com/JuanCF/scrcpy-mcp)
  > MCP server for Android device control via ADB and scrcpy — gives AI agents vision and control over A...

### [gh0stkey](https://github.com/gh0stkey)
- 🌟 👤 [gh0stkey](https://github.com/gh0stkey) Starred [eclipse-theia/theia](https://github.com/eclipse-theia/theia)
  > Eclipse Theia is a cloud & desktop IDE framework implemented in TypeScript.
- 🌟 👤 [gh0stkey](https://github.com/gh0stkey) Starred [HACK-THE-WORLD/bore](https://github.com/HACK-THE-WORLD/bore)
- 🌟 👤 [gh0stkey](https://github.com/gh0stkey) Starred [microsoft/SkillOpt](https://github.com/microsoft/SkillOpt)
  > SkillOpt is a text-space optimizer that trains reusable natural-language skills for frozen LLM agent...
- 🌟 👤 [gh0stkey](https://github.com/gh0stkey) Starred [abiosoft/colima](https://github.com/abiosoft/colima)
  > Container runtimes on macOS (and Linux) with minimal setup
- 🌟 👤 [gh0stkey](https://github.com/gh0stkey) Starred [zhaoxuya520/reverse-skill](https://github.com/zhaoxuya520/reverse-skill)
  > Reverse Engineering / Authorized Penetration Testing / Security Research Skill Router Pack AI-powere...

### [gmh5225](https://github.com/gmh5225)
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [nova452/ComfyUI-ConditioningKrea2Rebalance](https://github.com/nova452/ComfyUI-ConditioningKrea2Rebalance) to [gmh5225/ComfyUI-ConditioningKrea2Rebalance](https://github.com/gmh5225/ComfyUI-ConditioningKrea2Rebalance)
...
- 🌟 👤 [h3h3qaq](https://github.com/h3h3qaq) Starred [tw93/Mole](https://github.com/tw93/Mole)
  > 🐹 Clean, uninstall, analyze, optimize, and monitor your Mac from the terminal.

### [halfkiss](https://github.com/halfkiss)
- 🌟 👤 [halfkiss](https://github.com/halfkiss) Starred [jgm/pandoc](https://github.com/jgm/pandoc)
  > Universal markup converter

### [hanbings](https://github.com/hanbings)
- 🌟 👤 [hanbings](https://github.com/hanbings) Starred [can1357/oh-my-pi](https://github.com/can1357/oh-my-pi)
...
- 🌟 👤 [hhhaiai](https://github.com/hhhaiai) Starred [SheepChef/Abracadabra](https://github.com/SheepChef/Abracadabra)
  > Abracadabra 魔曰，古文风文本加密工具
- 🍴 👤 [hhhaiai](https://github.com/hhhaiai) Forked [SheepChef/Abracadabra](https://github.com/SheepChef/Abracadabra) to [hhhaiai/Abracadabra](https://github.com/hhhaiai/Abracadabra)
  > Abracadabra 魔曰，古文风文本加密工具
...
- 🌟 👤 [huoji120](https://github.com/huoji120) Starred [OpenPipe/ART](https://github.com/OpenPipe/ART)
  > Agent Reinforcement Trainer: train multi-step agents for real-world tasks using GRPO. Give your agen...

### [idkhidden](https://github.com/idkhidden)
- 🌟 👤 [idkhidden](https://github.com/idkhidden) Starred [chromium/chromium](https://github.com/chromium/chromium)
  > The official GitHub mirror of the Chromium source

### [jianglin-code](https://github.com/jianglin-code)
- 🌟 👤 [jianglin-code](https://github.com/jianglin-code) Starred [googleworkspace/cli](https://github.com/googleworkspace/cli)
  > Google Workspace CLI — one command-line tool for Drive, Gmail, Calendar, Sheets, Docs, Chat, Admin, ...

### [jmpews](https://github.com/jmpews)
- 🌟 👤 [jmpews](https://github.com/jmpews) Starred [littleShrimp2333/ios-cmio-mirror](https://github.com/littleShrimp2333/ios-cmio-mirror)
  > iOS screen capture toolkit using CoreMediaIO bridge on macOS — no on-device app required. Verified f...
- 🌟 👤 [jmpews](https://github.com/jmpews) Starred [StarTrail-org/PixelRAG](https://github.com/StarTrail-org/PixelRAG)
  > The end of web parsing. The beginning of scalable pixel-native search.
- 🌟 👤 [jmpews](https://github.com/jmpews) Starred [antimof/UxPlay](https://github.com/antimof/UxPlay)
  > AirPlay Unix mirroring server
- 🌟 👤 [jmpews](https://github.com/jmpews) Starred [PrefectHQ/prefect](https://github.com/PrefectHQ/prefect)
...
- 🌟 👤 [k0mraid3](https://github.com/k0mraid3) Starred [D3FEKT/ForzaTechStudio](https://github.com/D3FEKT/ForzaTechStudio)
  > Multi resource editing tools for Forza Motorsport and Forza Horizon

### [kasnria001](https://github.com/kasnria001)
- 🌟 👤 [kasnria001](https://github.com/kasnria001) Starred [daedalus/BreakingECDSAwithLLL](https://github.com/daedalus/BreakingECDSAwithLLL)
...
- 🌟 👤 [kotori2](https://github.com/kotori2) Starred [LukeFZ/Il2CppInspectorRedux](https://github.com/LukeFZ/Il2CppInspectorRedux)
...
- 🌟 👤 [lamster2018](https://github.com/lamster2018) Starred [chen08209/FlClash](https://github.com/chen08209/FlClash)
  > A multi-platform proxy client based on ClashMeta,simple and easy to use, open-source and ad-free.
- 🌟 👤 [lamster2018](https://github.com/lamster2018) Starred [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg)
...
- 🌟 👤 [linxid](https://github.com/linxid) Starred [omnigent-ai/omnigent](https://github.com/omnigent-ai/omnigent)
...
- 🌟 👤 [ltttttttttttt](https://github.com/ltttttttttttt) Starred [htdt/godogen](https://github.com/htdt/godogen)
  > Autonomous game development for Godot and Bevy with Claude Code and Codex

### [lyy289065406](https://github.com/lyy289065406)
- 🌟 👤 [lyy289065406](https://github.com/lyy289065406) Starred [nextlevelbuilder/ui-ux-pro-max-skill](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill)
  > An AI SKILL that provide design intelligence for building professional UI/UX multiple platforms

### [mahmoudimus](https://github.com/mahmoudimus)
- 🌟 👤 [mahmoudimus](https://github.com/mahmoudimus) Starred [BohemiaInteractive/CWR](https://github.com/BohemiaInteractive/CWR)
...
- 🌟 👤 [mos9527](https://github.com/mos9527) Starred [SnapdragonGameStudios/snapdragon-gsr](https://github.com/SnapdragonGameStudios/snapdragon-gsr)
...
- 🌟 👤 [namename333](https://github.com/namename333) Starred [davinci1012/pinduoduo_backdoor_unpacker](https://github.com/davinci1012/pinduoduo_backdoor_unpacker)
  > Samples and Unpacker of malicious backdoors and exploits developed and used by Pinduoduo

### [nblog](https://github.com/nblog)
- 🌟 👤 [nblog](https://github.com/nblog) Starred [microsoft/Windows-Driver-Developer-Supplemental-Tools](https://github.com/microsoft/Windows-Driver-Developer-Supplemental-Tools)
  > Supplemental open-source components for use in developing device drivers for Windows.

### [nek0y4nsu](https://github.com/nek0y4nsu)
- 🌟 👤 [nek0y4nsu](https://github.com/nek0y4nsu) Starred [lqqyt2423/go-mitmproxy](https://github.com/lqqyt2423/go-mitmproxy)
...
- 🌟 👤 [niqiuqiux](https://github.com/niqiuqiux) Starred [calesthio/OpenMontage](https://github.com/calesthio/OpenMontage)
  > World's first open-source, agentic video production system. 12 pipelines, 52 tools, 500+ agent skill...

### [null-dev](https://github.com/null-dev)
- 🌟 👤 [null-dev](https://github.com/null-dev) Starred [parawanderer/OpenTagViewer](https://github.com/parawanderer/OpenTagViewer)
...
- 🌟 👤 [rrrrrrri](https://github.com/rrrrrrri) Starred [bnomei/tmux-mcp](https://github.com/bnomei/tmux-mcp)
  > Lets agents create sessions, split panes, run commands, and capture output with TMUX.

### [sakana164](https://github.com/sakana164)
- 🌟 👤 [sakana164](https://github.com/sakana164) Starred [hanbao233xD/LittleClicker](https://github.com/hanbao233xD/LittleClicker)
  > Scheduled Autoclicker based on Android Accessibility service,Support NTP Time Sync

### [seisman](https://github.com/seisman)
- 🌟 👤 [seisman](https://github.com/seisman) Starred [StuartJRussell/EllipticiPy](https://github.com/StuartJRussell/EllipticiPy)
  > Python package for the calculation of ellipticity corrections for seismic waves.

### [shadow3aaa](https://github.com/shadow3aaa)
- 🌟 👤 [shadow3aaa](https://github.com/shadow3aaa) Starred [logic10492/openchat](https://github.com/logic10492/openchat)

### [shanshanerxi](https://github.com/shanshanerxi)
- 🌟 👤 [shanshanerxi](https://github.com/shanshanerxi) Starred [Y4tacker/codex-ai-ppt](https://github.com/Y4tacker/codex-ai-ppt)
  > Review-gated image-based PPT generation for Codex

### [shomykohai](https://github.com/shomykohai)
- 🚀 👤 [shomykohai](https://github.com/shomykohai) Made [shomykohai/lydian](https://github.com/shomykohai/lydian) public
  > MIRROR OF https://git.kaerulabs.com/shomy/lydian

### [singe](https://github.com/singe)
- 🍴 👤 [singe](https://github.com/singe) Forked [usestrix/strix](https://github.com/usestrix/strix) to [singe/strix](https://github.com/singe/strix)
  > Open-source AI hackers to find and fix your app’s vulnerabilities.

### [strivexjun](https://github.com/strivexjun)
- 🌟 👤 [strivexjun](https://github.com/strivexjun) Starred [0Chencc/clawgod](https://github.com/0Chencc/clawgod)
...
- 🌟 👤 [su-vikas](https://github.com/su-vikas) Starred [philc/vimium](https://github.com/philc/vimium)
  > The hacker's browser.
- 🌟 👤 [su-vikas](https://github.com/su-vikas) Starred [upscayl/upscayl](https://github.com/upscayl/upscayl)
  > 🆙 Upscayl - #1 Free and Open Source AI Image Upscaler for Linux, MacOS and Windows.

### [suifei](https://github.com/suifei)
- 🌟 👤 [suifei](https://github.com/suifei) Starred [thedotmack/claude-mem](https://github.com/thedotmack/claude-mem)
...
- 🌟 👤 [superturtlee](https://github.com/superturtlee) Starred [lfdevs/anland-termux](https://github.com/lfdevs/anland-termux)
  > Use Anland in Termux (especially PRoot and Chroot)

### [surunzi](https://github.com/surunzi)
- 🌟 👤 [surunzi](https://github.com/surunzi) Starred [scaleflex/filerobot-image-editor](https://github.com/scaleflex/filerobot-image-editor)
  > Edit, resize, and filter any image! Any questions or issues, please report to https://github.com/sca...

### [suzhelan](https://github.com/suzhelan)
- 🌟 👤 [suzhelan](https://github.com/suzhelan) Starred [IamRuaRua/HookSMS](https://github.com/IamRuaRua/HookSMS)
  > 在设备接收到短信时自动将其转发到外部消息服务(QQ NapCat、飞书机器人或自定义 HTTP 端点)的Xposed模块

### [topcoco](https://github.com/topcoco)
- 🌟 👤 [topcoco](https://github.com/topcoco) Starred [showlab/Code2Video](https://github.com/showlab/Code2Video)
  > [ICML 2026] Video generation via code

### [un4ckn0wl3z](https://github.com/un4ckn0wl3z)
- 🌟 👤 [un4ckn0wl3z](https://github.com/un4ckn0wl3z) Starred [kernelstub/NTForge](https://github.com/kernelstub/NTForge)
  > Toolkit for Windows internals, vulnerability analysis, and reproducible security research workflows.
- 🌟 👤 [un4ckn0wl3z](https://github.com/un4ckn0wl3z) Starred [coreboot/coreboot](https://github.com/coreboot/coreboot)
...
- 🌟 👤 [v9d0g](https://github.com/v9d0g) Starred [vulhub/java-chains](https://github.com/vulhub/java-chains)
  > Java Vulnerability Exploitation Platform

### [wa1ki0g](https://github.com/wa1ki0g)
- 🌟 👤 [wa1ki0g](https://github.com/wa1ki0g) Starred [liyown/ai-trend-publish](https://github.com/liyown/ai-trend-publish)
  > TrendPublish: 全自动 AI 内容生成与发布系统 | 微信公众号自动化 | 多源数据抓取 (Twitter/X、网站) | DeepseekAI、千问、讯飞模型 | 智能内容分析排序 | ...
- 🌟 👤 [wa1ki0g](https://github.com/wa1ki0g) Starred [NaiboWang/EasySpider](https://github.com/NaiboWang/EasySpider)
...
- 🌟 👤 [wyattearp](https://github.com/wyattearp) Starred [mx-shift/busradio](https://github.com/mx-shift/busradio)
  > AM radio over an IBM PC AT's bus emissions
...
- 🌟 👤 [xiandanin](https://github.com/xiandanin) Starred [CloakHQ/CloakBrowser](https://github.com/CloakHQ/CloakBrowser)
...
- 🌟 👤 [xiaoweigege](https://github.com/xiaoweigege) Starred [Helvesec/rmux](https://github.com/Helvesec/rmux)
...
- 🌟 👤 [y11en](https://github.com/y11en) Starred [P4nda0s/reverse-skills](https://github.com/P4nda0s/reverse-skills)
  > Reverse engineering skills for Claude Code | 逆向工程 Claude Code Skills 插件
- 🍴 👤 [y11en](https://github.com/y11en) Forked [P4nda0s/reverse-skills](https://github.com/P4nda0s/reverse-skills) to [y11en/reverse-skills](https://github.com/y11en/reverse-skills)
  > Reverse engineering skills for Claude Code | 逆向工程 Claude Code Skills 插件
- 🌟 👤 [y11en](https://github.com/y11en) Starred [r3xmax/PhantomCtx](https://github.com/r3xmax/PhantomCtx)
  > Activation Context Hijacking Evasion Tool
- 🍴 👤 [y11en](https://github.com/y11en) Forked [r3xmax/PhantomCtx](https://github.com/r3xmax/PhantomCtx) to [y11en/PhantomCtx](https://github.com/y11en/PhantomCtx)
  > Activation Context Hijacking Evasion Tool

### [yhy0](https://github.com/yhy0)
- 🌟 👤 [yhy0](https://github.com/yhy0) Starred [calesthio/OpenMontage](https://github.com/calesthio/OpenMontage)
  > World's first open-source, agentic video production system. 12 pipelines, 52 tools, 500+ agent skill...

### [yux1azhengye](https://github.com/yux1azhengye)
- 🍴 👤 [yux1azhengye](https://github.com/yux1azhengye) Forked [watchtowrlabs/watchTowr-vs-Check-Point-CVE-2026-50751](https://github.com/watchtowrlabs/watchTowr-vs-Check-Point-CVE-2026-50751) to [yux1azhengye/watchTowr-vs-Check-Point-CVE-2026-50751](https://github.com/yux1azhengye/watchTowr-vs-Check-Point-CVE-2026-50751)
...
- 🌟 👤 [zjw-swun](https://github.com/zjw-swun) Starred [HyperDbg/HyperDbg](https://github.com/HyperDbg/HyperDbg)
  > State-of-the-art native debugging tools

### [zyl5721451](https://github.com/zyl5721451)
- 🌟 👤 [zyl5721451](https://github.com/zyl5721451) Starred [alibaba/open-code-review](https://github.com/alibaba/open-code-review)
  > Open-source & free — Battle-tested at Alibaba's scale. Hybrid architecture code review tool: determi...
- 🌟 👤 [zyl5721451](https://github.com/zyl5721451) Starred [nexu-io/open-design](https://github.com/nexu-io/open-design)
