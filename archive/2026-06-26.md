...
- 🌟 👤 [0x1306a94](https://github.com/0x1306a94) Starred [paradiseduo/dsdump](https://github.com/paradiseduo/dsdump)
  > An improved nm + Objective-C & Swift class-dump
- 🍴 👤 [0x1306a94](https://github.com/0x1306a94) Forked [paradiseduo/dsdump](https://github.com/paradiseduo/dsdump) to [0x1306a94/dsdump_py](https://github.com/0x1306a94/dsdump_py)
  > An improved nm + Objective-C & Swift class-dump
- 🌟 👤 [0x1306a94](https://github.com/0x1306a94) Starred [jacobsapps/MetalScroll](https://github.com/jacobsapps/MetalScroll)
  > Metal scrolling @ 120fps
- 🍴 👤 [0x1306a94](https://github.com/0x1306a94) Forked [jacobsapps/MetalScroll](https://github.com/jacobsapps/MetalScroll) to [0x1306a94/MetalScroll](https://github.com/0x1306a94/MetalScroll)
  > Metal scrolling @ 120fps

### [0xbug](https://github.com/0xbug)
- 🌟 👤 [0xbug](https://github.com/0xbug) Starred [Catherines77/code-au](https://github.com/Catherines77/code-au)

### [0xdad0](https://github.com/0xdad0)
- 🌟 👤 [0xdad0](https://github.com/0xdad0) Starred [frida/luma](https://github.com/frida/luma)

### [1193776794](https://github.com/1193776794)
- 🌟 👤 [1193776794](https://github.com/1193776794) Starred [0xsdeo/Bypass_Debugger](https://github.com/0xsdeo/Bypass_Debugger)
  > Bypass无限debugger

### [1c7](https://github.com/1c7)
- 🌟 👤 [1c7](https://github.com/1c7) Starred [jackwener/OpenCLI](https://github.com/jackwener/OpenCLI)
  > Make Any Website into CLI & Use your logged-in browser by AI agent. 
- 🌟 👤 [1c7](https://github.com/1c7) Starred [Panniantong/Agent-Reach](https://github.com/Panniantong/Agent-Reach)
  > Give your AI agent eyes to see the entire internet. Read & search Twitter, Reddit, YouTube, GitHub, ...

### [1orz](https://github.com/1orz)
- 🌟 👤 [1orz](https://github.com/1orz) Starred [michael-laoyu/MapTileGenerator](https://github.com/michael-laoyu/MapTileGenerator)
  > 支持TMS、WMTS标准瓦片下载，支持百度地图瓦片、高德地图瓦片、腾讯地图瓦片、天地图、ArcGIS Rest、geoserver等瓦片下载。默认以png文件方式保存瓦片，也支持以sqlite（mbt...

### [2977094657](https://github.com/2977094657)
- 🌟 👤 [2977094657](https://github.com/2977094657) Starred [hicccc77/WeLive-release](https://github.com/hicccc77/WeLive-release)
  > WeLive的发布仓库
...
- 🌟 👤 [34306](https://github.com/34306) Starred [J-jaeyoung/bad-epoll](https://github.com/J-jaeyoung/bad-epoll)
...
- 🌟 👤 [AndnixSH](https://github.com/AndnixSH) Starred [chigwell/telegram-mcp](https://github.com/chigwell/telegram-mcp)
...
- 🍴 👤 [ColdWindScholar](https://github.com/ColdWindScholar) Forked [remote-android/redroid-doc](https://github.com/remote-android/redroid-doc) to [ColdWindScholar/redroid-doc](https://github.com/ColdWindScholar/redroid-doc)
...
- 🌟 👤 [DarkLineX](https://github.com/DarkLineX) Starred [zhaoxuya520/reverse-skill](https://github.com/zhaoxuya520/reverse-skill)
  > Reverse Engineering / Authorized Penetration Testing / Security Research Skill Router Pack AI-powere...
- 🌟 👤 [DarkLineX](https://github.com/DarkLineX) Starred [opencyvis/opencyvis-phone](https://github.com/opencyvis/opencyvis-phone)
...
- 🌟 👤 [EZForever](https://github.com/EZForever) Starred [libyal/libyal](https://github.com/libyal/libyal)
  > Yet another library library (and tools)

### [Exo1i](https://github.com/Exo1i)
- 🌟 👤 [Exo1i](https://github.com/Exo1i) Starred [Shocked-Cat/oppo-mtk-fastboot-unlock](https://github.com/Shocked-Cat/oppo-mtk-fastboot-unlock)
...
- 🌟 👤 [FldBudin](https://github.com/FldBudin) Starred [hugohe3/ppt-master](https://github.com/hugohe3/ppt-master)
...
- 🌟 👤 [GangJust](https://github.com/GangJust) Starred [Calvin-LL/Reorderable](https://github.com/Calvin-LL/Reorderable)
...
- 🌟 👤 [LanBaiCode](https://github.com/LanBaiCode) Starred [jygzyc/decx](https://github.com/jygzyc/decx)
  > DECX - Decompiler + X
- 🍴 👤 [LanBaiCode](https://github.com/LanBaiCode) Forked [jygzyc/decx](https://github.com/jygzyc/decx) to [LanBaiCode/decx](https://github.com/LanBaiCode/decx)
  > DECX - Decompiler + X

### [Linuxoid-cn](https://github.com/Linuxoid-cn)
- 🌟 👤 [Linuxoid-cn](https://github.com/Linuxoid-cn) Starred [MlgmXyysd/Xiaomi-HyperOS-BootLoader-Bypass](https://github.com/MlgmXyysd/Xiaomi-HyperOS-BootLoader-Bypass)
...
- 🌟 👤 [Lotus6](https://github.com/Lotus6) Starred [LLeavesG/eBPFDexDumper](https://github.com/LLeavesG/eBPFDexDumper)
  > eBPF-Based DexDumper for Android

### [LunFengChen](https://github.com/LunFengChen)
- 🌟 👤 [LunFengChen](https://github.com/LunFengChen) Starred [LoseNine/Firefox-FingerPrint-Analyzer](https://github.com/LoseNine/Firefox-FingerPrint-Analyzer)
  > 一个面向网站指纹风控研究与辅助 JS 逆向学术分析的桌面工具，一键分析web页面指纹风控，可直接将全量日志交给AI进行JS补环境，专用于网站指纹搜集研究和辅助JS补环境。
- 🌟 👤 [LunFengChen](https://github.com/LunFengChen) Starred [bibinocode/rust-frida-shadow-hook](https://github.com/bibinocode/rust-frida-shadow-hook)
  > 无痕HOOK，for来源rustFrida,修复部分问题
- 🍴 👤 [LunFengChen](https://github.com/LunFengChen) Forked [bibinocode/rust-frida-shadow-hook](https://github.com/bibinocode/rust-frida-shadow-hook) to [LunFengChen/rustfrida-ab](https://github.com/LunFengChen/rustfrida-ab)
  > 无痕HOOK，for来源rustFrida,修复部分问题
...
- 🌟 👤 [MartinKayJr](https://github.com/MartinKayJr) Starred [Xposed-Modules-Repo/mba.vm.onhit](https://github.com/Xposed-Modules-Repo/mba.vm.onhit)
  > onHit: NFC NDEF Replay Module
- 🌟 👤 [MartinKayJr](https://github.com/MartinKayJr) Starred [0penPublic/onHit](https://github.com/0penPublic/onHit)
  > Trigger Android NFC events without a physical tag by Xposed.
- 🌟 👤 [MartinKayJr](https://github.com/MartinKayJr) Starred [Xposed-Modules-Repo/com.evo.piccatcher](https://github.com/Xposed-Modules-Repo/com.evo.piccatcher)
  > Evo-PicCatcher(Evo-图片捕手)
- 🌟 👤 [MartinKayJr](https://github.com/MartinKayJr) Starred [Xposed-Modules-Repo/io.mo.glassmic](https://github.com/Xposed-Modules-Repo/io.mo.glassmic)
...
- 🌟 👤 [Moe-hacker](https://github.com/Moe-hacker) Starred [aqnya/anetd](https://github.com/aqnya/anetd)
  > DNS proxy daemon for Android with adblock-style domain filtering, intercepting dnsproxyd Unix socket...
...
- 🌟 👤 [MorvanZhou](https://github.com/MorvanZhou) Starred [helloianneo/ian-xiaohei-illustrations](https://github.com/helloianneo/ian-xiaohei-illustrations)
  > 中文小黑怪诞正文配图生成 Skill | 16:9 白底手绘 | 少量红橙蓝批注 | Codex Skill

### [N3rdL0rd](https://github.com/N3rdL0rd)
- 🌟 👤 [N3rdL0rd](https://github.com/N3rdL0rd) Starred [OpenSpace/OpenSpace](https://github.com/OpenSpace/OpenSpace)
...
- 🌟 👤 [NiTianErXing666](https://github.com/NiTianErXing666) Starred [yadavnikhil03/Play-integrity-fix-guide](https://github.com/yadavnikhil03/Play-integrity-fix-guide)
  > Easiest Way to Fix Strong Integrity on Custom ROMs & Rooted Devices

### [No-Github](https://github.com/No-Github)
- 🌟 👤 [No-Github](https://github.com/No-Github) Starred [FishCodeTech/muteki](https://github.com/FishCodeTech/muteki)
...
- 🍴 👤 [P4x1s](https://github.com/P4x1s) Forked [Wei-Shaw/sub2api](https://github.com/Wei-Shaw/sub2api) to [P4x1s/sub2api](https://github.com/P4x1s/sub2api)
...
- 🌟 👤 [Resery](https://github.com/Resery) Starred [Vikramaditya015/samsung-android-lpe](https://github.com/Vikramaditya015/samsung-android-lpe)
  > Poc for CVE-2026-20980, CVE-2026-20981, CVE-2026-20982

### [SakuraKoi](https://github.com/SakuraKoi)
- 🌟 👤 [SakuraKoi](https://github.com/SakuraKoi) Starred [Pixel-Tailor-CN/PixelTelo](https://github.com/Pixel-Tailor-CN/PixelTelo)
  > 专为 Pixel 打造的来电识别与拦截应用，本地优先处理，隐私零泄露

### [Samael-Z](https://github.com/Samael-Z)
- 🌟 👤 [Samael-Z](https://github.com/Samael-Z) Starred [b-nnett/codex-plusplus-ios-simulator](https://github.com/b-nnett/codex-plusplus-ios-simulator)
...
- 🌟 👤 [SimonTheCoder](https://github.com/SimonTheCoder) Starred [kaloscope/kaloscope](https://github.com/kaloscope/kaloscope)
...
- 🌟 👤 [SoyBeanMilkx](https://github.com/SoyBeanMilkx) Starred [sensorsdata/sa-sdk-ios](https://github.com/sensorsdata/sa-sdk-ios)
  > 神策数据官方 iOS 埋点 SDK，是一款轻量级用于 iOS 端的数据采集埋点 SDK。神策分析 iOS SDK 不仅有代码埋点功能，还通过使用运行时机制（Runtime）中的相关技术实现 iOS 端...
- 🌟 👤 [SoyBeanMilkx](https://github.com/SoyBeanMilkx) Starred [lm060719/io.mo.glassmic](https://github.com/lm060719/io.mo.glassmic)
  > 开源 LSPosed 虚拟麦克风与 Android 音频链路测试模块，面向 Root 设备。

### [Super12138](https://github.com/Super12138)
- 🌟 👤 [Super12138](https://github.com/Super12138) Starred [Demizo/Daily_You](https://github.com/Demizo/Daily_You)
  > Every day is worth remembering...

### [TheQmaks](https://github.com/TheQmaks)
- 🌟 👤 [TheQmaks](https://github.com/TheQmaks) Starred [vichhka-git/renef-skills](https://github.com/vichhka-git/renef-skills)
  > Agent Skill (Claude Code + OpenCode) for operating renef.io — Android ARM64 dynamic instrumentation:...

### [U039b](https://github.com/U039b)
- 🌟 👤 [U039b](https://github.com/U039b) Starred [apple/container](https://github.com/apple/container)
...
- 🌟 👤 [VonChange](https://github.com/VonChange) Starred [zai-org/Open-AutoGLM](https://github.com/zai-org/Open-AutoGLM)
  > An Open Phone Agent Model & Framework. Unlocking the AI Phone for Everyone

### [WindySha](https://github.com/WindySha)
- 🌟 👤 [WindySha](https://github.com/WindySha) Starred [zhaoxuya520/reverse-skill](https://github.com/zhaoxuya520/reverse-skill)
  > Reverse Engineering / Authorized Penetration Testing / Security Research Skill Router Pack AI-powere...

### [X1r0z](https://github.com/X1r0z)
- 🌟 👤 [X1r0z](https://github.com/X1r0z) Starred [FishCodeTech/muteki](https://github.com/FishCodeTech/muteki)
  > Project Muteki (無敵): autonomous multi-model CTF-solving AI agent swarm
...
- 🌟 👤 [ashishb](https://github.com/ashishb) Starred [raketenkater/ggrun](https://github.com/raketenkater/ggrun)
  > Auto-tuned launcher for GGUF models on llama.cpp / ik_llama.cpp — OpenAI-compatible server with mult...
...
- 🌟 👤 [chenjiandongx](https://github.com/chenjiandongx) Starred [Tracer-Cloud/opensre](https://github.com/Tracer-Cloud/opensre)
...
- 🌟 👤 [ctkqiang](https://github.com/ctkqiang) Starred [liuyu771/document-ai-assistant](https://github.com/liuyu771/document-ai-assistant)
  > AI 公文智能优化助手 — 基于 GB/T 9704 的公文格式智能检测与优化
- 🌟 👤 [ctkqiang](https://github.com/ctkqiang) Starred [etcd-io/etcd](https://github.com/etcd-io/etcd)
...
- 🍴 👤 [dumblob](https://github.com/dumblob) Forked [mratsim/tattletale](https://github.com/mratsim/tattletale) to [dumblob/tattletale](https://github.com/dumblob/tattletale)
  > Stealth LLM inference engine

### [eerimoq](https://github.com/eerimoq)
- 🌟 👤 [eerimoq](https://github.com/eerimoq) Starred [datarhei/gosrt](https://github.com/datarhei/gosrt)
  > Implementation of the SRT protocol in pure Go

### [eggfly](https://github.com/eggfly)
- 🌟 👤 [eggfly](https://github.com/eggfly) Starred [flipperdevices/flipctl](https://github.com/flipperdevices/flipctl)
  > FlipCTL

### [einverne](https://github.com/einverne)
- 🌟 👤 [einverne](https://github.com/einverne) Starred [nashsu/llm_wiki](https://github.com/nashsu/llm_wiki)
...
- 🌟 👤 [elllusion](https://github.com/elllusion) Starred [BLANK2077/xverif](https://github.com/BLANK2077/xverif)
...
- 🌟 👤 [fynch3r](https://github.com/fynch3r) Starred [xbtlin/ai-berkshire](https://github.com/xbtlin/ai-berkshire)
  > AI 时代的伯克希尔：基于 Claude Code 的价值投资研究框架。巴菲特·芒格·段永平·李录四大师方法论 + 多Agent并行研究。| AI-era Berkshire: a value inv...
- 🌟 👤 [fynch3r](https://github.com/fynch3r) Starred [wondertrader/wondertrader](https://github.com/wondertrader/wondertrader)
  > WonderTrader——量化研发交易一站式框架

### [fyrlove](https://github.com/fyrlove)
- 🍴 👤 [fyrlove](https://github.com/fyrlove) Forked [openai/codex](https://github.com/openai/codex) to [fyrlove/codex](https://github.com/fyrlove/codex)
  > Lightweight coding agent that runs in your terminal

### [g0th1c54e4](https://github.com/g0th1c54e4)
- 🌟 👤 [g0th1c54e4](https://github.com/g0th1c54e4) Starred [ZacharyZcR/vmware-mcp](https://github.com/ZacharyZcR/vmware-mcp)
  > MCP server for controlling VMware Workstation Pro virtual machines

### [gamelaster](https://github.com/gamelaster)
- 🌟 👤 [gamelaster](https://github.com/gamelaster) Starred [Arenukvern/mcp_flutter](https://github.com/Arenukvern/mcp_flutter)
  > MCP Toolkit for Flutter AI Agent Driven Development (MCP/CLI + custom client side tools) - via close...

### [geekonion](https://github.com/geekonion)
- 🌟 👤 [geekonion](https://github.com/geekonion) Starred [x86byte/Obfusk8](https://github.com/x86byte/Obfusk8)
  > Obfusk8: lightweight Obfuscation library based on C++17 / Header Only for windows binaries
- 🍴 👤 [geekonion](https://github.com/geekonion) Forked [x86byte/Obfusk8](https://github.com/x86byte/Obfusk8) to [geekonion/Obfusk8](https://github.com/geekonion/Obfusk8)
  > Obfusk8: lightweight Obfuscation library based on C++17 / Header Only for windows binaries

### [gh0stkey](https://github.com/gh0stkey)
- 🌟 👤 [gh0stkey](https://github.com/gh0stkey) Starred [docker/docker-agent](https://github.com/docker/docker-agent)
  > AI Agent Builder and Runtime by Docker Engineering

### [gmh5225](https://github.com/gmh5225)
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [binsnake/fARM64](https://github.com/binsnake/fARM64) to [gmh5225/fARM64](https://github.com/gmh5225/fARM64)
  > ARM64 decoder and encoder
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [REDPOWAR/D2GI](https://github.com/REDPOWAR/D2GI) to [gmh5225/D2GI](https://github.com/gmh5225/D2GI)
  > Graphic improvements for Hard Truck 2 game (Дальнобойщики 2, King of the Road, Kelyje 2)
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [aleko2144/KoTR_Modern_Patch](https://github.com/aleko2144/KoTR_Modern_Patch) to [gmh5225/KoTR_Modern_Patch](https://github.com/gmh5225/KoTR_Modern_Patch)
  > King of the Road (Дальнобойщики 2) Modern Patch sources

### [goatmilkkk](https://github.com/goatmilkkk)
- 🌟 👤 [goatmilkkk](https://github.com/goatmilkkk) Starred [teabound/rophi](https://github.com/teabound/rophi)
  > Injecting code by recompiling shellcode into a ROP chain.
- 🌟 👤 [goatmilkkk](https://github.com/goatmilkkk) Starred [dominicklee/Arduino-PN532-NTAG213](https://github.com/dominicklee/Arduino-PN532-NTAG213)
  > Custom written Arduino examples to read, write, and format NTAG213 tags using PN532
...
- 🌟 👤 [hanbings](https://github.com/hanbings) Starred [rcore-os/tgoskits](https://github.com/rcore-os/tgoskits)
...
- 🌟 👤 [hanc00l](https://github.com/hanc00l) Starred [Q16G/aster](https://github.com/Q16G/aster)
  > 基于 ReAct 框架的安全分析 Agent，在终端中完成代码审计、渗透测试、主机防护

### [hhhaiai](https://github.com/hhhaiai)
- 🌟 👤 [hhhaiai](https://github.com/hhhaiai) Starred [NanmiCoder/MediaCrawler](https://github.com/NanmiCoder/MediaCrawler)
  > 小红书笔记 | 评论爬虫、抖音视频 | 评论爬虫、快手视频 | 评论爬虫、B 站视频 ｜ 评论爬虫、微博帖子 ｜ 评论爬虫、百度贴吧帖子 ｜ 百度贴吧评论回复爬虫  | 知乎问答文章｜评论爬虫
- 🍴 👤 [hhhaiai](https://github.com/hhhaiai) Forked [NanmiCoder/MediaCrawler](https://github.com/NanmiCoder/MediaCrawler) to [parserpp/MediaCrawler](https://github.com/parserpp/MediaCrawler)
  > 小红书笔记 | 评论爬虫、抖音视频 | 评论爬虫、快手视频 | 评论爬虫、B 站视频 ｜ 评论爬虫、微博帖子 ｜ 评论爬虫、百度贴吧帖子 ｜ 百度贴吧评论回复爬虫  | 知乎问答文章｜评论爬虫

### [hoffstadt](https://github.com/hoffstadt)
- 🌟 👤 [hoffstadt](https://github.com/hoffstadt) Starred [ebruneton/precomputed_atmospheric_scattering](https://github.com/ebruneton/precomputed_atmospheric_scattering)
  > This project provides a new implementation of our EGSR 2008 paper "Precomputed Atmospheric Scatterin...
...
- 🌟 👤 [huoji120](https://github.com/huoji120) Starred [Krixx1337/burner-net](https://github.com/Krixx1337/burner-net)
  > Zero-trust anti-forensic networking engine. Wipes secrets. Severs traces. CPR in a Stealth Tank. 👻

### [hyuunnn](https://github.com/hyuunnn)
- 🌟 👤 [hyuunnn](https://github.com/hyuunnn) Starred [Agents365-ai/drawio-skill](https://github.com/Agents365-ai/drawio-skill)
...
- 🌟 👤 [israel-dryer](https://github.com/israel-dryer) Starred [israel-dryer/bootstack](https://github.com/israel-dryer/bootstack)
  > End-to-end Python desktop framework. Declarative layout, reactive signals, semantic styling, 60+ wid...
...
- 🍴 👤 [j3ssie](https://github.com/j3ssie) Forked [infoslack/awesome-web-hacking](https://github.com/infoslack/awesome-web-hacking) to [j3ssie/awesome-web-hacking](https://github.com/j3ssie/awesome-web-hacking)
  > A list of web application security
- 🍴 👤 [j3ssie](https://github.com/j3ssie) Forked [enaqx/awesome-pentest](https://github.com/enaqx/awesome-pentest) to [j3ssie/awesome-pentest](https://github.com/j3ssie/awesome-pentest)
  > A collection of awesome penetration testing resources, tools and other shiny things
- 🍴 👤 [j3ssie](https://github.com/j3ssie) Forked [OWASP/www-community](https://github.com/OWASP/www-community) to [j3ssie/www-community](https://github.com/j3ssie/www-community)
  > OWASP Community Pages are a place where OWASP can accept community contributions for security-relate...
- 🍴 👤 [j3ssie](https://github.com/j3ssie) Forked [arch3rPro/PentestTools](https://github.com/arch3rPro/PentestTools) to [j3ssie/PentestTools](https://github.com/j3ssie/PentestTools)
  > Awesome Pentest Tools Collection

### [j4nn](https://github.com/j4nn)
- 🌟 👤 [j4nn](https://github.com/j4nn) Starred [Daniel224455/katana](https://github.com/Daniel224455/katana)
  > Let's hijack our bootchain - CVE-2021-30327
- 🌟 👤 [j4nn](https://github.com/j4nn) Starred [Daniel224455/sdm845-payloads](https://github.com/Daniel224455/sdm845-payloads)

### [jas502n](https://github.com/jas502n)
- 🌟 👤 [jas502n](https://github.com/jas502n) Starred [oritera/Cairn](https://github.com/oritera/Cairn)
...
- 🌟 👤 [jianglin-code](https://github.com/jianglin-code) Starred [apache/hadoop-mapreduce](https://github.com/apache/hadoop-mapreduce)
  > Mirror of Apache Hadoop MapReduce
- 🌟 👤 [jianglin-code](https://github.com/jianglin-code) Starred [baidu/Unlimited-OCR](https://github.com/baidu/Unlimited-OCR)
...
- 🌟 👤 [jweny](https://github.com/jweny) Starred [agent-infra/sandbox](https://github.com/agent-infra/sandbox)
...
- 🌟 👤 [kasnria001](https://github.com/kasnria001) Starred [symgraph/IDAssist](https://github.com/symgraph/IDAssist)
  > AI-Powered Reverse Engineering Plugin for IDA Pro
- 🌟 👤 [kasnria001](https://github.com/kasnria001) Starred [EliseZeroTwo/tx2hax](https://github.com/EliseZeroTwo/tx2hax)
  > This is a mirror of https://codeberg.org/katze/tx2hax
- 🌟 👤 [kasnria001](https://github.com/kasnria001) Starred [arzam16/empty-sixty-five](https://github.com/arzam16/empty-sixty-five)
  > My notes on old Mediatek devices (mt65xx, and kernel 3.4.x). Some info might be useful for developin...
...
- 🌟 👤 [kingking888](https://github.com/kingking888) Starred [YPYT1/Douyin_TikTok_Download_API](https://github.com/YPYT1/Douyin_TikTok_Download_API)
  > 🚀「Douyin_TikTok_Download_API」是一个开箱即用的高性能异步抖音、快手、TikTok、Bilibili数据爬取工具，支持API调用，在线批量解析及下载。
- 🌟 👤 [kingking888](https://github.com/kingking888) Starred [1kuzus/iiiLabCrawler](https://github.com/1kuzus/iiiLabCrawler)
  > Download resources from TikTok/Douyin, YouTube, Bilibili, Facebook, Instagram, and X/Twitter - A web...
- 🌟 👤 [kingking888](https://github.com/kingking888) Starred [wangrongding/ins-spider](https://github.com/wangrongding/ins-spider)
  > 基于 puppeteer 实现的简单 instagram 爬虫 (WIP)
- 🌟 👤 [kingking888](https://github.com/kingking888) Starred [moondrink/SoFixer](https://github.com/moondrink/SoFixer)
  > 基于SoFixer修改
...
- 🌟 👤 [konieshadow](https://github.com/konieshadow) Starred [RockyChing/the_expanse](https://github.com/RockyChing/the_expanse)

### [le31ei](https://github.com/le31ei)
- 🌟 👤 [le31ei](https://github.com/le31ei) Starred [HanZeYu-momo/woyun](https://github.com/HanZeYu-momo/woyun)
  > v0.1

### [linxid](https://github.com/linxid)
- 🌟 👤 [linxid](https://github.com/linxid) Starred [rebel0789/codexpro](https://github.com/rebel0789/codexpro)
...
- 🌟 👤 [liuzjMr](https://github.com/liuzjMr) Starred [wpzzz/blocked-sites-in-south-korea](https://github.com/wpzzz/blocked-sites-in-south-korea)
- 🌟 👤 [liuzjMr](https://github.com/liuzjMr) Starred [Forget-C/Jellyfish](https://github.com/Forget-C/Jellyfish)
  > An end-to-end production workspace for AI-generated short dramas. From script input to structured st...
- 🌟 👤 [liuzjMr](https://github.com/liuzjMr) Starred [ruvnet/RuView](https://github.com/ruvnet/RuView)
  > π RuView turns commodity WiFi signals into real-time spatial intelligence, vital sign monitoring, an...
- 🌟 👤 [liuzjMr](https://github.com/liuzjMr) Starred [VisoMasterFusion/VisoMaster-Fusion](https://github.com/VisoMasterFusion/VisoMaster-Fusion)
...
- 🌟 👤 [lux-QAQ](https://github.com/lux-QAQ) Starred [Seele-Official/tiny-web-framework](https://github.com/Seele-Official/tiny-web-framework)
  > A simple web framework implemented in C++23 for study.
- 🌟 👤 [lux-QAQ](https://github.com/lux-QAQ) Starred [Seele-Official/systemd](https://github.com/Seele-Official/systemd)

### [lyming99](https://github.com/lyming99)
- 🌟 👤 [lyming99](https://github.com/lyming99) Starred [simonyos/Z-CODE](https://github.com/simonyos/Z-CODE)
  > A beautiful terminal-based AI coding assistant with multi-provider support (Claude, Gemini, OpenAI).

### [lyy289065406](https://github.com/lyy289065406)
- 🌟 👤 [lyy289065406](https://github.com/lyy289065406) Starred [rust-lang/mdBook](https://github.com/rust-lang/mdBook)
...
- 🌟 👤 [marsinator358](https://github.com/marsinator358) Starred [tom-james-watson/old-reddit-redirect](https://github.com/tom-james-watson/old-reddit-redirect)
  > Ensure Reddit always loads the old design

### [mo-xiaoxi](https://github.com/mo-xiaoxi)
- 🌟 👤 [mo-xiaoxi](https://github.com/mo-xiaoxi) Starred [FishCodeTech/muteki](https://github.com/FishCodeTech/muteki)
  > Project Muteki (無敵): autonomous multi-model CTF-solving AI agent swarm
...
- 🌟 👤 [netxfly](https://github.com/netxfly) Starred [smallnest/seq](https://github.com/smallnest/seq)
  > A generic library in Golang with generic method feature
- 🌟 👤 [netxfly](https://github.com/netxfly) Starred [EpicGames/lore](https://github.com/EpicGames/lore)
  > Lore is a next-generation, open source version control system

### [null-dev](https://github.com/null-dev)
- 🌟 👤 [null-dev](https://github.com/null-dev) Starred [provrb/obdium](https://github.com/provrb/obdium)
  > OBDium. The free, open-source on-board diagnostics software. Where silence falls, truth rises.
- 🌟 👤 [null-dev](https://github.com/null-dev) Starred [barracuda-fsh/pyobd](https://github.com/barracuda-fsh/pyobd)
  > OBD-II compliant automotive diagnostic software
- 🌟 👤 [null-dev](https://github.com/null-dev) Starred [fr3ts0n/AndrOBD](https://github.com/fr3ts0n/AndrOBD)
  > Android OBD diagnostics with any ELM327 adapter

### [ommadawn46](https://github.com/ommadawn46)
- 🌟 👤 [ommadawn46](https://github.com/ommadawn46) Starred [apache/caldera](https://github.com/apache/caldera)
  > Automated Adversary Emulation Platform

### [quangnh89](https://github.com/quangnh89)
- 🌟 👤 [quangnh89](https://github.com/quangnh89) Starred [zhaoxuya520/reverse-skill](https://github.com/zhaoxuya520/reverse-skill)
  > Reverse Engineering / Authorized Penetration Testing / Security Research Skill Router Pack AI-powere...
- 🌟 👤 [quangnh89](https://github.com/quangnh89) Starred [Diolinux/PhotoGIMP](https://github.com/Diolinux/PhotoGIMP)
  > A Patch for GIMP 3+ for Photoshop Users

### [r0eXpeR](https://github.com/r0eXpeR)
- 🌟 👤 [r0eXpeR](https://github.com/r0eXpeR) Starred [jar-analyzer/jar-analyzer](https://github.com/jar-analyzer/jar-analyzer)
  > Jar Analyzer - 一个 JAR 包 GUI 分析工具，内置 AI 助手协助分析，支持 JAR DIFF 分析，方法调用关系搜索，方法调用链 DFS 算法分析，模拟 JVM 的污点分析验证 ...

### [rankalpha](https://github.com/rankalpha)
- 🌟 👤 [rankalpha](https://github.com/rankalpha) Starred [NanmiCoder/MediaCrawler](https://github.com/NanmiCoder/MediaCrawler)
  > 小红书笔记 | 评论爬虫、抖音视频 | 评论爬虫、快手视频 | 评论爬虫、B 站视频 ｜ 评论爬虫、微博帖子 ｜ 评论爬虫、百度贴吧帖子 ｜ 百度贴吧评论回复爬虫  | 知乎问答文章｜评论爬虫
- 🌟 👤 [rankalpha](https://github.com/rankalpha) Starred [xbtlin/ai-berkshire](https://github.com/xbtlin/ai-berkshire)
  > AI 时代的伯克希尔：基于 Claude Code 的价值投资研究框架。巴菲特·芒格·段永平·李录四大师方法论 + 多Agent并行研究。| AI-era Berkshire: a value inv...
- 🌟 👤 [rankalpha](https://github.com/rankalpha) Starred [jygzyc/decx](https://github.com/jygzyc/decx)
  > DECX - Decompiler + X
...
- 🌟 👤 [roadwy](https://github.com/roadwy) Starred [xnTopAz/ICSFieldID](https://github.com/xnTopAz/ICSFieldID)
- 🌟 👤 [roadwy](https://github.com/roadwy) Starred [mukul975/cve-mcp-server](https://github.com/mukul975/cve-mcp-server)
...
- 🌟 👤 [rogxo](https://github.com/rogxo) Starred [FaEryICE/MemScanner](https://github.com/FaEryICE/MemScanner)
  > Analyze Windows x64 Kernel Memory Layout
- 🌟 👤 [rogxo](https://github.com/rogxo) Starred [ekknod/pcileech-wifi](https://github.com/ekknod/pcileech-wifi)
  > pcileech-fpga with wireless card emulation
- 🌟 👤 [rogxo](https://github.com/rogxo) Starred [ufrisk/pcileech-fpga](https://github.com/ufrisk/pcileech-fpga)
  > FPGA modules used together with the PCILeech Direct Memory Access (DMA) Attack Software
- 🌟 👤 [rogxo](https://github.com/rogxo) Starred [binsnake/icey-x86](https://github.com/binsnake/icey-x86)
  > A specialized version of iced-x86 for binary lifting

### [sakana164](https://github.com/sakana164)
- 🌟 👤 [sakana164](https://github.com/sakana164) Starred [iebb/mithka](https://github.com/iebb/mithka)

### [sandyz987](https://github.com/sandyz987)
- 🌟 👤 [sandyz987](https://github.com/sandyz987) Starred [sugyan/claude-code-webui](https://github.com/sugyan/claude-code-webui)
...
- 🌟 👤 [serein-213](https://github.com/serein-213) Starred [NanmiCoder/MediaCrawler](https://github.com/NanmiCoder/MediaCrawler)
  > 小红书笔记 | 评论爬虫、抖音视频 | 评论爬虫、快手视频 | 评论爬虫、B 站视频 ｜ 评论爬虫、微博帖子 ｜ 评论爬虫、百度贴吧帖子 ｜ 百度贴吧评论回复爬虫  | 知乎问答文章｜评论爬虫

### [sh1ma](https://github.com/sh1ma)
- 🌟 👤 [sh1ma](https://github.com/sh1ma) Starred [open-telemetry/opentelemetry-go](https://github.com/open-telemetry/opentelemetry-go)
  > OpenTelemetry Go API and SDK

### [shellsec](https://github.com/shellsec)
- 🍴 👤 [shellsec](https://github.com/shellsec) Forked [bugsyhewitt/possession](https://github.com/bugsyhewitt/possession) to [shellsec/possession](https://github.com/shellsec/possession)
  > Possession takes a valid authenticated request and wears its skin under other identities, roles, str...

### [shmilylty](https://github.com/shmilylty)
- 🌟 👤 [shmilylty](https://github.com/shmilylty) Starred [P4nda0s/reverse-skills](https://github.com/P4nda0s/reverse-skills)
  > Reverse engineering skills for Claude Code | 逆向工程 Claude Code Skills 插件

### [smartdone](https://github.com/smartdone)
- 🌟 👤 [smartdone](https://github.com/smartdone) Starred [exvulsec/sui-move-skill](https://github.com/exvulsec/sui-move-skill)
...
- 🌟 👤 [summitt](https://github.com/summitt) Starred [OpenTransmute/OpenTransmute](https://github.com/OpenTransmute/OpenTransmute)
  > OpenTransmute is a system for decomposing software into conceptual ingredients and recomposing them ...

### [superturtlee](https://github.com/superturtlee)
- 🌟 👤 [superturtlee](https://github.com/superturtlee) Starred [torvalds/linux](https://github.com/torvalds/linux)
  > Linux kernel source tree

### [surendrajat](https://github.com/surendrajat)
- 🌟 👤 [surendrajat](https://github.com/surendrajat) Starred [jdexorg/jdex](https://github.com/jdexorg/jdex)
  > Apk disassembler and decompiler

### [taisuii](https://github.com/taisuii)
- 🌟 👤 [taisuii](https://github.com/taisuii) Starred [bytedance/btrace](https://github.com/bytedance/btrace)
  > 🔥🔥 btrace (AKA RheaTrace) is a high-performance Android & iOS tracing tool built on Perfetto. It not...
- 🌟 👤 [taisuii](https://github.com/taisuii) Starred [bytedance/bhook](https://github.com/bytedance/bhook)
...
- 🌟 👤 [un4ckn0wl3z](https://github.com/un4ckn0wl3z) Starred [SmileZXLee/ZXHookDetection](https://github.com/SmileZXLee/ZXHookDetection)
  > 【iOS应用安全、安全攻防】hook及越狱的基本防护与检测(动态库注入检测、hook检测与防护、越狱检测、签名校验、汇编分析、IDA反编译分析加密协议Demo)；【数据传输安全】浅谈http、http...
- 🌟 👤 [un4ckn0wl3z](https://github.com/un4ckn0wl3z) Starred [idea4good/GuiLite](https://github.com/idea4good/GuiLite)
  > ✔️The smallest header-only GUI library(4 KLOC) for all platforms

### [v9d0g](https://github.com/v9d0g)
- 🍴 👤 [v9d0g](https://github.com/v9d0g) Forked [chAng-L19/codex-redteam-mode](https://github.com/chAng-L19/codex-redteam-mode) to [v9d0g/codex-redteam-mode](https://github.com/v9d0g/codex-redteam-mode)
  > 针对于红队攻击思维做出的red team模式(破限项目，封号概不负责）##可自行适配其他AI

### [vipstone](https://github.com/vipstone)
- 🌟 👤 [vipstone](https://github.com/vipstone) Starred [yangchuansheng/visual-ip-illustrations](https://github.com/yangchuansheng/visual-ip-illustrations)
  > Codex Skill for consistent 16:9 hand-drawn article illustrations with selectable visual IP routes: O...

### [wafinfo](https://github.com/wafinfo)
- 🌟 👤 [wafinfo](https://github.com/wafinfo) Starred [SECWG/WG-Win-Check](https://github.com/SECWG/WG-Win-Check)
  > 一款轻量级Windows 应急响应辅助工具

### [winmin](https://github.com/winmin)
- 🌟 👤 [winmin](https://github.com/winmin) Starred [P4nda0s/reverse-skills](https://github.com/P4nda0s/reverse-skills)
  > Reverse engineering skills for Claude Code | 逆向工程 Claude Code Skills 插件

### [wishihab](https://github.com/wishihab)
- 🌟 👤 [wishihab](https://github.com/wishihab) Starred [Kodiqa-Solutions/VaultS3](https://github.com/Kodiqa-Solutions/VaultS3)
  > Lightweight, S3-compatible object storage server with built-in web dashboard. Single binary, low mem...

### [wkbin](https://github.com/wkbin)
- 🌟 👤 [wkbin](https://github.com/wkbin) Starred [roro2239/Stellar](https://github.com/roro2239/Stellar)
  > Another Shizuku impl
- 🍴 👤 [wkbin](https://github.com/wkbin) Forked [roro2239/Stellar](https://github.com/roro2239/Stellar) to [wkbin/Stellar](https://github.com/wkbin/Stellar)
  > Another Shizuku impl

### [wonderkun](https://github.com/wonderkun)
- 🌟 👤 [wonderkun](https://github.com/wonderkun) Starred [palmier-io/palmier-pro](https://github.com/palmier-io/palmier-pro)
  > macOS video editor built for AI

### [xiaoweigege](https://github.com/xiaoweigege)
- 🌟 👤 [xiaoweigege](https://github.com/xiaoweigege) Starred [baidu/Unlimited-OCR](https://github.com/baidu/Unlimited-OCR)
  > Unlimited OCR Works: Welcome the Era of One-shot Long-horizon Parsing.
- 🌟 👤 [xiaoweigege](https://github.com/xiaoweigege) Starred [disasm-dev/js-vm-in-go](https://github.com/disasm-dev/js-vm-in-go)
  > Companion code for the 'Writing a JavaScript VM in Go' article: a minimal register-based JS VM compi...

### [xsser](https://github.com/xsser)
- 🌟 👤 [xsser](https://github.com/xsser) Starred [agent-infra/sandbox](https://github.com/agent-infra/sandbox)
  > All-in-One Sandbox for AI Agents that combines Browser, Shell, File, MCP and VSCode Server in a sing...
...
- 🌟 👤 [yhy0](https://github.com/yhy0) Starred [nexu-io/open-design](https://github.com/nexu-io/open-design)
...
- 🌟 👤 [yichen115](https://github.com/yichen115) Starred [nminaylov/F1C100s_info](https://github.com/nminaylov/F1C100s_info)
  > Allwinner F1C100s/F1C200s reverse engineering and documentation

### [yipianfengye](https://github.com/yipianfengye)
- 🌟 👤 [yipianfengye](https://github.com/yipianfengye) Starred [ZhuLinsen/daily_stock_analysis](https://github.com/ZhuLinsen/daily_stock_analysis)
  > LLM 驱动的多市场股票智能分析系统：多源行情、实时新闻、决策看板与自动推送，支持零成本定时运行。  LLM-powered multi-market stock analysis system wi...
- 🍴 👤 [yipianfengye](https://github.com/yipianfengye) Forked [ZhuLinsen/daily_stock_analysis](https://github.com/ZhuLinsen/daily_stock_analysis) to [yipianfengye/daily_stock_analysis](https://github.com/yipianfengye/daily_stock_analysis)
  > LLM 驱动的多市场股票智能分析系统：多源行情、实时新闻、决策看板与自动推送，支持零成本定时运行。  LLM-powered multi-market stock analysis system wi...
...
- 🌟 👤 [yulate](https://github.com/yulate) Starred [go-kratos/kratos](https://github.com/go-kratos/kratos)
  > Your ultimate Go microservices framework for the cloud-native era.

### [yuzheng14](https://github.com/yuzheng14)
- 🌟 👤 [yuzheng14](https://github.com/yuzheng14) Starred [tsz-org/tsz](https://github.com/tsz-org/tsz)
  > A performance-first TypeScript checker

### [zetaloop](https://github.com/zetaloop)
- 🌟 👤 [zetaloop](https://github.com/zetaloop) Starred [siyuan-note/siyuan](https://github.com/siyuan-note/siyuan)
...
- 🌟 👤 [zfl9](https://github.com/zfl9) Starred [the-argus/zig-compile-commands](https://github.com/the-argus/zig-compile-commands)
  > A simple zig module to generate compile_commands.json from a slice of build targets.
- 🌟 👤 [zfl9](https://github.com/zfl9) Starred [rizsotto/Bear](https://github.com/rizsotto/Bear)
  > Bear is a tool that generates a compilation database for clang tooling.

### [zhangyoufu](https://github.com/zhangyoufu)
- 🌟 👤 [zhangyoufu](https://github.com/zhangyoufu) Starred [Yu9191/wloc](https://github.com/Yu9191/wloc)
  > 修改 Apple 网络定位（gs-loc）返回坐标 · 支持 Surge / Quantumult X / Loon / Stash · 快捷指令一键设置/恢复定位
- 🌟 👤 [zhangyoufu](https://github.com/zhangyoufu) Starred [theoderoy/Deboogey](https://github.com/theoderoy/Deboogey)
