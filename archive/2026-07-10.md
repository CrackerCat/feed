...
- 🌟 👤 [0xbug](https://github.com/0xbug) Starred [glincker/thesvg](https://github.com/glincker/thesvg)
...
- 🍴 👤 [0xricksanchez](https://github.com/0xricksanchez) Forked [ptr-yudai/pawnyable](https://github.com/ptr-yudai/pawnyable) to [0xricksanchez/pawnyable](https://github.com/0xricksanchez/pawnyable)
  > PAWNYABLE!
...
- 🌟 👤 [350030173](https://github.com/350030173) Starred [yzfly/Awesome-MCP-ZH](https://github.com/yzfly/Awesome-MCP-ZH)
  > MCP 资源精选， MCP指南，Claude MCP，MCP Servers, MCP Clients
- 🌟 👤 [350030173](https://github.com/350030173) Starred [stablyai/orca](https://github.com/stablyai/orca)
  > Orca is the ADE for working with a fleet of parallel agents. Run any coding agent with your own subs...

### [4ra1n](https://github.com/4ra1n)
- 🌟 👤 [4ra1n](https://github.com/4ra1n) Starred [JustVugg/colibri](https://github.com/JustVugg/colibri)
...
- 🌟 👤 [7etsuo](https://github.com/7etsuo) Starred [IQCoreTeam/AgentNet](https://github.com/IQCoreTeam/AgentNet)
- 🌟 👤 [7etsuo](https://github.com/7etsuo) Starred [sebbsssss/clude](https://github.com/sebbsssss/clude)

### [Abbbbbi](https://github.com/Abbbbbi)
- 🌟 👤 [Abbbbbi](https://github.com/Abbbbbi) Starred [pubglite55/oppo-ghostlock](https://github.com/pubglite55/oppo-ghostlock)
  > OPPO Find N2 GhostLock (CVE-2026-43499) exploit adaptation

### [AlexiaChen](https://github.com/AlexiaChen)
- 🌟 👤 [AlexiaChen](https://github.com/AlexiaChen) Starred [malisper/pgrust](https://github.com/malisper/pgrust)
  > Postgres rewritten in Rust, now passing 100% of the Postgres regression tests

### [AnkioTomas](https://github.com/AnkioTomas)
- 🌟 👤 [AnkioTomas](https://github.com/AnkioTomas) Starred [xiaodonglicn/webView](https://github.com/xiaodonglicn/webView)
  > 此插件为jetbrains集成开发环境添加了一个在编辑器右侧工具栏的内置浏览器功能，允许开发者在不离开IDE的情况下： - 高效浏览网页 - 测试前端代码 - 查阅在线文档 极大提升了开发效率。
...
- 🌟 👤 [CCint3](https://github.com/CCint3) Starred [ShinoLeah/eDBG](https://github.com/ShinoLeah/eDBG)
  > eBPF-based lightweight debugger for Android with MCP support
- 🌟 👤 [CCint3](https://github.com/CCint3) Starred [5ec1cff/btrace](https://github.com/5ec1cff/btrace)
  > btrace：binder_transaction+eBPF+Golang实现通用的Android APP动态行为追踪工具
...
- 🌟 👤 [Cxk4ng](https://github.com/Cxk4ng) Starred [ravindu644/VirtualAP](https://github.com/ravindu644/VirtualAP)
...
- 🌟 👤 [DarkLineX](https://github.com/DarkLineX) Starred [MobiusM/CVE-2026-43499](https://github.com/MobiusM/CVE-2026-43499)
  > CVE-2026-43499 PoC
- 🌟 👤 [DarkLineX](https://github.com/DarkLineX) Starred [neocanable/garlic](https://github.com/neocanable/garlic)
  > The world's fastest apk (android)/java open source decompiler
- 🌟 👤 [DarkLineX](https://github.com/DarkLineX) Starred [vocolboy/RemoteKeyAttestation](https://github.com/vocolboy/RemoteKeyAttestation)
  > Android Remote Key Attestation (RKA) / Remote Key Provisioning (RKP) notes & demo for Play Integrity
- 🌟 👤 [DarkLineX](https://github.com/DarkLineX) Starred [pkic/remote-key-attestation](https://github.com/pkic/remote-key-attestation)
  > Remote Key Attestation
- 🌟 👤 [DarkLineX](https://github.com/DarkLineX) Starred [Andrea-lyz/TEESimulator-RS-Online](https://github.com/Andrea-lyz/TEESimulator-RS-Online)
  > Software simulation for Android hardware-backed key pairs with key attestation | https://t.me/superp...
- 🌟 👤 [DarkLineX](https://github.com/DarkLineX) Starred [March7-code/ZygiskInject](https://github.com/March7-code/ZygiskInject)
  > 基于ZygiskFrida修改而来的行为分析和注入器
- 🌟 👤 [DarkLineX](https://github.com/DarkLineX) Starred [Anekys/BinderTracer](https://github.com/Anekys/BinderTracer)
  > Android Binder transaction tracer
- 🌟 👤 [DarkLineX](https://github.com/DarkLineX) Starred [pubglite55/oppo-ghostlock](https://github.com/pubglite55/oppo-ghostlock)
  > OPPO Find N2 GhostLock (CVE-2026-43499) exploit adaptation
- 🌟 👤 [DarkLineX](https://github.com/DarkLineX) Starred [jiqiu2022/Zygisk-MyInjector](https://github.com/jiqiu2022/Zygisk-MyInjector)
...
- 🌟 👤 [DownWithUp](https://github.com/DownWithUp) Starred [aclfe/inertia](https://github.com/aclfe/inertia)
...
- 🌟 👤 [G4rb3n](https://github.com/G4rb3n) Starred [Pennyw0rth/NetExec](https://github.com/Pennyw0rth/NetExec)
  > The Network Execution Tool

### [GaoYuCan](https://github.com/GaoYuCan)
- 🌟 👤 [GaoYuCan](https://github.com/GaoYuCan) Starred [FrizzleM/SideInstaller](https://github.com/FrizzleM/SideInstaller)
  > An an app that installs Sidestore on iOS 27, fully on-device 
- 🌟 👤 [GaoYuCan](https://github.com/GaoYuCan) Starred [SamuelTulach/unxorer](https://github.com/SamuelTulach/unxorer)
  > Yet another IDA Pro/Home plugin for deobfuscating stack strings
- 🌟 👤 [GaoYuCan](https://github.com/GaoYuCan) Starred [19h/idax](https://github.com/19h/idax)
  > A beautiful, idiomatic and less frustrating IDA C++ SDK.

### [Grigory-Rylov](https://github.com/Grigory-Rylov)
- 🌟 👤 [Grigory-Rylov](https://github.com/Grigory-Rylov) Starred [hec-ovi/vllm-qwen](https://github.com/hec-ovi/vllm-qwen)
  > vLLM + Qwen3.6-27B (BF16) OpenAI-compatible inference server on AMD Strix Halo (Ryzen AI Max+ 395, g...

### [H3d9](https://github.com/H3d9)
- 🌟 👤 [H3d9](https://github.com/H3d9) Starred [vercel-labs/native](https://github.com/vercel-labs/native)
...
- 🌟 👤 [Howard20181](https://github.com/Howard20181) Starred [JonaNorman/WebViewUpgrade](https://github.com/JonaNorman/WebViewUpgrade)
...
- 🌟 👤 [Idov31](https://github.com/Idov31) Starred [V4bel/Januscape](https://github.com/V4bel/Januscape)
...
- 🌟 👤 [KHwang9883](https://github.com/KHwang9883) Starred [utkarshdalal/GameNative](https://github.com/utkarshdalal/GameNative)
  > Native PC gaming with Steam, Epic, GOG and Amazon integrations on Android

### [KuLiPai](https://github.com/KuLiPai)
- 🌟 👤 [KuLiPai](https://github.com/KuLiPai) Starred [paditianxiu/QQ_Revived](https://github.com/paditianxiu/QQ_Revived)
  > 基于手表QQ9.0.5版本的文艺复兴模块
- 🍴 👤 [KuLiPai](https://github.com/KuLiPai) Forked [znzsofficial/NeLuaJ](https://github.com/znzsofficial/NeLuaJ) to [KuLiPai/LC-IDE](https://github.com/KuLiPai/LC-IDE)
  > Android LuaJ IDE With Newest Dependency and Feature

### [LaPhilosophie](https://github.com/LaPhilosophie)
- 🌟 👤 [LaPhilosophie](https://github.com/LaPhilosophie) Starred [HYGON-AI/dcu-inference-cookbook](https://github.com/HYGON-AI/dcu-inference-cookbook)
  > 本仓库整理了在 DCU 硬件上部署、调优和运行 AI 模型的经验与最佳实践

### [LanBaiCode](https://github.com/LanBaiCode)
- 🌟 👤 [LanBaiCode](https://github.com/LanBaiCode) Starred [neocanable/garlic](https://github.com/neocanable/garlic)
  > The world's fastest apk (android)/java open source decompiler
- 🍴 👤 [LanBaiCode](https://github.com/LanBaiCode) Forked [neocanable/garlic](https://github.com/neocanable/garlic) to [LanBaiCode/garlic](https://github.com/LanBaiCode/garlic)
  > The world's fastest apk (android)/java open source decompiler

### [LimerBoy](https://github.com/LimerBoy)
- 🌟 👤 [LimerBoy](https://github.com/LimerBoy) Starred [i-vt/InterestingSnippets](https://github.com/i-vt/InterestingSnippets)
  > Interesting code snippets found across the www world  & some of my own useful creations :)

### [Lotus6](https://github.com/Lotus6)
- 🌟 👤 [Lotus6](https://github.com/Lotus6) Starred [owl234/ARL-Next](https://github.com/owl234/ARL-Next)
  > 🚀 自动化资产侦察与漏洞监控平台 (ARL-Next)。重构自 ARL 经典版，升级为 Puppeteer + Nuclei 引擎，打通“天眼查/ICP ➔ 资产发现 ➔ 漏洞扫描”全链路。Vue3 ...
- 🌟 👤 [Lotus6](https://github.com/Lotus6) Starred [P4nda0s/IDA-NO-MCP](https://github.com/P4nda0s/IDA-NO-MCP)
...
- 🌟 👤 [MartinKayJr](https://github.com/MartinKayJr) Starred [NebuSec/CyberMeowfia](https://github.com/NebuSec/CyberMeowfia)
  > PoCs and exploits for CVEs discovered by VEGA. 
- 🌟 👤 [MartinKayJr](https://github.com/MartinKayJr) Starred [r58Playz/uBlock-mv3](https://github.com/r58Playz/uBlock-mv3)
  > Full MV3 port of uBlock Origin - An efficient blocker for Chromium and Firefox. Fast and lean.
- 🌟 👤 [MartinKayJr](https://github.com/MartinKayJr) Starred [S1mpleSonny/neon-vibe-motion](https://github.com/S1mpleSonny/neon-vibe-motion)
  > First open-source vibe motion platform.
- 🌟 👤 [MartinKayJr](https://github.com/MartinKayJr) Starred [GurYN/vibe-slides](https://github.com/GurYN/vibe-slides)
  > Vibe Slides is a "Vibe Coding" application for presentation creation. It enables users to create pro...
- 🌟 👤 [MartinKayJr](https://github.com/MartinKayJr) Starred [lijiejie/BBScan](https://github.com/lijiejie/BBScan)
  > A fast vulnerability scanner helps pentesters pinpoint possibly vulnerable targets from a large numb...

### [Metatronxl](https://github.com/Metatronxl)
- 🌟 👤 [Metatronxl](https://github.com/Metatronxl) Starred [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md)
...
- 🌟 👤 [Monoceros406](https://github.com/Monoceros406) Starred [MistyFir/SVMHypervisor-Preview](https://github.com/MistyFir/SVMHypervisor-Preview)
  > 从零开始手写的AMD平台Hypervisor

### [MrIkso](https://github.com/MrIkso)
- 🌟 👤 [MrIkso](https://github.com/MrIkso) Starred [ForeverZer0/glfw-net](https://github.com/ForeverZer0/glfw-net)
  > Complete, cross-platform, managed wrapper around the GLFW library for creating native windows with a...
...
- 🌟 👤 [No-Github](https://github.com/No-Github) Starred [AgentCyberRange/PostExploitBench](https://github.com/AgentCyberRange/PostExploitBench)
...
- 🌟 👤 [Resery](https://github.com/Resery) Starred [0xCyberstan/CVE-2026-46215-POC](https://github.com/0xCyberstan/CVE-2026-46215-POC)
...
- 🌟 👤 [Seyud](https://github.com/Seyud) Starred [Ujhhgtg/WeKit](https://github.com/Ujhhgtg/WeKit)
...
- 🌟 👤 [Skorpion96](https://github.com/Skorpion96) Starred [evoker0/AlwaysStrong](https://github.com/evoker0/AlwaysStrong)
...
- 🍴 👤 [Slzdude](https://github.com/Slzdude) Forked [taisuii/rusda](https://github.com/taisuii/rusda) to [Slzdude/rusda](https://github.com/Slzdude/rusda)
  > 对frida 的patch，产物可直接下载Release

### [SodaMilk233](https://github.com/SodaMilk233)
- 🌟 👤 [SodaMilk233](https://github.com/SodaMilk233) Starred [ADeveloperH/AndroidReverse](https://github.com/ADeveloperH/AndroidReverse)
  > Android 逆向相关
- 🌟 👤 [SodaMilk233](https://github.com/SodaMilk233) Starred [playbar/androidreverse](https://github.com/playbar/androidreverse)
- 🌟 👤 [SodaMilk233](https://github.com/SodaMilk233) Starred [kcd-dev/codex-no-limit](https://github.com/kcd-dev/codex-no-limit)
  > 突破限制
- 🌟 👤 [SodaMilk233](https://github.com/SodaMilk233) Starred [gaogg521/1ONE-ClaudeCode](https://github.com/gaogg521/1ONE-ClaudeCode)
...
- 🍴 👤 [Tornaco](https://github.com/Tornaco) Forked [wanghongenpin/proxypin](https://github.com/wanghongenpin/proxypin) to [Tornaco/proxypin](https://github.com/Tornaco/proxypin)
  > Open source free capture HTTP(S) traffic  software ProxyPin, supporting full platform systems

### [WangWei-CM](https://github.com/WangWei-CM)
- 🚀 👤 [WangWei-CM](https://github.com/WangWei-CM) Made [KSwordDEV/KSwordSandbox](https://github.com/KSwordDEV/KSwordSandbox) public
  > Windows sandbox to analyze virus automatically

### [WindXaa](https://github.com/WindXaa)
- 🌟 👤 [WindXaa](https://github.com/WindXaa) Starred [MobiusM/CVE-2026-43499](https://github.com/MobiusM/CVE-2026-43499)
  > CVE-2026-43499 PoC
- 🍴 👤 [WindXaa](https://github.com/WindXaa) Forked [MobiusM/CVE-2026-43499](https://github.com/MobiusM/CVE-2026-43499) to [WindXaa/CVE-2026-43499](https://github.com/WindXaa/CVE-2026-43499)
  > CVE-2026-43499 PoC

### [X1r0z](https://github.com/X1r0z)
- 🌟 👤 [X1r0z](https://github.com/X1r0z) Starred [Metnew/write-ups](https://github.com/Metnew/write-ups)

### [XayahSuSuSu](https://github.com/XayahSuSuSu)
- 🌟 👤 [XayahSuSuSu](https://github.com/XayahSuSuSu) Starred [mean00/avidemux2](https://github.com/mean00/avidemux2)
  > Avidemux2, simple video editor

### [Xieansecn](https://github.com/Xieansecn)
- 🌟 👤 [Xieansecn](https://github.com/Xieansecn) Starred [NebuSec/CyberMeowfia](https://github.com/NebuSec/CyberMeowfia)
  > PoCs and exploits for CVEs discovered by VEGA. 
...
- 🌟 👤 [YuKongA](https://github.com/YuKongA) Starred [stablyai/orca](https://github.com/stablyai/orca)
  > Orca is the ADE for working with a fleet of parallel agents. Run any coding agent with your own subs...
- 🌟 👤 [YuKongA](https://github.com/YuKongA) Starred [hanshuaikang/nezha](https://github.com/hanshuaikang/nezha)
...
- 🌟 👤 [byt3n33dl3](https://github.com/byt3n33dl3) Starred [overgrowncarrot1/Invoke-Everything](https://github.com/overgrowncarrot1/Invoke-Everything)
...
- 🌟 👤 [cnlh](https://github.com/cnlh) Starred [zw008/VMware-AIops](https://github.com/zw008/VMware-AIops)
  > VMware vCenter/ESXi AI-powered monitoring and operations. Two skills: vmware-monitor (read-only, saf...

### [codehasan](https://github.com/codehasan)
- 🍴 👤 [codehasan](https://github.com/codehasan) Forked [flyfishxu/Kadb](https://github.com/flyfishxu/Kadb) to [codehasan/Kadb](https://github.com/codehasan/Kadb)
  > A Kotlin Multiplatform library to connect Android devices directly without ADB binary file.

### [crazy-max](https://github.com/crazy-max)
- 🍴 👤 [crazy-max](https://github.com/crazy-max) Forked [docker/docker-py](https://github.com/docker/docker-py) to [crazy-max/docker-py](https://github.com/crazy-max/docker-py)
  > A Python library for the Docker Engine API

### [cwuom](https://github.com/cwuom)
- 🌟 👤 [cwuom](https://github.com/cwuom) Starred [MobiusM/CVE-2026-43499](https://github.com/MobiusM/CVE-2026-43499)
  > CVE-2026-43499 PoC

### [darbra](https://github.com/darbra)
- 🌟 👤 [darbra](https://github.com/darbra) Starred [op7418/Humanizer-zh](https://github.com/op7418/Humanizer-zh)
  > Humanizer 的汉化版本，Claude Code Skills，旨在消除文本中 AI 生成的痕迹。
- 🌟 👤 [darbra](https://github.com/darbra) Starred [QiuChenly/ida-pro-mcp-enhancement](https://github.com/QiuChenly/ida-pro-mcp-enhancement)
  > 二创爆改，懒得提交给原仓库了
...
- 🌟 👤 [darvincisec](https://github.com/darvincisec) Starred [synacktiv/frinet](https://github.com/synacktiv/frinet)
  > Frida-based tracer for easier reverse-engineering on Android, iOS, Linux, Windows and most related a...
- 🌟 👤 [darvincisec](https://github.com/darvincisec) Starred [caverav/flutterdec](https://github.com/caverav/flutterdec)
  > The Flutter Decompiler: CLI tool that decompiles Flutter Android AOT (libapp.so) into Dart-like pseu...
- 🌟 👤 [darvincisec](https://github.com/darvincisec) Starred [requie/AI-Red-Teaming-Guide](https://github.com/requie/AI-Red-Teaming-Guide)
...
- 🌟 👤 [doodlewind](https://github.com/doodlewind) Starred [arcprize/ARC-AGI-3-Agents](https://github.com/arcprize/ARC-AGI-3-Agents)
- 🌟 👤 [doodlewind](https://github.com/doodlewind) Starred [xt4d/GameBlocks](https://github.com/xt4d/GameBlocks)
  > Concise and self-explanatory building blocks that help coding agents prototype browser-based 3D game...
- 🌟 👤 [doodlewind](https://github.com/doodlewind) Starred [TencentARC/InstantMesh](https://github.com/TencentARC/InstantMesh)
  > InstantMesh: Efficient 3D Mesh Generation from a Single Image with Sparse-view Large Reconstruction ...

### [dstmath](https://github.com/dstmath)
- 🌟 👤 [dstmath](https://github.com/dstmath) Starred [ilysenko/codex-desktop-linux](https://github.com/ilysenko/codex-desktop-linux)
  > Unofficial ChatGPT desktop app for Linux (formerly the Codex app), built locally from OpenAI’s offic...

### [dwisiswant0](https://github.com/dwisiswant0)
- 🌟 👤 [dwisiswant0](https://github.com/dwisiswant0) Starred [mjansson/rpmalloc](https://github.com/mjansson/rpmalloc)
  > Public domain cross platform lock free thread caching 16-byte aligned memory allocator implemented i...

### [dzxpert](https://github.com/dzxpert)
- 🌟 👤 [dzxpert](https://github.com/dzxpert) Starred [devirtz/ss-overlay-hook](https://github.com/devirtz/ss-overlay-hook)
...
- 🍴 👤 [enginelesscc](https://github.com/enginelesscc) Forked [vendetta-mod/VendettaTweak](https://github.com/vendetta-mod/VendettaTweak) to [enginelesscc/VendettaTweak](https://github.com/enginelesscc/VendettaTweak)
  > A tweak to inject Vendetta, a mod for Discord's mobile apps.
- 🍴 👤 [enginelesscc](https://github.com/enginelesscc) Forked [vendetta-mod/Vendetta](https://github.com/vendetta-mod/Vendetta) to [enginelesscc/Vendetta](https://github.com/enginelesscc/Vendetta)
...
- 🌟 👤 [fengchenzxc](https://github.com/fengchenzxc) Starred [WhiteNightShadow/hello_js_reverse_skill](https://github.com/WhiteNightShadow/hello_js_reverse_skill)
  > 🔧 AI-powered JS逆向工程 Skill —— 覆盖加密还原、混淆分析、动态Cookie、WASM逆向、协议对抗等全链路场景，通过 Node.js 实现算法还原与模拟请求。适配 Claude...
- 🌟 👤 [fengchenzxc](https://github.com/fengchenzxc) Starred [P4nda0s/reverse-skills](https://github.com/P4nda0s/reverse-skills)
...
- 🌟 👤 [fynch3r](https://github.com/fynch3r) Starred [chAng-L19/codex-redteam-mode](https://github.com/chAng-L19/codex-redteam-mode)
  > 针对于红队攻击思维做出的red team模式(破限项目，封号概不负责）##可自行适配其他AI

### [gclm](https://github.com/gclm)
- 🍴 👤 [gclm](https://github.com/gclm) Forked [maillab/cloud-mail](https://github.com/maillab/cloud-mail) to [gclm/cloud-mail](https://github.com/gclm/cloud-mail)
  > A Cloudflare-based email service  | 基于 Cloudflare 的邮箱服务  | Cloudflare Email 邮箱 Mail

### [gmh5225](https://github.com/gmh5225)
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [XenoCoreGiger31/GEMMA-by-GOOGLE](https://github.com/XenoCoreGiger31/GEMMA-by-GOOGLE) to [gmh5225/GEMMA-by-GOOGLE](https://github.com/gmh5225/GEMMA-by-GOOGLE)
  > A fully local, autonomous AI penetration-testing agent powered by Gemma 4-12B and a Flask MCP tool s...
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [sieblyio/kraken-api](https://github.com/sieblyio/kraken-api) to [gmh5225/kraken-api](https://github.com/gmh5225/kraken-api)
  > Complete Node.js & JavaScript SDK for Kraken's REST APIs & WebSockets, with TypeScript & browser sup...
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [freedomofpress/webcat](https://github.com/freedomofpress/webcat) to [gmh5225/webcat](https://github.com/gmh5225/webcat)
...
- 🌟 👤 [huoji120](https://github.com/huoji120) Starred [kacper-daftcode/vLLM-Moet](https://github.com/kacper-daftcode/vLLM-Moet)
...
- 🌟 👤 [hyrathon](https://github.com/hyrathon) Starred [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent)
  > The agent that grows with you

### [hyuunnn](https://github.com/hyuunnn)
- 🌟 👤 [hyuunnn](https://github.com/hyuunnn) Starred [elpapi42/pi-observational-memory](https://github.com/elpapi42/pi-observational-memory)
...
- 🌟 👤 [ilian](https://github.com/ilian) Starred [jqssun/android-airplay-server](https://github.com/jqssun/android-airplay-server)
...
- 🌟 👤 [jianglin-code](https://github.com/jianglin-code) Starred [pytorch/torchtitan](https://github.com/pytorch/torchtitan)
  > A PyTorch native platform for training generative AI models
- 🌟 👤 [jianglin-code](https://github.com/jianglin-code) Starred [apache/spark](https://github.com/apache/spark)
  > Apache Spark - A unified analytics engine for large-scale data processing
- 🌟 👤 [jianglin-code](https://github.com/jianglin-code) Starred [ray-project/ray](https://github.com/ray-project/ray)
  > Ray is an AI compute engine. Ray consists of a core distributed runtime and a set of AI Libraries fo...
- 🌟 👤 [jianglin-code](https://github.com/jianglin-code) Starred [OpenDCAI/DataFlow](https://github.com/OpenDCAI/DataFlow)
  > Easy Data Preparation with latest LLMs-based Operators and Pipelines.
- 🌟 👤 [jianglin-code](https://github.com/jianglin-code) Starred [apache/beam](https://github.com/apache/beam)
  > Apache Beam is a unified programming model for Batch and Streaming data processing.
- 🌟 👤 [jianglin-code](https://github.com/jianglin-code) Starred [allenai/OLMo](https://github.com/allenai/OLMo)
...
- 🌟 👤 [jiyulany](https://github.com/jiyulany) Starred [Wanghaibo10/Reqable-Mcp](https://github.com/Wanghaibo10/Reqable-Mcp)
  > Reqable mcp工具

### [jpacg](https://github.com/jpacg)
- 🌟 👤 [jpacg](https://github.com/jpacg) Starred [synacktiv/frinet](https://github.com/synacktiv/frinet)
  > Frida-based tracer for easier reverse-engineering on Android, iOS, Linux, Windows and most related a...
...
- 🍴 👤 [kaganisildak](https://github.com/kaganisildak) Forked [bytecodealliance/wasmtime](https://github.com/bytecodealliance/wasmtime) to [kaganisildak/wasmtime](https://github.com/kaganisildak/wasmtime)
  > A lightweight WebAssembly runtime that is fast, secure, and standards-compliant
- 🌟 👤 [kaganisildak](https://github.com/kaganisildak) Starred [REMnux/remnux-mcp-server](https://github.com/REMnux/remnux-mcp-server)
...
- 🌟 👤 [keith2018](https://github.com/keith2018) Starred [TransformerLensOrg/TransformerLens](https://github.com/TransformerLensOrg/TransformerLens)
  > A library for mechanistic interpretability of GPT-style language models

### [kkkgo](https://github.com/kkkgo)
- 🌟 👤 [kkkgo](https://github.com/kkkgo) Starred [1-stream/RegionRestrictionCheck](https://github.com/1-stream/RegionRestrictionCheck)
  > A bash script to check if your VPS's IP is available for various OTT platforms

### [konieshadow](https://github.com/konieshadow)
- 🌟 👤 [konieshadow](https://github.com/konieshadow) Starred [flame-engine/flame](https://github.com/flame-engine/flame)
...
- 🌟 👤 [lidongyooo](https://github.com/lidongyooo) Starred [NebuSec/CyberMeowfia](https://github.com/NebuSec/CyberMeowfia)
  > PoCs and exploits for CVEs discovered by VEGA. 
- 🍴 👤 [lidongyooo](https://github.com/lidongyooo) Forked [NebuSec/CyberMeowfia](https://github.com/NebuSec/CyberMeowfia) to [lidongyooo/CyberMeowfia](https://github.com/lidongyooo/CyberMeowfia)
  > PoCs and exploits for CVEs discovered by VEGA. 

### [lightless233](https://github.com/lightless233)
- 🌟 👤 [lightless233](https://github.com/lightless233) Starred [laoma2053/awesome-zhuiju-free](https://github.com/laoma2053/awesome-zhuiju-free)
...
- 🌟 👤 [lordidiot](https://github.com/lordidiot) Starred [dk8827/ra-port](https://github.com/dk8827/ra-port)
  > Unofficial working port of Command & Conquer: Red Alert running natively on iOS, Android and macOS. ...
...
- 🌟 👤 [lyy289065406](https://github.com/lyy289065406) Starred [DeusData/codebase-memory-mcp](https://github.com/DeusData/codebase-memory-mcp)
  > High-performance code intelligence MCP server. Indexes codebases into a persistent knowledge graph —...
- 🍴 👤 [lyy289065406](https://github.com/lyy289065406) Forked [DeusData/codebase-memory-mcp](https://github.com/DeusData/codebase-memory-mcp) to [Visuals-AI/codebase-memory-mcp](https://github.com/Visuals-AI/codebase-memory-mcp)
  > High-performance code intelligence MCP server. Indexes codebases into a persistent knowledge graph —...
...
- 🍴 👤 [mdcgqq](https://github.com/mdcgqq) Forked [ZhuLinsen/daily_stock_analysis](https://github.com/ZhuLinsen/daily_stock_analysis) to [mdcgqq/daily_stock_analysis](https://github.com/mdcgqq/daily_stock_analysis)
  > LLM 驱动的多市场股票智能分析系统：多源行情、实时新闻、决策看板与自动推送，支持零成本定时运行。  LLM-powered multi-market stock analysis system wi...

### [merlinxcy](https://github.com/merlinxcy)
- 🌟 👤 [merlinxcy](https://github.com/merlinxcy) Starred [P1sec/hermes-dec](https://github.com/P1sec/hermes-dec)
...
- 🌟 👤 [mzule](https://github.com/mzule) Starred [mattpocock/skills](https://github.com/mattpocock/skills)
  > Skills for Real Engineers. Straight from my .claude directory.

### [namename333](https://github.com/namename333)
- 🌟 👤 [namename333](https://github.com/namename333) Starred [owu/wsl-dashboard](https://github.com/owu/wsl-dashboard)
...
- 🌟 👤 [nek0y4nsu](https://github.com/nek0y4nsu) Starred [zeze-zeze/2021iThome](https://github.com/zeze-zeze/2021iThome)
  > 2021 iThome 鐵人賽

### [netxfly](https://github.com/netxfly)
- 🌟 👤 [netxfly](https://github.com/netxfly) Starred [TianxingChen/Embodied-AI-Guide](https://github.com/TianxingChen/Embodied-AI-Guide)
  > [Lumina具身智能社区] 具身智能技术指南 Embodied-AI-Guide
- 🌟 👤 [netxfly](https://github.com/netxfly) Starred [eatmoreduck/boss-zhipin-scraper](https://github.com/eatmoreduck/boss-zhipin-scraper)
...
- 🌟 👤 [not1cyyy](https://github.com/not1cyyy) Starred [devirtz/ss-overlay-hook](https://github.com/devirtz/ss-overlay-hook)
  > DLL injection + ImGui overlay by hijacking SteelSeries GameOverlay internals.
...
- 🌟 👤 [overfl0](https://github.com/overfl0) Starred [P4nda0s/IDABeautify](https://github.com/P4nda0s/IDABeautify)
  > An IDA plugin for making pseudocode better.

### [poorevil](https://github.com/poorevil)
- 🌟 👤 [poorevil](https://github.com/poorevil) Starred [modelcontextprotocol/go-sdk](https://github.com/modelcontextprotocol/go-sdk)
...
- 🌟 👤 [pwh-pwh](https://github.com/pwh-pwh) Starred [mukul975/Anthropic-Cybersecurity-Skills](https://github.com/mukul975/Anthropic-Cybersecurity-Skills)
...
- 🌟 👤 [quanyeyang](https://github.com/quanyeyang) Starred [cython/cython](https://github.com/cython/cython)
...
- 🌟 👤 [riusksk](https://github.com/riusksk) Starred [TianxingChen/Embodied-AI-Guide](https://github.com/TianxingChen/Embodied-AI-Guide)
  > [Lumina具身智能社区] 具身智能技术指南 Embodied-AI-Guide
- 🌟 👤 [riusksk](https://github.com/riusksk) Starred [datawhalechina/dive-into-embodied-ai](https://github.com/datawhalechina/dive-into-embodied-ai)
...
- 🌟 👤 [s5uishida](https://github.com/s5uishida) Starred [zebra-rs/zebra-rs](https://github.com/zebra-rs/zebra-rs)
- 🍴 👤 [s5uishida](https://github.com/s5uishida) Forked [ravens/awesome-telco](https://github.com/ravens/awesome-telco) to [s5uishida/awesome-telco](https://github.com/s5uishida/awesome-telco)
  > A curated list of telco resources and projects
- 🌟 👤 [s5uishida](https://github.com/s5uishida) Starred [ravens/awesome-telco](https://github.com/ravens/awesome-telco)
  > A curated list of telco resources and projects
...
- 🌟 👤 [seritools](https://github.com/seritools) Starred [ryzendew/Linux-Affinity-Installer](https://github.com/ryzendew/Linux-Affinity-Installer)
...
- 🌟 👤 [wa1ki0g](https://github.com/wa1ki0g) Starred [AiHubCN/Awesome-Chinese-LLM](https://github.com/AiHubCN/Awesome-Chinese-LLM)
  > 整理开源的中文大语言模型，以规模较小、可私有化部署、训练成本较低的模型为主，包括底座模型，垂直领域微调及应用，数据集与教程等。

### [weizn11](https://github.com/weizn11)
- 🌟 👤 [weizn11](https://github.com/weizn11) Starred [mattpocock/skills](https://github.com/mattpocock/skills)
  > Skills for Real Engineers. Straight from my .claude directory.

### [wh1te4ever](https://github.com/wh1te4ever)
- 🌟 👤 [wh1te4ever](https://github.com/wh1te4ever) Starred [synackuk/De-Rebus-Antiquis-v6](https://github.com/synackuk/De-Rebus-Antiquis-v6)
...
- 🌟 👤 [wjcsharp](https://github.com/wjcsharp) Starred [ruvnet/RuView](https://github.com/ruvnet/RuView)
...
- 🌟 👤 [wszxl516](https://github.com/wszxl516) Starred [google/esh](https://github.com/google/esh)
  > UART based embedded shell for embedded systems. Intended to be used for learning, experimenting and ...
- 🌟 👤 [wszxl516](https://github.com/wszxl516) Starred [obra/superpowers](https://github.com/obra/superpowers)
  > An agentic skills framework & software development methodology that works.

### [wuxiaosu](https://github.com/wuxiaosu)
- 🌟 👤 [wuxiaosu](https://github.com/wuxiaosu) Starred [advanced-chat/vue-advanced-chat](https://github.com/advanced-chat/vue-advanced-chat)
  > A beautiful chat rooms web component compatible with all Javascript frameworks
- 🌟 👤 [wuxiaosu](https://github.com/wuxiaosu) Starred [soybeanjs/soybean-admin](https://github.com/soybeanjs/soybean-admin)
...
- 🌟 👤 [wy876](https://github.com/wy876) Starred [lyswhut/lx-music-desktop](https://github.com/lyswhut/lx-music-desktop)
  > 一个基于 Electron 的音乐软件
- 🌟 👤 [wy876](https://github.com/wy876) Starred [liuyunss/LX-source](https://github.com/liuyunss/LX-source)
  > 落雪播放源 - 洛雪音乐播放器配置源

### [xiandanin](https://github.com/xiandanin)
- 🌟 👤 [xiandanin](https://github.com/xiandanin) Starred [huangguang1999/ccstatusline-zh](https://github.com/huangguang1999/ccstatusline-zh)
  > ccstatusline 的中文汉化版 - Claude Code CLI 可定制状态栏格式化工具

### [xiaoweigege](https://github.com/xiaoweigege)
- 🌟 👤 [xiaoweigege](https://github.com/xiaoweigege) Starred [nukilabs/tlsclient](https://github.com/nukilabs/tlsclient)
  > http client with option to spoof tls, h2 and h3  fingerprint 
- 🌟 👤 [xiaoweigege](https://github.com/xiaoweigege) Starred [lingbol088-spec/ReiPenFlow](https://github.com/lingbol088-spec/ReiPenFlow)
  > Codex skill for local sandbox, CTF, authorized pentest and reverse-engineering workflows.

### [yanyaoli](https://github.com/yanyaoli)
- 🌟 👤 [yanyaoli](https://github.com/yanyaoli) Starred [P1kaj1uu/ChattyPlay-Agent](https://github.com/P1kaj1uu/ChattyPlay-Agent)
  > 🚀 告别多个App！本项目主要基于Python+React+TypeScript+Hono+SQLite3+Redis，打造“All in One”智能工具集。免会员破解爱奇艺、腾讯视频、优酷、抖音、...
- 🌟 👤 [yanyaoli](https://github.com/yanyaoli) Starred [amasen02/freshcart-backend](https://github.com/amasen02/freshcart-backend)
...
- 🌟 👤 [zhangyoufu](https://github.com/zhangyoufu) Starred [requestly/requestly](https://github.com/requestly/requestly)
...
- 🌟 👤 [zhanymkanov](https://github.com/zhanymkanov) Starred [emilkowalski/skills](https://github.com/emilkowalski/skills)
  > Skills for Design Engineers.
- 🌟 👤 [zhanymkanov](https://github.com/zhanymkanov) Starred [mattpocock/skills](https://github.com/mattpocock/skills)
  > Skills for Real Engineers. Straight from my .claude directory.

### [zhaotianff](https://github.com/zhaotianff)
- 🌟 👤 [zhaotianff](https://github.com/zhaotianff) Starred [LibRaw/LibRaw](https://github.com/LibRaw/LibRaw)
  > LibRaw is a library for reading RAW files from digital cameras
- 🌟 👤 [zhaotianff](https://github.com/zhaotianff) Starred [microsoft/mimalloc](https://github.com/microsoft/mimalloc)
  > mimalloc is a compact general purpose allocator with excellent performance.

### [zzzcccyyyggg](https://github.com/zzzcccyyyggg)
- 🌟 👤 [zzzcccyyyggg](https://github.com/zzzcccyyyggg) Starred [JailbrokenAI/wallbreaker](https://github.com/JailbrokenAI/wallbreaker)
- 🍴 👤 [zzzcccyyyggg](https://github.com/zzzcccyyyggg) Forked [JailbrokenAI/wallbreaker](https://github.com/JailbrokenAI/wallbreaker) to [zzzcccyyyggg/wallbreaker](https://github.com/zzzcccyyyggg/wallbreaker)
- 🌟 👤 [zzzcccyyyggg](https://github.com/zzzcccyyyggg) Starred [kernel-mastery/Kernel-Mastery](https://github.com/kernel-mastery/Kernel-Mastery)


---
*最后更新于 2026-07-10 23:57:08 UTC*
*历史记录保存在 `archive` 目录中。*
