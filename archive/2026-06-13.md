...
- 🌟 👤 [4ra1n](https://github.com/4ra1n) Starred [NVIDIA/SkillSpector](https://github.com/NVIDIA/SkillSpector)
  > Security scanner for AI agent skills. Detect vulnerabilities, malicious patterns, and security risks...
- 🌟 👤 [4ra1n](https://github.com/4ra1n) Starred [elder-plinius/CL4R1T4S](https://github.com/elder-plinius/CL4R1T4S)
...
- 🌟 👤 [Barre](https://github.com/Barre) Starred [seanmonstar/reqwest](https://github.com/seanmonstar/reqwest)
...
- 🍴 👤 [CyberCraftsmanx](https://github.com/CyberCraftsmanx) Forked [officialdedsec/-ExeShield-Advanced-Windows-EXE-Protector-Licensing](https://github.com/officialdedsec/-ExeShield-Advanced-Windows-EXE-Protector-Licensing) to [CyberCraftsmanx/-ExeShield-Advanced-Windows-EXE-Protector-Licensing](https://github.com/CyberCraftsmanx/-ExeShield-Advanced-Windows-EXE-Protector-Licensing)
  > ExeShield is a professional tool that protects any Windows executable (EXE) with hardware‑based lice...
...
- 🌟 👤 [DeLuks2006](https://github.com/DeLuks2006) Starred [19h/eac-analysis](https://github.com/19h/eac-analysis)
- 🌟 👤 [DeLuks2006](https://github.com/DeLuks2006) Starred [Aki2k/BEDaisy](https://github.com/Aki2k/BEDaisy)
  > reverse engineering of bedaisy.sys (battleyes kernel driver) - Aki2k/BEDaisy
- 🌟 👤 [DeLuks2006](https://github.com/DeLuks2006) Starred [mui/base-ui](https://github.com/mui/base-ui)
  > Unstyled UI components for building accessible web apps and design systems. From the creators of Rad...
...
- 🌟 👤 [FldBudin](https://github.com/FldBudin) Starred [DietrichGebert/ponytail](https://github.com/DietrichGebert/ponytail)
...
- 🌟 👤 [H3d9](https://github.com/H3d9) Starred [horsicq/Detect-It-Easy](https://github.com/horsicq/Detect-It-Easy)
...
- 🍴 👤 [ItsVixano](https://github.com/ItsVixano) Forked [LineageOS/android_kernel_qcom_sm8150](https://github.com/LineageOS/android_kernel_qcom_sm8150) to [essential-sm7150/android_kernel_essential_sm7150](https://github.com/essential-sm7150/android_kernel_essential_sm7150)

### [JunioJsv](https://github.com/JunioJsv)
- 🌟 👤 [JunioJsv](https://github.com/JunioJsv) Starred [redorav/hlslpp](https://github.com/redorav/hlslpp)
  > Math library using HLSL syntax with multiplatform SIMD support

### [KShChan](https://github.com/KShChan)
- 🌟 👤 [KShChan](https://github.com/KShChan) Starred [RikkaApps/Shizuku](https://github.com/RikkaApps/Shizuku)
...
- 🌟 👤 [L4ys](https://github.com/L4ys) Starred [Steam-Headless/docker-steam-headless](https://github.com/Steam-Headless/docker-steam-headless)
  > A Headless Steam Docker image supporting NVIDIA GPU and accessible via Web UI
- 🌟 👤 [L4ys](https://github.com/L4ys) Starred [kernelstub/Cognitor](https://github.com/kernelstub/Cognitor)
...
- 🍴 👤 [LunFengChen](https://github.com/LunFengChen) Forked [benedict2310/telecodex](https://github.com/benedict2310/telecodex) to [LunFengChen/tg-control-codex](https://github.com/LunFengChen/tg-control-codex)
  > Telegram bridge for the OpenAI Codex CLI SDK
- 🍴 👤 [LunFengChen](https://github.com/LunFengChen) Forked [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) to [LunFengChen/hermes-agent](https://github.com/LunFengChen/hermes-agent)
...
- 🌟 👤 [Monster-GM](https://github.com/Monster-GM) Starred [automate-it0/qualcomm-vulnerability-scanner](https://github.com/automate-it0/qualcomm-vulnerability-scanner)
  > A tool to scan Android devices for the recently exploited Qualcomm flaw CVE-2026-21385, providing a ...
- 🌟 👤 [Monster-GM](https://github.com/Monster-GM) Starred [michalbednarski/AbxOverflow](https://github.com/michalbednarski/AbxOverflow)
...
- 🌟 👤 [S3cur3Th1sSh1t](https://github.com/S3cur3Th1sSh1t) Starred [ar0x4/tunnel-vision-toolkit](https://github.com/ar0x4/tunnel-vision-toolkit)

### [Seyud](https://github.com/Seyud)
- 🌟 👤 [Seyud](https://github.com/Seyud) Starred [xingguangcuican6666/ABK](https://github.com/xingguangcuican6666/ABK)
  > AnyBase Kernel. To build GKI with your any idea!

### [Silentsoul04](https://github.com/Silentsoul04)
- 🌟 👤 [Silentsoul04](https://github.com/Silentsoul04) Starred [NVIDIA/SkillSpector](https://github.com/NVIDIA/SkillSpector)
  > Security scanner for AI agent skills. Detect vulnerabilities, malicious patterns, and security risks...
- 🍴 👤 [Silentsoul04](https://github.com/Silentsoul04) Forked [NVIDIA/SkillSpector](https://github.com/NVIDIA/SkillSpector) to [Silentsoul04/SkillSpector](https://github.com/Silentsoul04/SkillSpector)
  > Security scanner for AI agent skills. Detect vulnerabilities, malicious patterns, and security risks...
- 🌟 👤 [Silentsoul04](https://github.com/Silentsoul04) Starred [hahwul/smugglex](https://github.com/hahwul/smugglex)
  > Rust-powered HTTP Request Smuggling Scanner.
- 🌟 👤 [Silentsoul04](https://github.com/Silentsoul04) Starred [dry-abscess93/proof](https://github.com/dry-abscess93/proof)
  > Record and verify tamper-proof SHA-256 proof chains for AI decisions via MCP, SDK, or REST API, with...

### [SimonTheCoder](https://github.com/SimonTheCoder)
- 🌟 👤 [SimonTheCoder](https://github.com/SimonTheCoder) Starred [LMCache/LMCache](https://github.com/LMCache/LMCache)
  > LMCache: Supercharge Your LLM with the Fastest KV Cache Layer

### [Sndav](https://github.com/Sndav)
- 🌟 👤 [Sndav](https://github.com/Sndav) Starred [atomiczsec/Noradrenaline](https://github.com/atomiczsec/Noradrenaline)
  > Offensive macOS and Linux shared library modules for Poseidon and other agent frameworks. Designed t...

### [SodaMilk233](https://github.com/SodaMilk233)
- 🌟 👤 [SodaMilk233](https://github.com/SodaMilk233) Starred [sinspired/CF-Proxy](https://github.com/sinspired/CF-Proxy)
  > 简单而功能强大的反代服务，允许你将一个网址映射到另一个网址，并处理跨域请求和github api速率限制
- 🌟 👤 [SodaMilk233](https://github.com/SodaMilk233) Starred [zsqw123/CatReflect](https://github.com/zsqw123/CatReflect)
  > Greatly simplifies the complexities of Kotlin's reflection of Java. 极大简化 Kotlin 反射 Java 的复杂操作。
- 🌟 👤 [SodaMilk233](https://github.com/SodaMilk233) Starred [rover12421/PhoenixReflect](https://github.com/rover12421/PhoenixReflect)
  > Kotlin 写的一个反射库
...
- 🌟 👤 [SodaMilk233](https://github.com/SodaMilk233) Starred [maboloshi/github-chinese](https://github.com/maboloshi/github-chinese)
  > GitHub 汉化插件，GitHub 中文化界面。 (GitHub Translation To Chinese)
- 🌟 👤 [SodaMilk233](https://github.com/SodaMilk233) Starred [gemini-cli-extensions/jules](https://github.com/gemini-cli-extensions/jules)
  > A Gemini CLI extension that allows you to use the Gemini CLI to orchestrate the Jules asynchronous a...
- 🌟 👤 [SodaMilk233](https://github.com/SodaMilk233) Starred [jeremychone/zcoder](https://github.com/jeremychone/zcoder)
  > AI coding CLI — very early stage
- 🌟 👤 [SodaMilk233](https://github.com/SodaMilk233) Starred [XiaomiMiMo/MiMo-Code](https://github.com/XiaomiMiMo/MiMo-Code)
...
- 🌟 👤 [YuKongA](https://github.com/YuKongA) Starred [JetBrains/markdown](https://github.com/JetBrains/markdown)
...
- 🌟 👤 [androidmalin](https://github.com/androidmalin) Starred [plannotator/effective-html](https://github.com/plannotator/effective-html)
...
- 🌟 👤 [ba0gu0](https://github.com/ba0gu0) Starred [EnesKaraosman/SwiftyChat](https://github.com/EnesKaraosman/SwiftyChat)
  > A lightweight SwiftUI chat UI framework with 11 built-in message types, 8 themes, and cross-platform...
- 🌟 👤 [ba0gu0](https://github.com/ba0gu0) Starred [GetStream/stream-chat-swift-ai](https://github.com/GetStream/stream-chat-swift-ai)
- 🌟 👤 [ba0gu0](https://github.com/ba0gu0) Starred [oasisfeng/island](https://github.com/oasisfeng/island)
  > Island for Android
- 🌟 👤 [ba0gu0](https://github.com/ba0gu0) Starred [jmmy9609-design/gpt-pp](https://github.com/jmmy9609-design/gpt-pp)
...
- 🌟 👤 [cctv18](https://github.com/cctv18) Starred [pol-rivero/github-desktop-plus](https://github.com/pol-rivero/github-desktop-plus)
  > A GitHub Desktop fork with advanced functionality and Bitbucket, GitLab integration.

### [codezjx](https://github.com/codezjx)
- 🌟 👤 [codezjx](https://github.com/codezjx) Starred [addyosmani/agent-skills](https://github.com/addyosmani/agent-skills)
  > Production-grade engineering skills for AI coding agents.

### [ctkqiang](https://github.com/ctkqiang)
- 🌟 👤 [ctkqiang](https://github.com/ctkqiang) Starred [klionsec/RedTeamer](https://github.com/klionsec/RedTeamer)
  > 红方人员作战执行手册
- 🌟 👤 [ctkqiang](https://github.com/ctkqiang) Starred [elder-plinius/CL4R1T4S](https://github.com/elder-plinius/CL4R1T4S)
  > LEAKED SYSTEM PROMPTS FOR CHATGPT, CLAUDE, GEMINI, GROK, PERPLEXITY, CURSOR, LOVABLE, REPLIT, AND MO...
- 🌟 👤 [ctkqiang](https://github.com/ctkqiang) Starred [spring-projects/spring-ai](https://github.com/spring-projects/spring-ai)
  > An Application Framework for AI Engineering
- 🍴 👤 [ctkqiang](https://github.com/ctkqiang) Forked [spring-projects/spring-ai](https://github.com/spring-projects/spring-ai) to [ctkqiang/spring-ai](https://github.com/ctkqiang/spring-ai)
  > An Application Framework for AI Engineering
- 🌟 👤 [ctkqiang](https://github.com/ctkqiang) Starred [jwangkun/claude-for-financial-services-cn](https://github.com/jwangkun/claude-for-financial-services-cn)
  >  63 个 Claude Skills，为 A 股金融从业者而生  基于 Anthropic 官方 claude-for-financial-services 深度适配国内市场，现已开源。
- 🍴 👤 [ctkqiang](https://github.com/ctkqiang) Forked [jwangkun/claude-for-financial-services-cn](https://github.com/jwangkun/claude-for-financial-services-cn) to [ctkqiang/claude-for-financial-services-cn](https://github.com/ctkqiang/claude-for-financial-services-cn)
  >  63 个 Claude Skills，为 A 股金融从业者而生  基于 Anthropic 官方 claude-for-financial-services 深度适配国内市场，现已开源。
- 🌟 👤 [ctkqiang](https://github.com/ctkqiang) Starred [siddharthvaddem/openscreen](https://github.com/siddharthvaddem/openscreen)
...
- 🍴 👤 [dbalsom](https://github.com/dbalsom) Forked [schlae/graphics-gremlin](https://github.com/schlae/graphics-gremlin) to [dbalsom/graphics-gremlin](https://github.com/dbalsom/graphics-gremlin)
  > Open source retro ISA video card

### [doronz88](https://github.com/doronz88)
- 🌟 👤 [doronz88](https://github.com/doronz88) Starred [verback2308/YTLite](https://github.com/verback2308/YTLite)
  > A lightweight, privacy-focused YouTube client for iOS built entirely with UIKit. No ads, no tracking...
...
- 🍴 👤 [eggfly](https://github.com/eggfly) Forked [Web3-Pi/Web3-Pi-UPS](https://github.com/Web3-Pi/Web3-Pi-UPS) to [eggfly/Web3-Pi-UPS](https://github.com/eggfly/Web3-Pi-UPS)
  > Open-source DC UPS for Raspberry Pi 5 — USB-PD 27W, Sony NP-F batteries, OLED display, 3D-printed en...

### [elllusion](https://github.com/elllusion)
- 🌟 👤 [elllusion](https://github.com/elllusion) Starred [jashking/UnrealPakViewer](https://github.com/jashking/UnrealPakViewer)
...
- 🌟 👤 [fei-ke](https://github.com/fei-ke) Starred [giscus/giscus](https://github.com/giscus/giscus)
...
- 🍴 👤 [feicong](https://github.com/feicong) Forked [chickendrop89/hyperos-accessibility-fix](https://github.com/chickendrop89/hyperos-accessibility-fix) to [feicong/hyperos-accessibility-fix](https://github.com/feicong/hyperos-accessibility-fix)
  > Stop HyperOS from randomly disabling accessibillity services
- 🌟 👤 [feicong](https://github.com/feicong) Starred [TouchFriend/MonkeyDev](https://github.com/TouchFriend/MonkeyDev)
  > CaptainHook Tweak、Logos Tweak and Command-line Tool、Patch iOS Apps,  Without Jailbreak.
- 🍴 👤 [feicong](https://github.com/feicong) Forked [TouchFriend/MonkeyDev](https://github.com/TouchFriend/MonkeyDev) to [feicong/MonkeyDev](https://github.com/feicong/MonkeyDev)
  > CaptainHook Tweak、Logos Tweak and Command-line Tool、Patch iOS Apps,  Without Jailbreak.

### [fengchenzxc](https://github.com/fengchenzxc)
- 🌟 👤 [fengchenzxc](https://github.com/fengchenzxc) Starred [op7418/guizang-social-card-skill](https://github.com/op7418/guizang-social-card-skill)
...
- 🌟 👤 [g0th1c54e4](https://github.com/g0th1c54e4) Starred [elder-plinius/CL4R1T4S](https://github.com/elder-plinius/CL4R1T4S)
  > LEAKED SYSTEM PROMPTS FOR CHATGPT, CLAUDE, GEMINI, GROK, PERPLEXITY, CURSOR, LOVABLE, REPLIT, AND MO...
- 🌟 👤 [g0th1c54e4](https://github.com/g0th1c54e4) Starred [farion1231/cc-switch](https://github.com/farion1231/cc-switch)
  > A cross-platform desktop All-in-One assistant for Claude Code, Codex, OpenCode, OpenClaw, Gemini CLI...
- 🌟 👤 [g0th1c54e4](https://github.com/g0th1c54e4) Starred [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent)
  > The agent that grows with you
- 🌟 👤 [g0th1c54e4](https://github.com/g0th1c54e4) Starred [dair-ai/Prompt-Engineering-Guide](https://github.com/dair-ai/Prompt-Engineering-Guide)
  > 🐙 Guides, papers, lessons, notebooks and resources for prompt engineering, context engineering, RAG,...
- 🌟 👤 [g0th1c54e4](https://github.com/g0th1c54e4) Starred [colbymchenry/codegraph](https://github.com/colbymchenry/codegraph)
  > Pre-indexed code knowledge graph, auto syncs on code changes, for Claude Code, Codex, Gemini, Cursor...

### [gmh5225](https://github.com/gmh5225)
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [techjarves/USB-Uncensored-LLM](https://github.com/techjarves/USB-Uncensored-LLM) to [gmh5225/USB-Uncensored-LLM](https://github.com/gmh5225/USB-Uncensored-LLM)
  > The ultimate zero-install, portable local AI environment. Run high-quality, uncensored LLMs (Gemma, ...
...
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [Kosmokleaner/RapidPicoC](https://github.com/Kosmokleaner/RapidPicoC) to [gmh5225/RapidPicoC](https://github.com/gmh5225/RapidPicoC)
...
- 🌟 👤 [hanbings](https://github.com/hanbings) Starred [numtide/llm-agents.nix](https://github.com/numtide/llm-agents.nix)
...
- 🌟 👤 [hhhaiai](https://github.com/hhhaiai) Starred [a63414262/CF-Server-Monitor-Pro](https://github.com/a63414262/CF-Server-Monitor-Pro)
  > 基于 Cloudflare Workers 和 D1 数据库构建的轻量级、零成本、高定制化的服务器探针大盘。 完美复刻了商业级探针的核心体验，但无需额外部署任何服务端 VPS！完全白嫖 Cloudfl...
- 🌟 👤 [hhhaiai](https://github.com/hhhaiai) Starred [huilang-me/CF-Server-Monitor](https://github.com/huilang-me/CF-Server-Monitor)
- 🌟 👤 [hhhaiai](https://github.com/hhhaiai) Starred [strongshuai/chatgpt2api-proxy-pool](https://github.com/strongshuai/chatgpt2api-proxy-pool)
  > chatgpt2api enhanced with proxy URL pool rotation for registration
- 🌟 👤 [hhhaiai](https://github.com/hhhaiai) Starred [strongshuai/proxy-checker](https://github.com/strongshuai/proxy-checker)
...
- 🌟 👤 [hyuunnn](https://github.com/hyuunnn) Starred [h5py/h5py](https://github.com/h5py/h5py)
  > HDF5 for Python -- The h5py package is a Pythonic interface to the HDF5 binary data format.
- 🌟 👤 [hyuunnn](https://github.com/hyuunnn) Starred [onnx/onnx](https://github.com/onnx/onnx)
  > Open standard for machine learning interoperability
- 🌟 👤 [hyuunnn](https://github.com/hyuunnn) Starred [nltk/nltk](https://github.com/nltk/nltk)
  > NLTK Source
- 🌟 👤 [hyuunnn](https://github.com/hyuunnn) Starred [jupyter/jupyter](https://github.com/jupyter/jupyter)
  > Jupyter metapackage for installation and documentation
- 🌟 👤 [hyuunnn](https://github.com/hyuunnn) Starred [elastic/elasticsearch-py](https://github.com/elastic/elasticsearch-py)
  > Official Python client for Elasticsearch
- 🌟 👤 [hyuunnn](https://github.com/hyuunnn) Starred [PyMySQL/PyMySQL](https://github.com/PyMySQL/PyMySQL)
  > MySQL client library for Python
- 🌟 👤 [hyuunnn](https://github.com/hyuunnn) Starred [bentoml/BentoML](https://github.com/bentoml/BentoML)
  > The easiest way to serve AI apps and models - Build Model Inference APIs, Job queues, LLM apps, Mult...
- 🌟 👤 [hyuunnn](https://github.com/hyuunnn) Starred [FoundationAgents/MetaGPT](https://github.com/FoundationAgents/MetaGPT)
  > 🌟 The Multi-Agent Framework: First AI Software Company, Towards Natural Language Programming
- 🌟 👤 [hyuunnn](https://github.com/hyuunnn) Starred [PrefectHQ/prefect](https://github.com/PrefectHQ/prefect)
  > Prefect is a workflow orchestration framework for building resilient data pipelines in Python.
- 🌟 👤 [hyuunnn](https://github.com/hyuunnn) Starred [huggingface/smolagents](https://github.com/huggingface/smolagents)
...
- 🌟 👤 [hyuunnn](https://github.com/hyuunnn) Starred [kernelstub/Ferrum](https://github.com/kernelstub/Ferrum)
...
- 🌟 👤 [iAklis](https://github.com/iAklis) Starred [tensorlakeai/tensorlake](https://github.com/tensorlakeai/tensorlake)
...
- 🌟 👤 [jianglin-code](https://github.com/jianglin-code) Starred [NiuTrans/NLPBook](https://github.com/NiuTrans/NLPBook)
  > A comprehensive book on neural networks and large language models in NLP

### [jmpews](https://github.com/jmpews)
- 🌟 👤 [jmpews](https://github.com/jmpews) Starred [HexRaysSA/rax](https://github.com/HexRaysSA/rax)
  > rax is a CPU emulator that does not trust itself.
...
- 🌟 👤 [kasnria001](https://github.com/kasnria001) Starred [mt798x-platform/arm-trusted-firmware-mtk](https://github.com/mt798x-platform/arm-trusted-firmware-mtk)
  > Trusted Firmware-A for MediaTek ApSoCs
- 🌟 👤 [kasnria001](https://github.com/kasnria001) Starred [cuu/SP-Flash-Tool-src](https://github.com/cuu/SP-Flash-Tool-src)

### [kernelwernel](https://github.com/kernelwernel)
- 🌟 👤 [kernelwernel](https://github.com/kernelwernel) Starred [uhhdexz/illusion-rs](https://github.com/uhhdexz/illusion-rs)
  > Rusty Hypervisor - Windows UEFI Blue Pill Type-1 Hypervisor in Rust (Codename: Illusion)

### [kernullist](https://github.com/kernullist)
- 🌟 👤 [kernullist](https://github.com/kernullist) Starred [ShareX/ShareX](https://github.com/ShareX/ShareX)
...
- 🌟 👤 [kinginu](https://github.com/kinginu) Starred [Kovelja009/gsplat_tt](https://github.com/Kovelja009/gsplat_tt)
  > Port of Gaussian Splatting to Tenstorrent

### [kingking888](https://github.com/kingking888)
- 🌟 👤 [kingking888](https://github.com/kingking888) Starred [Legrandin/pycryptodome](https://github.com/Legrandin/pycryptodome)
  > A self-contained cryptographic library for Python
- 🌟 👤 [kingking888](https://github.com/kingking888) Starred [G5t4r/WeProtocol](https://github.com/G5t4r/WeProtocol)
  > 微信ipad协议，五端登录版本

### [konieshadow](https://github.com/konieshadow)
- 🌟 👤 [konieshadow](https://github.com/konieshadow) Starred [espressif/esp-idf](https://github.com/espressif/esp-idf)
  > Espressif IoT Development Framework. Official development framework for Espressif SoCs.

### [laozig](https://github.com/laozig)
- 🌟 👤 [laozig](https://github.com/laozig) Starred [HW-whistleblower/True-Story-of-Pangu](https://github.com/HW-whistleblower/True-Story-of-Pangu)
  > 诺亚盘古大模型研发背后的真正的心酸与黑暗的故事。

### [lich4](https://github.com/lich4)
- 🌟 👤 [lich4](https://github.com/lich4) Starred [reconurge/flowsint](https://github.com/reconurge/flowsint)
  > A modern platform for visual, flexible, and extensible graph-based investigations. For cybersecurity...
- 🌟 👤 [lich4](https://github.com/lich4) Starred [Thysrael/Horizon](https://github.com/Thysrael/Horizon)
  > 📡 Your own AI-powered news radar. Generates daily briefings in English & Chinese. | 用 AI 构建你专属的新闻雷达
- 🌟 👤 [lich4](https://github.com/lich4) Starred [sstklen/trump-code](https://github.com/sstklen/trump-code)
  > 🔐 AI decoding Trump's posts × stock market | AI 解碼川普推文 × 美股 | AIでトランプ投稿×株式市場を解読 — 31.5M models, 61.3...

### [linuxmobile](https://github.com/linuxmobile)
- 🌟 👤 [linuxmobile](https://github.com/linuxmobile) Starred [projectdiscovery/depx](https://github.com/projectdiscovery/depx)
  > Malicious package & supply-chain intelligence

### [linxid](https://github.com/linxid)
- 🌟 👤 [linxid](https://github.com/linxid) Starred [nolangz/pixel2motion](https://github.com/nolangz/pixel2motion)
...
- 🌟 👤 [lixeon](https://github.com/lixeon) Starred [fengshao1227/ccg-workflow](https://github.com/fengshao1227/ccg-workflow)
  > 多模型协作工作流引擎 — /ccg:go 一个命令，AI 自动分析意图、选择策略、编排 Codex + Gemini + Claude 协作执行
- 🌟 👤 [lixeon](https://github.com/lixeon) Starred [jamiepine/voicebox](https://github.com/jamiepine/voicebox)
  > The open-source AI voice studio. Clone, dictate, create.

### [lizhangqu](https://github.com/lizhangqu)
- 🌟 👤 [lizhangqu](https://github.com/lizhangqu) Starred [kadevin/ilab-gpt-conjure](https://github.com/kadevin/ilab-gpt-conjure)
...
- 🌟 👤 [llsc12](https://github.com/llsc12) Starred [adoravel/converse](https://github.com/adoravel/converse)
  > A minimal, client-side Minecraft mod focused on improving the chat experience

### [ltttttttttttt](https://github.com/ltttttttttttt)
- 🌟 👤 [ltttttttttttt](https://github.com/ltttttttttttt) Starred [XiaomiMiMo/MiMo-Code](https://github.com/XiaomiMiMo/MiMo-Code)

### [lz6688](https://github.com/lz6688)
- 🍴 👤 [lz6688](https://github.com/lz6688) Forked [zhizhuodemao/js-reverse-mcp](https://github.com/zhizhuodemao/js-reverse-mcp) to [lz6688/js-reverse-mcp](https://github.com/lz6688/js-reverse-mcp)
...
- 🍴 👤 [mahmoudimus](https://github.com/mahmoudimus) Forked [cnu-ants/DeFFai](https://github.com/cnu-ants/DeFFai) to [mahmoudimus/DeFFai](https://github.com/mahmoudimus/DeFFai)
...
- 🌟 👤 [moonD4rk](https://github.com/moonD4rk) Starred [indexmap-rs/indexmap](https://github.com/indexmap-rs/indexmap)
  > A hash table with consistent order and fast iteration; access items by key or sequence index

### [mos9527](https://github.com/mos9527)
- 🌟 👤 [mos9527](https://github.com/mos9527) Starred [otya128/winevdm](https://github.com/otya128/winevdm)
...
- 🌟 👤 [natsumerinchan](https://github.com/natsumerinchan) Starred [StellarRach/Counter-Strike-Augmented-Edition](https://github.com/StellarRach/Counter-Strike-Augmented-Edition)
  > Counter-Strike Augmented Edition public repository

### [nblog](https://github.com/nblog)
- 🌟 👤 [nblog](https://github.com/nblog) Starred [alibaba/webmcp-nexus](https://github.com/alibaba/webmcp-nexus)
  > 面向 WebMCP 标准的非侵入式前端集成套件：写一个普通 TS 函数加一段 JSDoc，即可被任意 MCP 客户端调用 —— 含 SDK、Vite/Webpack 插件与 AI 编码 Skill。

### [null-dev](https://github.com/null-dev)
- 🌟 👤 [null-dev](https://github.com/null-dev) Starred [SickleFire/m-vis](https://github.com/SickleFire/m-vis)
  > lightweight cross-platform memory visualizer tool
- 🌟 👤 [null-dev](https://github.com/null-dev) Starred [hypen-lang/hypen](https://github.com/hypen-lang/hypen)
  > Hypen  - crossplatform UI framework for Rust, TS, Go, Kotlin, Swift and more
- 🌟 👤 [null-dev](https://github.com/null-dev) Starred [Prowlarr/Prowlarr](https://github.com/Prowlarr/Prowlarr)
  > Prowlarr is an indexer manager/proxy built on the popular *arr .net/reactjs base stack to integrate ...
- 🌟 👤 [null-dev](https://github.com/null-dev) Starred [Latias94/merman](https://github.com/Latias94/merman)
  > Mermaid.js, but headless, in Rust.
- 🌟 👤 [null-dev](https://github.com/null-dev) Starred [clld/glottolog3](https://github.com/clld/glottolog3)
  > glottolog2 re-implemented as CLLD app
- 🌟 👤 [null-dev](https://github.com/null-dev) Starred [clld/clld](https://github.com/clld/clld)
  > A web framework to display Cross Linguistic Linked Data.

### [oblique](https://github.com/oblique)
- 🌟 👤 [oblique](https://github.com/oblique) Starred [lenucksi/aur-malware-check](https://github.com/lenucksi/aur-malware-check)
...
- 🌟 👤 [omeraydindev](https://github.com/omeraydindev) Starred [fguzman82/gateGPT](https://github.com/fguzman82/gateGPT)
  > Full Transformer into a custom chip. microGPT in RTL, generating names on a Virtex-5 FPGA at ~56k to...
- 🌟 👤 [omeraydindev](https://github.com/omeraydindev) Starred [open-webui/open-webui](https://github.com/open-webui/open-webui)
  > User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
- 🌟 👤 [omeraydindev](https://github.com/omeraydindev) Starred [cogwheel0/conduit](https://github.com/cogwheel0/conduit)
  > Mobile (iOS/Android) client for OpenWebUI. Chat with your self‑hosted AI.

### [phith0n](https://github.com/phith0n)
- 🌟 👤 [phith0n](https://github.com/phith0n) Starred [reviewdog/reviewdog](https://github.com/reviewdog/reviewdog)
...
- 🌟 👤 [ravindu644](https://github.com/ravindu644) Starred [superturtlee/anland](https://github.com/superturtlee/anland)
...
- 🚀 👤 [rmuxnet](https://github.com/rmuxnet) Made [rmuxnet/ps-wifi-speedtest](https://github.com/rmuxnet/ps-wifi-speedtest) public
...
- 🌟 👤 [rogxo](https://github.com/rogxo) Starred [carlos-al/user-kernel-syscall-hook](https://github.com/carlos-al/user-kernel-syscall-hook)

### [s5uishida](https://github.com/s5uishida)
- 🌟 👤 [s5uishida](https://github.com/s5uishida) Starred [parttimenerd/hello-ebpf](https://github.com/parttimenerd/hello-ebpf)
  > Hello eBPF world! Hello Java world! Let's discover eBPF together and write Java user-land library al...
...
- 🌟 👤 [smallevilbeast](https://github.com/smallevilbeast) Starred [holzschu/cpython](https://github.com/holzschu/cpython)
  > The Python programming language
- 🌟 👤 [smallevilbeast](https://github.com/smallevilbeast) Starred [holzschu/python3_ios](https://github.com/holzschu/python3_ios)
...
- 🌟 👤 [stuxnet147](https://github.com/stuxnet147) Starred [wesmar/BootBypass](https://github.com/wesmar/BootBypass)
...
- 🌟 👤 [su-vikas](https://github.com/su-vikas) Starred [xoureldeen/Vectras-VM-Android](https://github.com/xoureldeen/Vectras-VM-Android)
  > It's a Virtual Machine App for Android Which is Based on QEMU

### [suifei](https://github.com/suifei)
- 🌟 👤 [suifei](https://github.com/suifei) Starred [TinyRetroWarehouse/wcdctool](https://github.com/TinyRetroWarehouse/wcdctool)
  > Watcom Decompilation Tool (wcdctool)
- 🌟 👤 [suifei](https://github.com/suifei) Starred [fonic/wcdatool](https://github.com/fonic/wcdatool)
  > Watcom Disassembly Tool (wcdatool) - Tool to aid disassembling DOS applications created with the Wat...
- 🌟 👤 [suifei](https://github.com/suifei) Starred [jaceju-game-books/fd2](https://github.com/jaceju-game-books/fd2)
  > 重新編排《炎龍騎士團2圖文攻略 - 青衫的圖文攻略集》，以便讀者觀看。原文網址： http://blog.yam.com/chiuinan/article/73505154 
- 🌟 👤 [suifei](https://github.com/suifei) Starred [skywind3000/GONGLUE](https://github.com/skywind3000/GONGLUE)
  > 单机游戏攻略秘籍（1580+ 篇）
...
- 🌟 👤 [totravel](https://github.com/totravel) Starred [datawhalechina/happy-llm](https://github.com/datawhalechina/happy-llm)
  > 📚 从零开始构建大模型
- 🌟 👤 [totravel](https://github.com/totravel) Starred [Lordog/dive-into-llms](https://github.com/Lordog/dive-into-llms)
  > 《动手学大模型Dive into LLMs》系列编程实践教程
- 🌟 👤 [totravel](https://github.com/totravel) Starred [jingyaogong/minimind-v](https://github.com/jingyaogong/minimind-v)
  > 👀「大模型」2小时从0训练65M参数的视觉多模态VLM！Train a 65M-parameter VLM from scratch in just 2h! 

### [vngkv123](https://github.com/vngkv123)
- 🌟 👤 [vngkv123](https://github.com/vngkv123) Starred [bkerler/ida_rpc](https://github.com/bkerler/ida_rpc)
  > IDA Pro RPC for assisted RE-tasks

### [wszxl516](https://github.com/wszxl516)
- 🌟 👤 [wszxl516](https://github.com/wszxl516) Starred [momo5502/sogen](https://github.com/momo5502/sogen)
  > 🪅 Windows & Linux userspace emulator 
- 🌟 👤 [wszxl516](https://github.com/wszxl516) Starred [google/flatbuffers](https://github.com/google/flatbuffers)
  > FlatBuffers: Memory Efficient Serialization Library

### [wwh1004](https://github.com/wwh1004)
- 🌟 👤 [wwh1004](https://github.com/wwh1004) Starred [bats3c/DarkLoadLibrary](https://github.com/bats3c/DarkLoadLibrary)
  > LoadLibrary for offensive operations
- 🌟 👤 [wwh1004](https://github.com/wwh1004) Starred [wwh1004/inline-execute-all](https://github.com/wwh1004/inline-execute-all)
  > Sophisticated In-Memory PE loader for Cobalt Strike

### [xiaobutiaoer](https://github.com/xiaobutiaoer)
- 🌟 👤 [xiaobutiaoer](https://github.com/xiaobutiaoer) Starred [XBuilderLAB/cheat-on-money](https://github.com/XBuilderLAB/cheat-on-money)
  > AI 时代靠谱兼职发现 + 反诈验证 skill：需求信号反推 + 实时时效核查 + 反诈 rubric + 个性化校准环

### [xiaotujinbnb](https://github.com/xiaotujinbnb)
- 🌟 👤 [xiaotujinbnb](https://github.com/xiaotujinbnb) Starred [elder-plinius/CL4R1T4S](https://github.com/elder-plinius/CL4R1T4S)
  > LEAKED SYSTEM PROMPTS FOR CHATGPT, CLAUDE, GEMINI, GROK, PERPLEXITY, CURSOR, LOVABLE, REPLIT, AND MO...
- 🍴 👤 [xiaotujinbnb](https://github.com/xiaotujinbnb) Forked [elder-plinius/CL4R1T4S](https://github.com/elder-plinius/CL4R1T4S) to [xiaotujinbnb/CL4R1T4S](https://github.com/xiaotujinbnb/CL4R1T4S)
  > LEAKED SYSTEM PROMPTS FOR CHATGPT, CLAUDE, GEMINI, GROK, PERPLEXITY, CURSOR, LOVABLE, REPLIT, AND MO...

### [xiaoweigege](https://github.com/xiaoweigege)
- 🍴 👤 [xiaoweigege](https://github.com/xiaoweigege) Forked [xKiian/datadome-vm](https://github.com/xKiian/datadome-vm) to [xiaoweigege/datadome-vm](https://github.com/xiaoweigege/datadome-vm)
  > Reverse engineering the new Datadome VM 🔥
- 🌟 👤 [xiaoweigege](https://github.com/xiaoweigege) Starred [B00H0O/kasada-vm](https://github.com/B00H0O/kasada-vm)
...
- 🌟 👤 [yohanes](https://github.com/yohanes) Starred [rooootdev/lara](https://github.com/rooootdev/lara)
...
- 🌟 👤 [zhanghecn](https://github.com/zhanghecn) Starred [SciPhi-AI/agent-search](https://github.com/SciPhi-AI/agent-search)
  > AgentSearch is a framework for powering search agents and enabling customizable local search.
- 🌟 👤 [zhanghecn](https://github.com/zhanghecn) Starred [Panniantong/Agent-Reach](https://github.com/Panniantong/Agent-Reach)
...
- 🌟 👤 [zhaoxuya520](https://github.com/zhaoxuya520) Starred [pood1e/wa-app](https://github.com/pood1e/wa-app)
- 🍴 👤 [zhaoxuya520](https://github.com/zhaoxuya520) Forked [pood1e/wa-app](https://github.com/pood1e/wa-app) to [zhaoxuya520/wa-app](https://github.com/zhaoxuya520/wa-app)
