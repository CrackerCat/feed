...
- 🌟 👤 [SherlockChiang](https://github.com/SherlockChiang) Starred [notxx/MiPushZygisk](https://github.com/notxx/MiPushZygisk)
  > 一个 Zygisk 模块，为应用伪装小米设备，以便使用 MiPush

### [SoyBeanMilkx](https://github.com/SoyBeanMilkx)
- 🌟 👤 [SoyBeanMilkx](https://github.com/SoyBeanMilkx) Starred [Jeric-X/SyncClipboard](https://github.com/Jeric-X/SyncClipboard)
  > 跨平台剪贴板同步、历史记录管理工具 / Cross-platform cipboard syncing, history management tool
- 🌟 👤 [SoyBeanMilkx](https://github.com/SoyBeanMilkx) Starred [jacksen168sub/SyncClipboard-Android](https://github.com/jacksen168sub/SyncClipboard-Android)
  > 基于SyncClipboard api开发的安卓版本
...
- 🌟 👤 [ravindu644](https://github.com/ravindu644) Starred [oliplusmzr/Sim_Fix_For_G99](https://github.com/oliplusmzr/Sim_Fix_For_G99)
  > Sim_Fix_For_G99
- ✨ 👤 [ravindu644](https://github.com/ravindu644) Created new repo [ravindu644/THE_DETECTIVE](https://github.com/ravindu644/THE_DETECTIVE)
  > A tool to detect changes in a "ported ROM" by analyzing it against the base ROM used for the port an...
...
- 🌟 👤 [zzzcccyyyggg](https://github.com/zzzcccyyyggg) Starred [xairy/linux-kernel-exploitation](https://github.com/xairy/linux-kernel-exploitation)
  > A collection of links related to Linux kernel security and exploitation
- 🌟 👤 [zzzcccyyyggg](https://github.com/zzzcccyyyggg) Starred [shardulsb08/prana_kernel_testing](https://github.com/shardulsb08/prana_kernel_testing)
- 🌟 👤 [zzzcccyyyggg](https://github.com/zzzcccyyyggg) Starred [seclab-ucr/SyzGenPlusPlus](https://github.com/seclab-ucr/SyzGenPlusPlus)


---
*最后更新于 2025-09-21 23:39:06 UTC*
*历史记录保存在 `archive` 目录中。*
