...
- 🌟 👤 [10code15bugs](https://github.com/10code15bugs) Starred [FANzR-arch/Numerologist_skills](https://github.com/FANzR-arch/Numerologist_skills)
  > 🔮 An engineering framework to stop LLM hallucinations in Chinese astrology. / 给“赛博半仙”戴上紧箍咒：减少幻觉、固定排盘...
...
- 🌟 👤 [AlSch092](https://github.com/AlSch092) Starred [sensepost/pipetap](https://github.com/sensepost/pipetap)
...
- 🌟 👤 [AnkioTomas](https://github.com/AnkioTomas) Starred [WankkoRee/WebViewPP](https://github.com/WankkoRee/WebViewPP)
  > Enable WebView debugging and add vConsole in it. Support WebView, TBS X5, UC U4, Crosswalk(XWalk), X...

### [Ascotbe](https://github.com/Ascotbe)
- 🌟 👤 [Ascotbe](https://github.com/Ascotbe) Starred [obra/superpowers](https://github.com/obra/superpowers)
  > An agentic skills framework & software development methodology that works.

### [BestBurning](https://github.com/BestBurning)
- 🍴 👤 [BestBurning](https://github.com/BestBurning) Forked [cmliu/CF-Workers-docker.io](https://github.com/cmliu/CF-Workers-docker.io) to [BestBurning/CF-Workers-docker.io](https://github.com/BestBurning/CF-Workers-docker.io)
...
- 🌟 👤 [DarkFunct](https://github.com/DarkFunct) Starred [kyegomez/OpenMythos](https://github.com/kyegomez/OpenMythos)
...
- 🌟 👤 [DeEpinGh0st](https://github.com/DeEpinGh0st) Starred [xjzhi/MPScan](https://github.com/xjzhi/MPScan)
...
- 🌟 👤 [Escapingbug](https://github.com/Escapingbug) Starred [burggraf/pi-teams](https://github.com/burggraf/pi-teams)
...
- 🌟 👤 [FldBudin](https://github.com/FldBudin) Starred [joeseesun/qiaomu-anything-to-notebooklm](https://github.com/joeseesun/qiaomu-anything-to-notebooklm)
...
- 🌟 👤 [FunnyWolf](https://github.com/FunnyWolf) Starred [webadderall/Recordly](https://github.com/webadderall/Recordly)
...
- 🌟 👤 [Gracker](https://github.com/Gracker) Starred [affaan-m/everything-claude-code](https://github.com/affaan-m/everything-claude-code)
...
- 🍴 👤 [ItsVixano](https://github.com/ItsVixano) Forked [LineageOS/android_device_xiaomi_mars](https://github.com/LineageOS/android_device_xiaomi_mars) to [xiaomi-lisa-devs/android_device_xiaomi_mars](https://github.com/xiaomi-lisa-devs/android_device_xiaomi_mars)

### [J0o1ey](https://github.com/J0o1ey)
- 🌟 👤 [J0o1ey](https://github.com/J0o1ey) Starred [oritera/Cairn](https://github.com/oritera/Cairn)
  > AI 自动化通用问题解决 / AI 自动化渗透测试系统
- 🌟 👤 [J0o1ey](https://github.com/J0o1ey) Starred [semgrep/skills](https://github.com/semgrep/skills)
  > A collection of skills for AI coding agents from Semgrep

### [KHwang9883](https://github.com/KHwang9883)
- 🌟 👤 [KHwang9883](https://github.com/KHwang9883) Starred [ram0ng1/avocado](https://github.com/ram0ng1/avocado)
  > Avocado — A modern and highly customizable Flarum theme
- 🌟 👤 [KHwang9883](https://github.com/KHwang9883) Starred [yannisme/flarum-oxo-theme](https://github.com/yannisme/flarum-oxo-theme)
  > Flarum Theme OXO , Card-style themes

### [KpLi0rn](https://github.com/KpLi0rn)
- 🌟 👤 [KpLi0rn](https://github.com/KpLi0rn) Starred [stanford-iris-lab/meta-harness-tbench2-artifact](https://github.com/stanford-iris-lab/meta-harness-tbench2-artifact)
  > Meta-Harness: 76.4% on Terminal-Bench 2.0 (Claude Opus 4.6)
- 🌟 👤 [KpLi0rn](https://github.com/KpLi0rn) Starred [stanford-iris-lab/meta-harness](https://github.com/stanford-iris-lab/meta-harness)
...
- 🌟 👤 [L4ys](https://github.com/L4ys) Starred [vmi-rs/ephemera](https://github.com/vmi-rs/ephemera)
...
- 🌟 👤 [Monster-GM](https://github.com/Monster-GM) Starred [gyc123456-1/FanQieNovelSpider](https://github.com/gyc123456-1/FanQieNovelSpider)
  > 番茄免费小说爬虫

### [MorvanZhou](https://github.com/MorvanZhou)
- 🌟 👤 [MorvanZhou](https://github.com/MorvanZhou) Starred [jackwener/wx-cli](https://github.com/jackwener/wx-cli)
...
- 🌟 👤 [MrIkso](https://github.com/MrIkso) Starred [ConnorKrammer/cpk-tools](https://github.com/ConnorKrammer/cpk-tools)
  > Tools for working with CRIWARE's CPK archive format.
...
- 🌟 👤 [NtDallas](https://github.com/NtDallas) Starred [Atsika/MalGitApp](https://github.com/Atsika/MalGitApp)
  > A simple OAuth App designed to capture OAuth tokens when users authenticate through GitHub OAuth flo...
...
- 🌟 👤 [PranavPurwar](https://github.com/PranavPurwar) Starred [PranavPurwar/kotlinc-android](https://github.com/PranavPurwar/kotlinc-android)
  > Kotlin Compiler Port for Android for compilers, IDEs, etc.
...
- 🌟 👤 [RicardoJiang](https://github.com/RicardoJiang) Starred [mack-a/v2ray-agent](https://github.com/mack-a/v2ray-agent)
  > Xray、Tuic、hysteria2、sing-box 八合一一键脚本

### [Ridter](https://github.com/Ridter)
- 🌟 👤 [Ridter](https://github.com/Ridter) Starred [Ed1s0nZ/CyberStrikeAI](https://github.com/Ed1s0nZ/CyberStrikeAI)
  > CyberStrikeAI is an AI-native security testing platform built in Go. It integrates 100+ security too...
- 🍴 👤 [Ridter](https://github.com/Ridter) Forked [Ed1s0nZ/CyberStrikeAI](https://github.com/Ed1s0nZ/CyberStrikeAI) to [Ridter/CyberStrikeAI](https://github.com/Ridter/CyberStrikeAI)
  > CyberStrikeAI is an AI-native security testing platform built in Go. It integrates 100+ security too...

### [Seyud](https://github.com/Seyud)
- 🌟 👤 [Seyud](https://github.com/Seyud) Starred [CanStarRivers/Hyperfusion-AOD-Service](https://github.com/CanStarRivers/Hyperfusion-AOD-Service)
  > HyperFusion Xiaomi Aod Display Services

### [SherlockChiang](https://github.com/SherlockChiang)
- 🍴 👤 [SherlockChiang](https://github.com/SherlockChiang) Forked [LineageOS/android_device_xiaomi_nuwa](https://github.com/LineageOS/android_device_xiaomi_nuwa) to [SherlockChiang/android_device_xiaomi_nuwa](https://github.com/SherlockChiang/android_device_xiaomi_nuwa)
- 🍴 👤 [SherlockChiang](https://github.com/SherlockChiang) Forked [LineageOS/android_device_xiaomi_sm8550-common](https://github.com/LineageOS/android_device_xiaomi_sm8550-common) to [SherlockChiang/android_device_xiaomi_sm8550-common](https://github.com/SherlockChiang/android_device_xiaomi_sm8550-common)

### [SimonTheCoder](https://github.com/SimonTheCoder)
- 🌟 👤 [SimonTheCoder](https://github.com/SimonTheCoder) Starred [mnfst/awesome-free-llm-apis](https://github.com/mnfst/awesome-free-llm-apis)
...
- 🌟 👤 [SoyBeanMilkx](https://github.com/SoyBeanMilkx) Starred [GitKittys/AndroidPrybar](https://github.com/GitKittys/AndroidPrybar)
  > Android Native Trace 与逆向分析工具，用于函数包装执行、指令跟踪、JNI 调用观测与外部跳转控制
...
- 🌟 👤 [THISISAGOODNAME](https://github.com/THISISAGOODNAME) Starred [skeeto/dcmake](https://github.com/skeeto/dcmake)
  > CMake debugger
...
- 🌟 👤 [X1r0z](https://github.com/X1r0z) Starred [MoonshotAI/kimi-cli](https://github.com/MoonshotAI/kimi-cli)
  > Kimi Code CLI is your next CLI agent.

### [XiaoliChan](https://github.com/XiaoliChan)
- 🌟 👤 [XiaoliChan](https://github.com/XiaoliChan) Starred [Wei-Shaw/sub2api](https://github.com/Wei-Shaw/sub2api)
  > Sub2API-CRS2 一站式开源中转服务，让 Claude、Openai 、Gemini、Antigravity订阅统一接入，支持拼车共享，更高效分摊成本，原生工具无缝使用。
- 🌟 👤 [XiaoliChan](https://github.com/XiaoliChan) Starred [oiweiwei/go-adws](https://github.com/oiweiwei/go-adws)
...
- 🌟 👤 [YuKongA](https://github.com/YuKongA) Starred [SugaryHull/re3](https://github.com/SugaryHull/re3)
  > Fuck you, Take Two
- 🌟 👤 [YuKongA](https://github.com/YuKongA) Starred [mrxenginner/reVC](https://github.com/mrxenginner/reVC)
  > Reverse engineering the classic GTA Vice City game
- 🌟 👤 [YuKongA](https://github.com/YuKongA) Starred [Lolendor/reVCDOS](https://github.com/Lolendor/reVCDOS)
  > Web-based port of GTA: Vice City running in browser via WebAssembly.
- 🍴 👤 [YuKongA](https://github.com/YuKongA) Forked [Lolendor/reVCDOS](https://github.com/Lolendor/reVCDOS) to [YuKongA/reVCDOS](https://github.com/YuKongA/reVCDOS)
  > Web-based port of GTA: Vice City running in browser via WebAssembly.
- 🍴 👤 [YuKongA](https://github.com/YuKongA) Forked [mrxenginner/reVC](https://github.com/mrxenginner/reVC) to [YuKongA/reVC](https://github.com/YuKongA/reVC)
  > Reverse engineering the classic GTA Vice City game
...
- 🌟 👤 [abdihaikal](https://github.com/abdihaikal) Starred [google/cel-spec](https://github.com/google/cel-spec)
  > Common Expression Language -- specification and binary representation
- 🍴 👤 [abdihaikal](https://github.com/abdihaikal) Forked [google/cel-spec](https://github.com/google/cel-spec) to [abdihaikal/cel-spec](https://github.com/abdihaikal/cel-spec)
  > Common Expression Language -- specification and binary representation

### [androidmalin](https://github.com/androidmalin)
- 🌟 👤 [androidmalin](https://github.com/androidmalin) Starred [volcengine/ImageXDemo-Android](https://github.com/volcengine/ImageXDemo-Android)
  > 火山引擎图片SDK，稳定性和性能经过内部抖音、西瓜等App验证；Demo展示多种图片格式解码、渐进式加载、动图播放控制等基础能力展示。
- 🌟 👤 [androidmalin](https://github.com/androidmalin) Starred [volcengine/mcp-server](https://github.com/volcengine/mcp-server)
  > Volcengine MCP Servers
- 🌟 👤 [androidmalin](https://github.com/androidmalin) Starred [volcengine/VEVodDemo-android](https://github.com/volcengine/VEVodDemo-android)
...
- 🌟 👤 [antiwar3](https://github.com/antiwar3) Starred [LabGuy94/Diskjacker](https://github.com/LabGuy94/Diskjacker)
  > Hijacking Hyper-V at Runtime with DDMA

### [any86](https://github.com/any86)
- 🌟 👤 [any86](https://github.com/any86) Starred [antdv-next/admin](https://github.com/antdv-next/admin)
  > Antdv Next Admin

### [aooiuu](https://github.com/aooiuu)
- 🌟 👤 [aooiuu](https://github.com/aooiuu) Starred [filipecalegario/awesome-vibe-coding](https://github.com/filipecalegario/awesome-vibe-coding)
  > A curated list of vibe coding references, collaborating with AI to write code.

### [apkunpacker](https://github.com/apkunpacker)
- 🌟 👤 [apkunpacker](https://github.com/apkunpacker) Starred [marioballano/cheapbin](https://github.com/marioballano/cheapbin)
  > Listen to your binaries
- 🍴 👤 [apkunpacker](https://github.com/apkunpacker) Forked [marioballano/cheapbin](https://github.com/marioballano/cheapbin) to [apkunpacker/cheapbin](https://github.com/apkunpacker/cheapbin)
  > Listen to your binaries
...
- 🌟 👤 [aystshen](https://github.com/aystshen) Starred [erode-app/erode](https://github.com/erode-app/erode)

### [badboycxcc](https://github.com/badboycxcc)
- 🌟 👤 [badboycxcc](https://github.com/badboycxcc) Starred [VMsec/ihoneyBakFileScan_Modify](https://github.com/VMsec/ihoneyBakFileScan_Modify)
  > 批量网站备份文件扫描器，增加文件规则，优化内存占用

### [banteg](https://github.com/banteg)
- 🌟 👤 [banteg](https://github.com/banteg) Starred [a16z/helios](https://github.com/a16z/helios)
...
- 🚀 👤 [coderstory](https://github.com/coderstory) Made [coderstory/vibe_coding](https://github.com/coderstory/vibe_coding) public
  > 基于AI编程生成的springboot+vue管理后台系统

### [ctkqiang](https://github.com/ctkqiang)
- 🌟 👤 [ctkqiang](https://github.com/ctkqiang) Starred [affaan-m/everything-claude-code](https://github.com/affaan-m/everything-claude-code)
  > The agent harness performance optimization system. Skills, instincts, memory, security, and research...
...
- 🌟 👤 [darbra](https://github.com/darbra) Starred [lissettecarlr/nano-banana-prompt-studio](https://github.com/lissettecarlr/nano-banana-prompt-studio)
  > 一个面向nano-banana-pro（gemini-3-pro-image-preview）文生图模型的提示词结构化与优化工具集。 它帮助你快速构建高质量的提示词，并一键调用接口生成图片，让「想法 ...

### [darkskygit](https://github.com/darkskygit)
- 🌟 👤 [darkskygit](https://github.com/darkskygit) Starred [Eul45/omni-search](https://github.com/Eul45/omni-search)
...
- 🌟 👤 [dzxpert](https://github.com/dzxpert) Starred [badsys1337/cranium-mapper1337](https://github.com/badsys1337/cranium-mapper1337)
  > an fully undetected/stealth driver mapper for loading unsigned drivers into system,fully compatible ...
- 🌟 👤 [dzxpert](https://github.com/dzxpert) Starred [0Xploitwtf/KMbase](https://github.com/0Xploitwtf/KMbase)
  > Kernel mode Read/Write driver base with CR3 decryption for Eac
- 🌟 👤 [dzxpert](https://github.com/dzxpert) Starred [retorquere/zotero-better-bibtex](https://github.com/retorquere/zotero-better-bibtex)
  > Make Zotero effective for us LaTeX holdouts
- 🌟 👤 [dzxpert](https://github.com/dzxpert) Starred [ndpvt-web/latex-document-skill](https://github.com/ndpvt-web/latex-document-skill)
  > Universal LaTeX document skill for Claude Code: 27 templates, 27 scripts, 26 reference guides. Made ...

### [easychen](https://github.com/easychen)
- 🌟 👤 [easychen](https://github.com/easychen) Starred [mikeyobrien/ralph-orchestrator](https://github.com/mikeyobrien/ralph-orchestrator)
...
- 🌟 👤 [elllusion](https://github.com/elllusion) Starred [kyegomez/OpenMythos](https://github.com/kyegomez/OpenMythos)
  > A theoretical reconstruction of the Claude Mythos architecture, built from first principles using th...
...
- 🌟 👤 [everettjf](https://github.com/everettjf) Starred [wojciech-kulik/XcodeProjectCLI](https://github.com/wojciech-kulik/XcodeProjectCLI)
  > A lightweight command-line tool for managing Xcode projects, built entirely in Swift. Also available...
- 🌟 👤 [everettjf](https://github.com/everettjf) Starred [Lakr233/bgclick-rev-skill](https://github.com/Lakr233/bgclick-rev-skill)
- 🍴 👤 [everettjf](https://github.com/everettjf) Forked [Lakr233/bgclick-rev-skill](https://github.com/Lakr233/bgclick-rev-skill) to [everettjf/bgclick-rev-skill](https://github.com/everettjf/bgclick-rev-skill)
- 🌟 👤 [everettjf](https://github.com/everettjf) Starred [Captain-AI-Hub/IDA-MCP](https://github.com/Captain-AI-Hub/IDA-MCP)
  > IDA MCP
- 🌟 👤 [everettjf](https://github.com/everettjf) Starred [MxIris-Reverse-Engineering/ida-mcp-server](https://github.com/MxIris-Reverse-Engineering/ida-mcp-server)
...
- 🌟 👤 [fanzhidongyzby](https://github.com/fanzhidongyzby) Starred [yologdev/yoyo-evolve](https://github.com/yologdev/yoyo-evolve)
  > A Truman Show of a self-evolving AI coding agent. It writes its own code. Growing up in public.

### [feicong](https://github.com/feicong)
- 🌟 👤 [feicong](https://github.com/feicong) Starred [h4ckf0r0day/obscura](https://github.com/h4ckf0r0day/obscura)
  > The headless browser for AI agents and web scraping
- 🍴 👤 [feicong](https://github.com/feicong) Forked [h4ckf0r0day/obscura](https://github.com/h4ckf0r0day/obscura) to [feicong/obscura](https://github.com/feicong/obscura)
  > The headless browser for AI agents and web scraping
- 🌟 👤 [feicong](https://github.com/feicong) Starred [amimo/goron](https://github.com/amimo/goron)
...
- 🌟 👤 [foospidy](https://github.com/foospidy) Starred [smol-machines/smolvm](https://github.com/smol-machines/smolvm)
...
- 🌟 👤 [fynch3r](https://github.com/fynch3r) Starred [SimoneAvogadro/android-reverse-engineering-skill](https://github.com/SimoneAvogadro/android-reverse-engineering-skill)
  > Claude Code skill to support Android app's reverse engineering
- 🌟 👤 [fynch3r](https://github.com/fynch3r) Starred [B3nac/Android-Reports-and-Resources](https://github.com/B3nac/Android-Reports-and-Resources)
...
- 🌟 👤 [gh0stkey](https://github.com/gh0stkey) Starred [browser-use/browser-harness](https://github.com/browser-use/browser-harness)
  > Self-healing browser harness that enables LLMs to complete any task.
- 🌟 👤 [gh0stkey](https://github.com/gh0stkey) Starred [taisuii/rusda](https://github.com/taisuii/rusda)
  > 对frida 的patch，产物可直接下载Release
- 🌟 👤 [gh0stkey](https://github.com/gh0stkey) Starred [kyegomez/OpenMythos](https://github.com/kyegomez/OpenMythos)
  > A theoretical reconstruction of the Claude Mythos architecture, built from first principles using th...
- 🌟 👤 [gh0stkey](https://github.com/gh0stkey) Starred [unixshells/clone](https://github.com/unixshells/clone)
  > Minimal VMM for multi-tenant dev shells and serverless
- 🌟 👤 [gh0stkey](https://github.com/gh0stkey) Starred [AlessandroZ/LaZagne](https://github.com/AlessandroZ/LaZagne)
  > Credentials recovery project
- 🌟 👤 [gh0stkey](https://github.com/gh0stkey) Starred [prasmussen/chrome-cli](https://github.com/prasmussen/chrome-cli)
  > Control Google Chrome from the command line

### [gitofleonardo](https://github.com/gitofleonardo)
- 🌟 👤 [gitofleonardo](https://github.com/gitofleonardo) Starred [android/skills](https://github.com/android/skills)

### [gmh5225](https://github.com/gmh5225)
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [lllyasviel/VCC](https://github.com/lllyasviel/VCC) to [gmh5225/VCC](https://github.com/gmh5225/VCC)
  > Compile agent conversations!
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [mattgodbolt/pal-decoder](https://github.com/mattgodbolt/pal-decoder) to [gmh5225/pal-decoder](https://github.com/gmh5225/pal-decoder)
  > Javascript PAL decoder
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [LayerZero-Labs/gasolina-aws](https://github.com/LayerZero-Labs/gasolina-aws) to [gmh5225/gasolina-aws](https://github.com/gmh5225/gasolina-aws)
  > This repository provides Infrastructure-As-Code (IAC) for installing Gasolina on AWS via CDK.
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [docmancer/docmancer](https://github.com/docmancer/docmancer) to [gmh5225/docmancer](https://github.com/gmh5225/docmancer)
  > Give your AI coding agents documentation superpowers. Fetch, embed, and query any public docs locall...
- 🍴 👤 [gmh5225](https://github.com/gmh5225) Forked [vmi-rs/ephemera](https://github.com/vmi-rs/ephemera) to [gmh5225/ephemera](https://github.com/gmh5225/ephemera)
  > Multiplatform MEMORY.DMP analysis tool with a WinDbg flavor

### [hahwul](https://github.com/hahwul)
- 🌟 👤 [hahwul](https://github.com/hahwul) Starred [n0-computer/iroh](https://github.com/n0-computer/iroh)
  > IP addresses break, dial keys instead. Modular networking stack in Rust.

### [hanc00l](https://github.com/hanc00l)
- 🌟 👤 [hanc00l](https://github.com/hanc00l) Starred [wgpsec/tchkiller](https://github.com/wgpsec/tchkiller)
  > 基于 claude-agent-sdk 的智能渗透测试 Agent，用于参与第二届 TCH 智能渗透挑战赛。
- 🌟 👤 [hanc00l](https://github.com/hanc00l) Starred [oritera/Cairn](https://github.com/oritera/Cairn)
  > AI 自动化通用问题解决 / AI 自动化渗透测试系统
...
- 🌟 👤 [hhhaiai](https://github.com/hhhaiai) Starred [basketikun/chatgpt2api](https://github.com/basketikun/chatgpt2api)
- 🍴 👤 [hhhaiai](https://github.com/hhhaiai) Forked [basketikun/chatgpt2api](https://github.com/basketikun/chatgpt2api) to [openChatGpts/chatgpt2api](https://github.com/openChatGpts/chatgpt2api)
- 🌟 👤 [hhhaiai](https://github.com/hhhaiai) Starred [lightpanda-io/browser](https://github.com/lightpanda-io/browser)
  > Lightpanda: the headless browser designed for AI and automation

### [hyuunnn](https://github.com/hyuunnn)
- 🌟 👤 [hyuunnn](https://github.com/hyuunnn) Starred [sirmalloc/ccstatusline](https://github.com/sirmalloc/ccstatusline)
  > 🚀 Beautiful highly customizable statusline for Claude Code CLI with powerline support, themes, and m...
- 🌟 👤 [hyuunnn](https://github.com/hyuunnn) Starred [kyegomez/OpenMythos](https://github.com/kyegomez/OpenMythos)
  > A theoretical reconstruction of the Claude Mythos architecture, built from first principles using th...
- 🌟 👤 [hyuunnn](https://github.com/hyuunnn) Starred [first-fluke/oh-my-agent](https://github.com/first-fluke/oh-my-agent)
...
- 🌟 👤 [hyuunnn](https://github.com/hyuunnn) Starred [k2-fsa/OmniVoice](https://github.com/k2-fsa/OmniVoice)
...
- 🌟 👤 [imlk0](https://github.com/imlk0) Starred [softaworks/agent-toolkit](https://github.com/softaworks/agent-toolkit)
  > A curated collection of skills for AI coding agents. Skills are packaged instructions and scripts th...
- 🌟 👤 [imlk0](https://github.com/imlk0) Starred [max-sixty/worktrunk](https://github.com/max-sixty/worktrunk)
...
- 🌟 👤 [jweny](https://github.com/jweny) Starred [oritera/Cairn](https://github.com/oritera/Cairn)
  > AI 自动化通用问题解决 / AI 自动化渗透测试系统
- 🌟 👤 [jweny](https://github.com/jweny) Starred [kyegomez/OpenMythos](https://github.com/kyegomez/OpenMythos)
  > A theoretical reconstruction of the Claude Mythos architecture, built from first principles using th...

### [kasnria001](https://github.com/kasnria001)
- 🌟 👤 [kasnria001](https://github.com/kasnria001) Starred [QRD-Development/SM8750_BSP_Sync](https://github.com/QRD-Development/SM8750_BSP_Sync)
- 🌟 👤 [kasnria001](https://github.com/kasnria001) Starred [systemnb/compile_android_driver](https://github.com/systemnb/compile_android_driver)
...
- 🌟 👤 [kmlgping](https://github.com/kmlgping) Starred [qq923004243/DMA-stay](https://github.com/qq923004243/DMA-stay)
  > PUBG 
- 🌟 👤 [kmlgping](https://github.com/kmlgping) Starred [OISF/suricata](https://github.com/OISF/suricata)
  > Suricata is a network Intrusion Detection System, Intrusion Prevention System and Network Security M...
- 🌟 👤 [kmlgping](https://github.com/kmlgping) Starred [zeek/zeek](https://github.com/zeek/zeek)
...
- 🌟 👤 [konieshadow](https://github.com/konieshadow) Starred [rtk-ai/rtk](https://github.com/rtk-ai/rtk)
  > CLI proxy that reduces LLM token consumption by 60-90% on common dev commands. Single Rust binary, z...

### [le31ei](https://github.com/le31ei)
- 🌟 👤 [le31ei](https://github.com/le31ei) Starred [byoungd/English-level-up-tips](https://github.com/byoungd/English-level-up-tips)
...
- 🌟 👤 [linuxmobile](https://github.com/linuxmobile) Starred [mi7i/dot-icons](https://github.com/mi7i/dot-icons)
  > Dreams Icon Theme
...
- 🌟 👤 [mingheyan](https://github.com/mingheyan) Starred [farion1231/cc-switch](https://github.com/farion1231/cc-switch)
...
- 🌟 👤 [motikan2010](https://github.com/motikan2010) Starred [DefectDojo/django-DefectDojo](https://github.com/DefectDojo/django-DefectDojo)
...
- 🌟 👤 [mzfr](https://github.com/mzfr) Starred [c-ares/c-ares](https://github.com/c-ares/c-ares)
  > A C library for asynchronous DNS requests
- 🌟 👤 [mzfr](https://github.com/mzfr) Starred [microsoft/sudo](https://github.com/microsoft/sudo)
  > It's sudo, for Windows
- 🌟 👤 [mzfr](https://github.com/mzfr) Starred [duriantaco/fyn](https://github.com/duriantaco/fyn)
  > Fyn is a fork of uv for fast Python package management, dependency resolution, virtual environments,...

### [mzule](https://github.com/mzule)
- 🌟 👤 [mzule](https://github.com/mzule) Starred [browser-use/browser-use](https://github.com/browser-use/browser-use)
  > 🌐 Make websites accessible for AI agents. Automate tasks online with ease.

### [namhyung](https://github.com/namhyung)
- 🍴 👤 [namhyung](https://github.com/namhyung) Forked [flathub/flathub](https://github.com/flathub/flathub) to [namhyung/flathub](https://github.com/namhyung/flathub)
  > Issue tracker and new submissions

### [nek0y4nsu](https://github.com/nek0y4nsu)
- 🌟 👤 [nek0y4nsu](https://github.com/nek0y4nsu) Starred [elastic/protections-artifacts](https://github.com/elastic/protections-artifacts)
  > Elastic Security detection content for Endpoint
- 🌟 👤 [nek0y4nsu](https://github.com/nek0y4nsu) Starred [AgentSmithers/DnSpy-MCPserver-Extension](https://github.com/AgentSmithers/DnSpy-MCPserver-Extension)
  > AgentSmithers DnSpyEx MCPServer extension

### [netxfly](https://github.com/netxfly)
- 🌟 👤 [netxfly](https://github.com/netxfly) Starred [nbigaouette/onnxruntime-rs](https://github.com/nbigaouette/onnxruntime-rs)
  > Rust wrapper for Microsoft's ONNX Runtime (version 1.8)

### [npjohnson](https://github.com/npjohnson)
- 🌟 👤 [npjohnson](https://github.com/npjohnson) Starred [xykong/flux-markdown](https://github.com/xykong/flux-markdown)
  > Markdown Preview Enhanced for macOS QuickLook
- 🌟 👤 [npjohnson](https://github.com/npjohnson) Starred [artginzburg/MiddleClick](https://github.com/artginzburg/MiddleClick)
...
- 🌟 👤 [rankalpha](https://github.com/rankalpha) Starred [QuantumNous/new-api](https://github.com/QuantumNous/new-api)
...
- 🌟 👤 [retme7](https://github.com/retme7) Starred [iFurySt/open-codex-computer-use](https://github.com/iFurySt/open-codex-computer-use)
  > 👾 Open Computer Use – Open-Source Alternative to Codex Computer Use

### [rmuxnet](https://github.com/rmuxnet)
- 🌟 👤 [rmuxnet](https://github.com/rmuxnet) Starred [elder-plinius/CL4R1T4S](https://github.com/elder-plinius/CL4R1T4S)
  > LEAKED SYSTEM PROMPTS FOR CHATGPT, GEMINI, GROK, CLAUDE, PERPLEXITY, CURSOR, DEVIN, REPLIT, AND MORE...

### [rogxo](https://github.com/rogxo)
- 🌟 👤 [rogxo](https://github.com/rogxo) Starred [TheCruZ/nvidiaCapture](https://github.com/TheCruZ/nvidiaCapture)
...
- 🌟 👤 [rootm0s](https://github.com/rootm0s) Starred [SunOner/sunone_aimbot](https://github.com/SunOner/sunone_aimbot)
...
- 🌟 👤 [semlinker](https://github.com/semlinker) Starred [cv-cat/DouYin_Spider](https://github.com/cv-cat/DouYin_Spider)
  > 抖音逆向，抖音爬虫，抖音全部api、直播间监听
- 🌟 👤 [semlinker](https://github.com/semlinker) Starred [forrestchang/andrej-karpathy-skills](https://github.com/forrestchang/andrej-karpathy-skills)
  > A single CLAUDE.md file to improve Claude Code behavior, derived from Andrej Karpathy's observations...

### [shadow3aaa](https://github.com/shadow3aaa)
- 🌟 👤 [shadow3aaa](https://github.com/shadow3aaa) Starred [aldefy/compose-skill](https://github.com/aldefy/compose-skill)
...
- 🌟 👤 [shellsec](https://github.com/shellsec) Starred [codeskyblue/gohttpserver](https://github.com/codeskyblue/gohttpserver)
  > The best HTTP Static File Server, write with golang+vue

### [smallzhong](https://github.com/smallzhong)
- 🌟 👤 [smallzhong](https://github.com/smallzhong) Starred [LabGuy94/Diskjacker](https://github.com/LabGuy94/Diskjacker)
  > Hijacking Hyper-V at Runtime with DDMA
- 🍴 👤 [smallzhong](https://github.com/smallzhong) Forked [LabGuy94/Diskjacker](https://github.com/LabGuy94/Diskjacker) to [smallzhong/Diskjacker](https://github.com/smallzhong/Diskjacker)
  > Hijacking Hyper-V at Runtime with DDMA

### [superfish9](https://github.com/superfish9)
- 🌟 👤 [superfish9](https://github.com/superfish9) Starred [anthropics/claude-agent-sdk-python](https://github.com/anthropics/claude-agent-sdk-python)
- 🌟 👤 [superfish9](https://github.com/superfish9) Starred [wgpsec/AboutSecurity](https://github.com/wgpsec/AboutSecurity)
...
- 🌟 👤 [ttttmr](https://github.com/ttttmr) Starred [wulujia/growing-in-cracks](https://github.com/wulujia/growing-in-cracks)
  > Growing in Cracks
...
- 🌟 👤 [vaibhavpandeyvpz](https://github.com/vaibhavpandeyvpz) Starred [vaibhavpandeyvpz/slackxmcp](https://github.com/vaibhavpandeyvpz/slackxmcp)
...
- 🌟 👤 [wa1ki0g](https://github.com/wa1ki0g) Starred [Mininglamp-AI/Mano-P](https://github.com/Mininglamp-AI/Mano-P)
...
- 🌟 👤 [wxhzhwxhzh](https://github.com/wxhzhwxhzh) Starred [adryfish/fingerprint-chromium](https://github.com/adryfish/fingerprint-chromium)
...
- 🌟 👤 [xyxdaily](https://github.com/xyxdaily) Starred [LRFP-Team/LRFP](https://github.com/LRFP-Team/LRFP)
  > This repository aims to provide the implementers, detectors, and bypassers that are related to LRFP ...
- 🍴 👤 [xyxdaily](https://github.com/xyxdaily) Forked [LRFP-Team/LRFP](https://github.com/LRFP-Team/LRFP) to [xyxdaily/LRFP-reverse](https://github.com/xyxdaily/LRFP-reverse)
  > This repository aims to provide the implementers, detectors, and bypassers that are related to LRFP ...
...
- 🌟 👤 [youncyb](https://github.com/youncyb) Starred [vulnerability-lookup/vulnerability-lookup](https://github.com/vulnerability-lookup/vulnerability-lookup)
  > Vulnerability-Lookup facilitates quick correlation of vulnerabilities from various sources, independ...
...
- 🌟 👤 [yulate](https://github.com/yulate) Starred [oritera/Cairn](https://github.com/oritera/Cairn)
  > AI 自动化通用问题解决 / AI 自动化渗透测试系统

### [zenghongtu](https://github.com/zenghongtu)
- 🌟 👤 [zenghongtu](https://github.com/zenghongtu) Starred [Haleclipse/CCometixLine](https://github.com/Haleclipse/CCometixLine)
  > Claude Code statusline tool written in Rust

### [zer0def](https://github.com/zer0def)
- 🌟 👤 [zer0def](https://github.com/zer0def) Starred [Scyne/stadiaRawBtFw](https://github.com/Scyne/stadiaRawBtFw)
  > A dump of the Raw Stadia controller BT Firmware
- 🌟 👤 [zer0def](https://github.com/zer0def) Starred [luigimannoni/stadia-controller-flasher](https://github.com/luigimannoni/stadia-controller-flasher)
  > Utility for flashing Stadia Controllers
- 🌟 👤 [zer0def](https://github.com/zer0def) Starred [debouncedgit/StadiaFW](https://github.com/debouncedgit/StadiaFW)
  > Google Stadia Controller Bluetooth (and Wi-Fi) Firmware Dumps. Use something like: https://luigimann...

### [zer0yu](https://github.com/zer0yu)
- 🌟 👤 [zer0yu](https://github.com/zer0yu) Starred [yzddmr6/repo-analyzer](https://github.com/yzddmr6/repo-analyzer)
...
- 🌟 👤 [zeroxjf](https://github.com/zeroxjf) Starred [khanhduytran0/lara](https://github.com/khanhduytran0/lara)
  > WIP darksword kexploit implement

### [zhanghai](https://github.com/zhanghai)
- 🌟 👤 [zhanghai](https://github.com/zhanghai) Starred [ginlix-ai/LangAlpha](https://github.com/ginlix-ai/LangAlpha)
  > Claude Code for Finance

### [zhangyoufu](https://github.com/zhangyoufu)
- 🌟 👤 [zhangyoufu](https://github.com/zhangyoufu) Starred [void-linux/musl-obstack](https://github.com/void-linux/musl-obstack)
  > A standalone library to implement GNU libc's obstack
- 🌟 👤 [zhangyoufu](https://github.com/zhangyoufu) Starred [kaniini/libucontext](https://github.com/kaniini/libucontext)
  > ucontext implementation featuring glibc-compatible ABI
- 🌟 👤 [zhangyoufu](https://github.com/zhangyoufu) Starred [DimensionDev/Flare](https://github.com/DimensionDev/Flare)
  > Browse Mastodon, Bluesky, X, Misskey, Nostr and RSS all in one app. One timeline, all your accounts,...
- 🌟 👤 [zhangyoufu](https://github.com/zhangyoufu) Starred [svaarala/duktape](https://github.com/svaarala/duktape)
  > Duktape - embeddable Javascript engine with a focus on portability and compact footprint
- 🌟 👤 [zhangyoufu](https://github.com/zhangyoufu) Starred [jow-/ucode](https://github.com/jow-/ucode)
  > JavaScript-like language with optional templating
- 🌟 👤 [zhangyoufu](https://github.com/zhangyoufu) Starred [ktock/buildg](https://github.com/ktock/buildg)
  > Interactive debugger for Dockerfile, with support for IDEs (VS Code, Emacs, Neovim, etc.)

### [zhaotianff](https://github.com/zhaotianff)
- 🌟 👤 [zhaotianff](https://github.com/zhaotianff) Starred [op7418/Humanizer-zh](https://github.com/op7418/Humanizer-zh)
  > Humanizer 的汉化版本，Claude Code Skills，旨在消除文本中 AI 生成的痕迹。
- 🌟 👤 [zhaotianff](https://github.com/zhaotianff) Starred [microsoft/MS-DOS](https://github.com/microsoft/MS-DOS)
  > The original sources of MS-DOS 1.25, 2.0, and 4.0 for reference purposes

### [zhengjim](https://github.com/zhengjim)
- 🌟 👤 [zhengjim](https://github.com/zhengjim) Starred [wgpsec/AboutSecurity](https://github.com/wgpsec/AboutSecurity)
  > Everything for pentest. | 用于渗透测试的 payload 和 bypass 字典.
- 🌟 👤 [zhengjim](https://github.com/zhengjim) Starred [oritera/Cairn](https://github.com/oritera/Cairn)
  > AI 自动化通用问题解决 / AI 自动化渗透测试系统

### [zhzyker](https://github.com/zhzyker)
- 🌟 👤 [zhzyker](https://github.com/zhzyker) Starred [adminnerr/Shodan_Tools](https://github.com/adminnerr/Shodan_Tools)
  > 对IP检测是否cve漏洞，是否为蜜罐
- 🍴 👤 [zhzyker](https://github.com/zhzyker) Forked [adminnerr/Shodan_Tools](https://github.com/adminnerr/Shodan_Tools) to [Sec-Fork/Shodan_Tools](https://github.com/Sec-Fork/Shodan_Tools)
  > 对IP检测是否cve漏洞，是否为蜜罐
- 🌟 👤 [zhzyker](https://github.com/zhzyker) Starred [FilipPwn/ExchangeHound](https://github.com/FilipPwn/ExchangeHound)
  > ExchangeHound is a defensive BloodHound OpenGraph collector for on-prem Microsoft Exchange that maps...
- 🍴 👤 [zhzyker](https://github.com/zhzyker) Forked [FilipPwn/ExchangeHound](https://github.com/FilipPwn/ExchangeHound) to [Sec-Fork/ExchangeHound](https://github.com/Sec-Fork/ExchangeHound)
  > ExchangeHound is a defensive BloodHound OpenGraph collector for on-prem Microsoft Exchange that maps...
- 🌟 👤 [zhzyker](https://github.com/zhzyker) Starred [hfiref0x/DefenderRulesPlus](https://github.com/hfiref0x/DefenderRulesPlus)
  > Tool designed to parse and analyze Microsoft Defender AV signature definition files 
- 🍴 👤 [zhzyker](https://github.com/zhzyker) Forked [hfiref0x/DefenderRulesPlus](https://github.com/hfiref0x/DefenderRulesPlus) to [Sec-Fork/DefenderRulesPlus](https://github.com/Sec-Fork/DefenderRulesPlus)
  > Tool designed to parse and analyze Microsoft Defender AV signature definition files 
- 🌟 👤 [zhzyker](https://github.com/zhzyker) Starred [DylanDavis1/DSCourier](https://github.com/DylanDavis1/DSCourier)
- 🌟 👤 [zhzyker](https://github.com/zhzyker) Starred [raskolnikov90/Beatrice.py](https://github.com/raskolnikov90/Beatrice.py)
  > Modify machine code in binaries with alternative x64 assembly opcodes for AV evasion
- 🍴 👤 [zhzyker](https://github.com/zhzyker) Forked [raskolnikov90/Beatrice.py](https://github.com/raskolnikov90/Beatrice.py) to [Sec-Fork/Beatrice.py](https://github.com/Sec-Fork/Beatrice.py)
  > Modify machine code in binaries with alternative x64 assembly opcodes for AV evasion
- 🍴 👤 [zhzyker](https://github.com/zhzyker) Forked [DylanDavis1/DSCourier](https://github.com/DylanDavis1/DSCourier) to [Sec-Fork/DSCourier](https://github.com/Sec-Fork/DSCourier)

### [zyl5721451](https://github.com/zyl5721451)
- 🌟 👤 [zyl5721451](https://github.com/zyl5721451) Starred [heygen-com/hyperframes](https://github.com/heygen-com/hyperframes)
  > Write HTML. Render video. Built for agents.


---
*最后更新于 2026-04-20 17:57:44 UTC*
*历史记录保存在 `archive` 目录中。*
